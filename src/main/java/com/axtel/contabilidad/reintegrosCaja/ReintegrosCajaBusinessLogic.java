...
public class ReintegrosCajaBusinessLogic extends DataSourceManager {
	...
	private static Logger	log			= Logger.getLogger( ReintegrosCajaBusinessLogic.class );
	...
	public ReintegrosCajaEncabezado getReintegrosCajaEncabezado(int folio) throws Exception {//DATOS SOLICITADOS POR EGRESOSFIRMANTES
	...
	public ReintegrosCajaDetalle getReintegrosCajaDetalle(int folio) throws Exception {//DATOS SOLICITADOS POR EGRESOSFIRMANTES
		Connection conn = null;
