...
@WebServlet(name = "LayoutProcesosFinAnioServlet", urlPatterns = { "/gstnmngr/LayoutProcesosFinAnio" })
public class LayoutProcesosFinAnioServlet extends HttpServlet {

    private static final long serialVersionUID = 6723127616859732249L;

    private static final Logger log = LoggerFactory.getLogger(LayoutProcesosFinAnioServlet.class);
