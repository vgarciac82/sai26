...
public class DocumentTreeServiceImpl extends DataSourceManager implements DocumentTreeService {
    ...
    public String getTreeDocument(String idCaso) throws DocumentTreeException {
        ...
        try {
            ...
            pstmnt = conn.prepareStatement("SELECT idcolumn, parentidcolumn, namecolumn, typecolumn FROM vimx_arbol WHERE titulo_aplicacion = ? " + "AND id_gabinete = ? ORDER BY typerow, id_carpeta_padre, id_carpeta_hija");
