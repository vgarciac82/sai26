...
public class SuficienciaPagoDirectoRetencionServlet extends HttpServlet {
	...
	private static final Logger								log					= Logger.getLogger( SuficienciaPagoDirectoRetencionServlet.class );
	...
	protected void doDelete( HttpServletRequest request, HttpServletResponse response ) throws IOException {
		try {
			...
			log.info( "Eliminando retencion " + idRetencion + " del folio " + folio );
