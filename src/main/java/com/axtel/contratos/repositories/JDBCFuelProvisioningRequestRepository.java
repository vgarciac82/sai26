...
public class JDBCFuelProvisioningRequestRepository implements FuelProvisioningRequestRepository {
    ...
    private static final Logger log = LoggerFactory.getLogger(JDBCFuelProvisioningRequestRepository.class);
    ...
    public FuelProvisioningRequest update(Connection conn, FuelProvisioningRequest fuelProvisioningRequest) throws ContratoException {
        ...
        try {
            runner.update(conn, queryUpdate.toString(), fuelProvisioningRequest.getRejectJustification(), fuelProvisioningRequest.getAutorizedAmount(), fuelProvisioningRequest.getRequestStatus(), (fuelProvisioningRequest.getAutorizationDate() == null ? null : new java.sql.Timestamp(fuelProvisioningRequest.getAutorizationDate().getTime())), fuelProvisioningRequest.getFuelContractAccountId(), fuelProvisioningRequest.getRequestJustification(), fuelProvisioningRequest.getRequestAmount(), fuelProvisioningRequest.getFuelProvisioningRequestId());
