...
public class QuestionnaireManager {
	...
	public static void readAnswersPayments(Connection conn, EgresoEncabezado header) throws SQLException {
		...
		ResultSetHandler<List<QuestionnaireAnswer>> h = new BeanListHandler<QuestionnaireAnswer>(
	...
	public static int insertAnswers(Connection conn, ContractQuestionnaire contractQuestionnaire, Usuario usuario)
			throws SQLException {
		int afectados = 0;
	...
	public static int insertQuestionnaire(Connection conn, ContractQuestionnaire contractQuestionnaire)
			throws SQLException {
		int afectados = 0;
		...
		try {
			...
			if (rs.next())
				...
				throw new SQLException(
						"No se encontro folio de apartado para la requisicion: " + questionnaire.getIdRequest());
		} finally {
			CloseObject.closeObject(ps);
			CloseObject.closeObject(rs);
		}
	...
	public static ContractQuestionnaire readContractQuestionnaireFIEL(Connection conn, String requestID)
	...
	public static int deleteQuestionnaireFIEL(Connection conn, String cIdRequest)
			throws SQLException {
		int afectados = 0;
	...
	public static int deleteQuestionnaire(Connection conn, String cIdRequest )
			throws SQLException {
		int afectados = 0;
		StringBuilder query=null;
		PreparedStatement ps = null;
	...
	public static int deleteIMXPAgina(Connection conn, int nCabinetId)
			throws SQLException {
		int afectados = 0;
		StringBuilder query=null;
		PreparedStatement ps = null;
