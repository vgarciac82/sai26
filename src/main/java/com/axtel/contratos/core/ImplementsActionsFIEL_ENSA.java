		...
		try {
			...
			for ( String folio : folios ) {
				...
				try {
					...
					//Avanzar caso
					avanzandoCaso( (( ProcesoEnteraSatisfaccionBusinessLogic ) sfe).getDatEnteraSatisfaccion().getcFolio(), (( ProcesoEnteraSatisfaccionBusinessLogic ) sfe).getUsuario().getLogin()
							, (( ProcesoEnteraSatisfaccionBusinessLogic ) sfe).getDatEnteraSatisfaccion().getOper()
							, (( ProcesoEnteraSatisfaccionBusinessLogic ) sfe).getDatEnteraSatisfaccion().getResp() );
