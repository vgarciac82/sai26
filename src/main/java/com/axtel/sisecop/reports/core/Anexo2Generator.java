...
public class Anexo2Generator {
    ...
    private static final Logger log = LoggerFactory.getLogger(Anexo2Generator.class);
    ...
    public Anexo2Generator(File reportPath) {
        ...
        log.info("Object: {}", "Anexo2Generator - Subreport path: " + params.get("REPORT_DIR") + "SubreportTerritory.jasper");
    }
