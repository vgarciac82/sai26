...
public class ProjectTerritoryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            log.info("Object: {}", "Looking for all territoris  for project: " + idProject);
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            log.info("Object: {}", "Trying to delete " + idTerritory + " territory");
            Map<String, String> result = new HashMap<>();
            proyectoService.deleteTerritory(idTerritory);
            log.info("Object: {}", "Territory " + idTerritory + " deleted");
