...
public class Main {
	...
	final static char[]		pwdPFX						= "Conaf1llave".toCharArray();																				// PFX's
																																									// password
	final static String		rfc							= "CNF010405EG1";
	final static String		dateStart					= "2020-09-13";																								// yyyy-MM-dd
	final static String		dateEnd						= "2020-09-14";																								// yyyy-MM-dd
