...
public class ViaticoClient {
    ...
    private static final Logger log = Logger.getLogger(ViaticoClient.class.getName());
    ...
    private ViaticoResponse enviarPeticion(String ruta, ViaticoRequest request) throws Exception {
        ...
        log.info("Respuesta parseada correctamente: " +
                "Empleado=" + response.getIdEmpleado() +
    ...
    public boolean verificarFormato(ViaticoRequest request, String url) throws Exception {
        String urlCompleta = String.format("%s?numeroEmpleado=%d&fechaInicio=%s&fechaFin=%s",
        		url,
