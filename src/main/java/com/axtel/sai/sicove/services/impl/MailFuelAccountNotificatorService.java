...
public class MailFuelAccountNotificatorService extends DataSourceManager implements FuelAccountNotificatorService {
    ...
    public boolean sendPendingAuthNotification(FuelProvisioningRequest request) throws SicoveException {
        ...
        try {
            ...
            AlarmaManager.procesaAlarmaCNF(conn, null, null, null, "Solicitud de combustible en cuenta " + requestAuthChain.getAccountNumber() + " pendiente de autorizar.", requestAuthChain.getAuthorizerMail() + (authCC != null ? (";" + authCC) : ""), notificationBody);
            success = true;
        } catch (Exception e) {
