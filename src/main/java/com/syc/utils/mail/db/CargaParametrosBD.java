...
public class CargaParametrosBD {
    ...
    public ParametrosCorreo getParameterDB(Connection conn, String nombreProceso) throws SQLException {
        ...
        ResultSet rs = null;
        String ParamQuery = "select * from tParamMensajeProceso PP inner join tMensajeProceso MP on " + " MP.idMensajeProceso=PP.tMensajeProceso_idMensajeProceso " + " inner join tAmbiente A on A.idAmbiente= PP.tAmbiente_idAmbiente	" + " where A.usado=0 and MP.descripcionMensajeProceos='" + nombreProceso + "'";
