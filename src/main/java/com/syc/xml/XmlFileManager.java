...
public class XmlFileManager
{
    ...
    private static final Logger log = Logger.getLogger(XmlFileManager.class);
 
    public XmlFileManager()
    {
    }

    public static String getAttributeValue(String AttrName, String PathFile, int opc)
    ...
    public static Hashtable getAllElementsAsHashtable(File xmlFile, 
    												  String charSetName,
    												  String[] datosCaso) 
    {
