...
public class SearchXml2
{
    ...
    public String find(Connection conn, String AttrName, int idCaso)
    ...
    public String find(Connection conn, String AttrName, Caso c)
        throws GestionException
    {
        String Valor = null;
    ...
    public String find(Connection conn, String AttrName, String tituloAplicacion, int id_gabinete)
        throws GestionException
    {
        String Valor = null;
        String PathFile = null;
    ...
    public Hashtable getAllElementsAsHashtable(Connection conn, 
    										   Caso c,
    										   Caso c1,
											   String charSetName)
    												throws GestionException {
    ...
    public Hashtable getAllElementsAsHashtable2(Connection conn, 
											   BitacoraCaso bc) 
										throws GestionException {
		Hashtable retVal = null;
		String PathFile = null;
