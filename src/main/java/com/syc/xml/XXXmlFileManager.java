...
public class XXXmlFileManager
{
    ...
    private static final Logger log = Logger.getLogger(XXXmlFileManager.class);

    public XXXmlFileManager()
    {
    }

    public static String getAttributeValue(String[] AttrName, String[] ValueXml, String PathFile, int opc)
