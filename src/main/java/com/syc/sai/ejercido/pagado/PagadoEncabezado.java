...
public class PagadoEncabezado {
    ...
    /**
     * @return the fechaSIAFF
     */
    public String getFechaSIAFF() {
        return fechaSIAFF;
    }
    ...
    /**
     * @param fechaSIAFF
     *            the fechaSIAFF to set
     */
    public void setFechaSIAFF(String fechaSIAFF) {
        this.fechaSIAFF = fechaSIAFF;
    }
     ...
     */
    public void setFolioSIAFF(String folioSIAFF) {
    ...
    public String toString() {
        return "PagadoEncabezado [caNoContrarrecibo=" + caNoContrarrecibo + ", descripcionPoliza=" + descripcionPoliza + ", fAplicacion=" + fAplicacion + ", fCancelacion=" + fCancelacion + ", fechaAplicacionSicop=" + fechaAplicacionSicop + ", fechaPagado=" + fechaPagado + ", fechaSIAFF=" + fechaSIAFF + ", fechaPagoSicop=" + fechaPagoSicop + ", folioCLC=" + folioCLC + ", folioPagado=" + folioPagado + ", folioPAGO=" + folioPAGO + ", folioPoliza=" + folioPoliza + ", folioPolizaCancelacion=" + folioPolizaCancelacion + ", folioSIAFF=" + folioSIAFF + ", folioSICOP=" + folioSICOP + ", idUsuarioCaptura=" + idUsuarioCaptura + ", integracion=" + integracion + ", login=" + login + ", numeroProceso=" + numeroProceso + ", ramo=" + ramo + ", solicitudPago=" + solicitudPago + ", tipoPago=" + tipoPago + ", tipoPoliza=" + tipoPoliza + ", unidadResponsableContable=" + unidadResponsableContable + "]";
    }
}
