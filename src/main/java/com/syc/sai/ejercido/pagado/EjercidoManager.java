...
public class EjercidoManager {
    ...
    public static int existeEjercido(Connection conn, String tipoPago, int folioPago) throws Exception {
        String query = "SELECT  nFolioEjercido  " + " FROM   tejercidoencabezado (NOLOCK) " + " WHERE  ctipopago = '" + tipoPago + "'  " + "        AND nfoliopago = " + folioPago;
    ...
    public static int insertaEjercido(Connection conn, List<Ejercido> ejercer) throws Exception {
        String queryInsertEnc = "INSERT INTO tejercidoencabezado  " + "             (ctipopago,  " + "              nfoliopago,  " + "              canocontrarrecibo,  " + "              ctipopoliza,  " + "              u_login,  " + "              faplicacion,  " + "              cdescripcionpoliza,  " + "              cunidadresponsablecontable,  " + "              nfoliosicop,  " + "              cramo,  " + "              cidusuariocaptura,  " + "              fechaaplicacionsicop,  " + "              fechapagosicop,  " + "              solicitudpago,  " + "              numeroproceso,  " + "              nfoliosiaff,  " + "              nfolioejercido," + "              nFolioPoliza  )  " + " VALUES      ( ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?,	 " + "               ?" + " ) ";
        String queryInsertDet = "INSERT INTO tEjercidoDetalle " + //1
        "         ( cTipoPago , " + //2
        "           nFolioPAGO , " + //3
        "           nDocRenglon , " + //4
        "           nMes , " + //5
        "           cEjercicio , " + //6
        "           cIdEntidadContable , " + //7
        "           cIdRelacion , " + //8
        "           EP , " + //9
        "           cIdCuentaContable , " + //10
        "           mComprometido , " + //11
        "           nPoliza , " + //12
        ...
        "           mImporteFlete4 , " + //38
        "           mISRArrenda , " + //39
        "           mRetImpuestoCedular , " + //40
        "           mBruto , " + //41
        "           mAmortizacionAnticipo , " + //42
        "           mIVA , " + //43
        "           mNeto , " + //44
        "           m5Millar , " + //45
        "           mFletes , " + //46
        "           mCedular , " + //47
        "           mImporte , " + //48
        "           mImporteIvaArrenda , " + //49
        "           mImporteIvaHonorarios , " + //50
        "           mImporteFlete23 , " + //51
        "           mImporteIvaProv , " + //52
        "           mImporteObra , " + //53
        "           mCNIC , " + //54
        ...
        "           Periodo13 , " + //59
        "           ADEFAS , " + //60
        "           mImporteISRLaudos, " + //61
        "			 cUnidadResponsable " + "         ) " + //1
        " VALUES  ( ? , 	 " + //2
        "           ? , 	 " + //3
        "           ? , 	 " + //4
        "           ? , 	 " + //5
