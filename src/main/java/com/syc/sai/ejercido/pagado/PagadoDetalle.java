...
public class PagadoDetalle {
    ...
    private BigDecimal importe23IVA;

    private BigDecimal importe2Millar;

    private BigDecimal importeAmortiza;

    private BigDecimal importeBruto;

    private BigDecimal importeCNIC;

    private BigDecimal importeComprometido;

    private BigDecimal importeDevolucion;

    private BigDecimal importeFlete23;

    private BigDecimal importeFlete4;

    private BigDecimal importeIMDT;

    private BigDecimal importeISRArrenda;

    private BigDecimal importeISRHonorarios;

    private BigDecimal importeISRLaudos;

    private BigDecimal importeIva;

    private BigDecimal importeIvaArrenda;

    private BigDecimal importeIvaHonorarios;

    private BigDecimal importeIvaProv;
    ...
    private BigDecimal importeObra5;

    private BigDecimal importePenalizacion;

    private BigDecimal importeRetencion;

    private BigDecimal importeRetImpuestoCedular;

    private BigDecimal importeSancion;

    private BigDecimal importeTesofe;
    ...
    /**
     * @return the importeComprometido
     */
    ...
    /**
     * @return the importeISRHonorarios
     */
    ...
    /**
     * @return the importeIvaHonorarios
     */
    ...
    /**
     * @return the importePenalizacion
     */
    ...
    /**
     * @return the importeRetImpuestoCedular
     */
    ...
    /**
     * @param idTipoConcepto
     *            the idTipoConcepto to set
     */
    ...
    /**
     * @param importe2Millar
     *            the importe2Millar to set
     */
    ...
    /**
     * @param importeAmortiza
     *            the importeAmortiza to set
     */
    ...
    /**
     * @param importeComprometido
     *            the importeComprometido to set
     */
    ...
    /**
     * @param importeFlete23
     *            the importeFlete23 to set
     */
    ...
    /**
     * @param importeISRArrenda
     *            the importeISRArrenda to set
     */
    ...
    /**
     * @param importeISRHonorarios
     *            the importeISRHonorarios to set
     */
    ...
    /**
     * @param importeISRLaudos the importeISRLaudos to set
     */
    ...
    /**
     * @param importeIvaArrenda
     *            the importeIvaArrenda to set
     */
    ...
    /**
     * @param importeIvaHonorarios
     *            the importeIvaHonorarios to set
     */
    ...
    /**
     * @param importeIvaProv
     *            the importeIvaProv to set
     */
    ...
    /**
     * @param importePenalizacion
     *            the importePenalizacion to set
     */
    ...
    /**
     * @param importeRetImpuestoCedular
     *            the importeRetImpuestoCedular to set
     */
     ...
     *            the oBGT to set
     */
    public void setOBGT(int oBGT) {
        OBGT = oBGT;
    }

    public void setPasivoDiferido(BigDecimal pasivoDiferido) {
        this.pasivoDiferido = pasivoDiferido;
    }
    ...
    public String toString() {
        return "PagadoDetalle [tipoPago=" + tipoPago + ", folioPAGO=" + folioPAGO + ", docRenglon=" + docRenglon + ", mes=" + mes + ", idEntidadContable=" + idEntidadContable + ", idRelacion=" + idRelacion + ", EP=" + EP + ", idCuentaContable=" + idCuentaContable + ", importeComprometido=" + importeComprometido + ", numeroPoliza=" + numeroPoliza + ", idTipoMovimiento=" + idTipoMovimiento + ", IdTipoConcepto=" + IdTipoConcepto + ", evento=" + evento + ", centroContable=" + centroContable + ", RFC=" + RFC + ", importeNeto=" + importeNeto + ", ALM=" + ALM + ", importeBruto=" + importeBruto + ", importeMasIva=" + importeMasIva + ", importeIva=" + importeIva + ", capitulo=" + capitulo + ", importeSancion=" + importeSancion + ", importeDevolucion=" + importeDevolucion + ", importeAmortiza=" + importeAmortiza + ", importeRetencion=" + importeRetencion + ", importePenalizacion=" + importePenalizacion + ", importe2Millar=" + importe2Millar + ", importe23IVA=" + importe23IVA + ", importeISRHonorarios=" + importeISRHonorarios + ", importeObra5=" + importeObra5 + ", importeFlete4=" + importeFlete4 + ", importeISRArrenda=" + importeISRArrenda + ", importeRetImpuestoCedular=" + importeRetImpuestoCedular + ", importeIvaArrenda=" + importeIvaArrenda + ", importeIvaHonorarios=" + importeIvaHonorarios + ", importeFlete23=" + importeFlete23 + ", importeIvaProv=" + importeIvaProv + ", importeObra=" + importeObra + ", importeCNIC=" + importeCNIC + ", importeTesofe=" + importeTesofe + ", altaAlmacen=" + altaAlmacen + ", ejercicioFiscal=" + ejercicioFiscal + ", importeIMDT=" + importeIMDT + ", importe=" + importe + ", folioPagado=" + folioPagado + ", OBGT=" + OBGT + ", CTAB=" + CTAB + ", cUnidadResponsable=" + cUnidadResponsable + "]";
    }
}
