...
public class PagadoDetalle {
	...
	public String toString() {
		return "PagadoDetalle [tipoPago=" + tipoPago + ", folioPAGO=" + folioPAGO + ", docRenglon=" + docRenglon + ", mes=" + mes + ", idEntidadContable=" + idEntidadContable + ", idRelacion=" + idRelacion + ", EP=" + EP + ", idCuentaContable=" + idCuentaContable + ", importeComprometido="
			+ importeComprometido + ", numeroPoliza=" + numeroPoliza + ", idTipoMovimiento=" + idTipoMovimiento + ", IdTipoConcepto=" + IdTipoConcepto + ", evento=" + evento + ", centroContable=" + centroContable + ", RFC=" + RFC + ", importeNeto=" + importeNeto + ", ALM=" + ALM + ", importeBruto="
			+ importeBruto + ", importeMasIva=" + importeMasIva + ", importeIva=" + importeIva + ", capitulo=" + capitulo + ", importeSancion=" + importeSancion + ", importeDevolucion=" + importeDevolucion + ", importeAmortiza=" + importeAmortiza + ", importeRetencion=" + importeRetencion
			+ ", importePenalizacion=" + importePenalizacion + ", importe2Millar=" + importe2Millar + ", importe23IVA=" + importe23IVA + ", importeISRHonorarios=" + importeISRHonorarios + ", importeObra5=" + importeObra5 + ", importeFlete4=" + importeFlete4 + ", importeISRArrenda="
			+ importeISRArrenda + ", importeRetImpuestoCedular=" + importeRetImpuestoCedular + ", importeIvaArrenda=" + importeIvaArrenda + ", importeIvaHonorarios=" + importeIvaHonorarios + ", importeFlete23=" + importeFlete23 + ", importeIvaProv=" + importeIvaProv + ", importeObra=" + importeObra
			+ ", importeCNIC=" + importeCNIC + ", importeTesofe=" + importeTesofe + ", altaAlmacen=" + altaAlmacen + ", ejercicioFiscal=" + ejercicioFiscal + ", importeIMDT=" + importeIMDT + ", importe=" + importe + ", folioPagado=" + folioPagado + ", OBGT=" + OBGT + ", CTAB=" + CTAB
