...
public class CuentasManager {
	private static Logger	log	= Logger.getLogger(CuentasManager.class);
	
	public static Cuentas readCuentas(
		Connection conn, 
		String nCuenta){
	...
	private static Cuentas extraeCuentas(ResultSet rs)
			throws CuentasEngineException {
		try {
	...
	private static String extraePartida(ResultSet rs)
		throws CuentasEngineException {
	try {
		Cuentas pojo = new Cuentas();
