...
public class EventoManualManager {
	private static Logger	log	= Logger.getLogger(EventoManualManager.class);
	
	public static EventoManual readEventoManual(
		Connection conn, 
		Integer cIdGrupoEvento, 
		Integer cIdSubGrupoEvento, 
		String cIdEventoManual,
		Integer cPartida,
		String nCuenta){
	...
	public static int saveOrUpdateEventoManual(Connection conn, EventoManual eventoManual) throws EventoManualEngineException{
		if(readEventoManual(
				conn,
				eventoManual.getCidGrupoEvento(),
				eventoManual.getCidSubGrupoEvento(), 
				eventoManual.getCidEventoManual(),
				eventoManual.getCpartida(),
				eventoManual.getNcuenta())==null){
	...
	private static EventoManual extraeEventoManual(ResultSet rs)
			throws EventoManualEngineException {
		try {
