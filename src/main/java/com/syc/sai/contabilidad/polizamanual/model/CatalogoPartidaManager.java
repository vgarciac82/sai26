...
public class CatalogoPartidaManager {
    ...
    private static Logger log = LoggerFactory.getLogger(CatalogoPartidaManager.class);

    public static CatalogoPartida readCatalogoPartida(Connection conn, String cPartida) {
    ...
    private static CatalogoPartida extraeCatalogoPartida(ResultSet rs) throws CatalogoPartidaEngineException {
        try {
