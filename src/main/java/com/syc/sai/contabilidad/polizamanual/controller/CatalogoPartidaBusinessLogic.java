...
public class CatalogoPartidaBusinessLogic extends DataSourceManager {
    ...
    Logger log = LoggerFactory.getLogger(CatalogoPartidaBusinessLogic.class);
    ...
    public List<CatalogoPartida> autocompleteCatalogoPartida(HttpServletRequest req) throws CatalogoPartidaEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
