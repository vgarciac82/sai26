...
public class DocPolizaDetalle implements java.io.Serializable {
	...
	/** minimal constructor */
	public DocPolizaDetalle(
			DocPolizaEncabezado tdocPolizaEncabezado, String periodo13,
			String adefas, Integer ntipoAjuste, String parcial, String ccabms,
			Integer ccucop, String cpartida) {
	...
	public void setTdocPolizaEncabezado(
			DocPolizaEncabezado tdocPolizaEncabezado) {
		this.tdocPolizaEncabezado = tdocPolizaEncabezado;
	}
