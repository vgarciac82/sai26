...
public class IngresoGreenMexManager {
	...
	private static final Logger	log				= Logger.getLogger( IngresoGreenMexManager.class );
	...
	public static boolean aplicarIngresoGreenMex( Connection conn, String documento, String nFolio, String tablaEncabezado, String tablaDetalle, String campo ) throws EgresoException {
		...
		try {
			...
			log.debug( "Se insertaron " + insertados + " campos para aplicar el Ingreso para GREENMEX " );
			log.info( " Aplicando motor para el Ingreso para GREENMEX " + nFolioIngresoGreenMex );
