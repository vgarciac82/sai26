...
public class RSToTable {
	...
	private static final Logger	log				= Logger.getLogger(RSToTable.class);
	...
	private static final String	htmlBodyI		= "<HTML>\n " + "\t<HEAD>\n " + "\t\t<TITLE>\n</TITLE>\n " + "\t\t<style type=\"text/css\">\n " + "\t\t\tbody {\n " + "\t\t\t\tfont-family: Arial, \"Helvetica Neue\", Helvetica, sans-serif;\n " + "\t\t\t\tfont-size: 18;\n " + "\t\t\t}\n "
		+ ".encabezadoTopBottomRight { " + "	border-top-style: solid; " + "	border-top-color: black; " + "	border-top-width: thin; " + "	border-bottom-style: solid; " + "	border-bottom-color: black; " + "	border-bottom-width: thin; " + "	border-right-style: solid; "
		+ "	border-right-color: black; " + "	border-right-width: thin; " + "}" + "\t\t\t.encabezadoTopBottomLeft { " + "\t\t\t\t	border-top-style: solid;\n " + "\t\t\t\t	border-top-color: black;\n " + "\t\t\t\t	border-top-width: thin;\n " + "\t\t\t\t	border-bottom-style: solid;\n "
	...
	public static Map<String, String> rsToMapCaseSensitive(ResultSet rs) throws SQLException {
		...
		if (rs.next()) {
			...
			for (int i = 1; i < rsmd.getColumnCount() + 1; i++) {
				...
				log.debug(nombreColumna + "," + type + "," + rs.getString(rsmd.getColumnName(i)));
	...
	public static List<List<String>> rsToList(ResultSet rs) throws Exception {
		...
		for (int i = 1; i < numColumns + 1; i++)
			encabezado.add(rsmd.getColumnName(i));
	...
	public static String rsToTable(ResultSet rs, Map<String, Integer> anchor, boolean includeClasses) throws Exception {
		...
		while (rs.next()) {
			...
			for (int i = 1; i < numColumns + 1; i++) {
				...
				if ("APLICADO".equals(column_name) || "REINTEGRO".equals(column_name) || "EJERCIDO".equals(column_name) || "Cargos".equals(column_name) || "Abonos".equals(column_name) || "mMovimiento".equals(column_name) || "Total".equals(column_name) || // Hoja
																																																																// de
																																																																// Trabajo
					"SaldoInicialDeudor".equals(column_name) || "SaldoInicialAcreedor".equals(column_name) || "MovimientosAcumuladosDebe".equals(column_name) || "MovimientosAcumuladosHaber".equals(column_name) || "SaldoAntesAjusteDeudor".equals(column_name)
					|| "SaldoAntesAjusteAcreedor".equals(column_name) || "AjustePrevDeudor".equals(column_name) || "AjustePrevAcreedor".equals(column_name) || "SaldoPreviosDeudor".equals(column_name) || "SaldoPreviosAcreedor".equals(column_name) || "AjustePresupDeudor".equals(column_name)
					|| "AjustePresupAcreedor".equals(column_name) || "SaldoAjustadosDeudor".equals(column_name) || "SaldoAjustadosAcreedor".equals(column_name) || "AjusteResulDeudor".equals(column_name) || "AjusteResulAcreedor".equals(column_name) || "SaldoFinalDeudor".equals(column_name)
					|| "SaldoFinalAcreedor".equals(column_name) || "DeudorAnterior".equals(column_name) || // Variaciones
					"AcreedorAnterior".equals(column_name) || "DeudorActual".equals(column_name) || "AcreedorActual".equals(column_name) || "variaciondeudor".equals(column_name) || "variacionacreedor".equals(column_name) || "ImporteDeudor".equals(column_name) || // Cuentas
																																																																		// Enlace
					"ImporteAcreedor".equals(column_name) || "MovimientoDeudor".equals(column_name) || // Rectificaciones
																										// al
																										// Ejercicio
					"MovimientoAcreedor".equals(column_name) || "MovimientoDebe".equals(column_name) || // Afectaciones
																										// a
																										// cuentas
					"MovimientoHaber".equals(column_name) || "TG1_Gasto_Corriente".equals(column_name) || // Analisis
																											// de
																											// la
																											// Incidencia
					"TG2_Gasto_de_Inversión".equals(column_name) || "TG3_Gasto_de_Obra_Pública".equals(column_name) || "TG4".equals(column_name) || "TG5".equals(column_name) || "TG6".equals(column_name) || "TG7_Otro_Corriente".equals(column_name) || "TG8_Otro_Inversión".equals(column_name)
					|| "TG9_Gasto_de_Inversión_a_Fideicomi".equals(column_name) || "TG0_Gasto_Corriente_a_Fideicomisos".equals(column_name) || "Corriente".equals(column_name) || "Inversion".equals(column_name) || "ObraPublica".equals(column_name) || "Cuentas".equals(column_name)
					|| "ImportePresupuestarios".equals(column_name) || // Integracion
																		// del
																		// Costo
					"ImporteNoPresupuestarios".equals(column_name) || "Original".equals(column_name) || // Presupuestal
					"AmplPresupLiquidas".equals(column_name) || "ReduPresupLiquidas".equals(column_name) || "AmplReduCompensadas".equals(column_name) || "ModifAutorizado".equals(column_name) || "Devengado".equals(column_name) || "Ejercido".equals(column_name)
					|| "DevengadoEjercido".equals(column_name) || "Pagado".equals(column_name) || "Economias".equals(column_name) || "TotalDevengadoEjercidoAnterior".equals(column_name) || // Analisis
																																																// del
																																																// gasto
																																																// por
																																																// Funcion
					"OriginalAutorizado".equals(column_name) || "TotalDevengadoEjercido".equals(column_name) || "DiferenciaCB".equals(column_name) || "DiferenciaCA".equals(column_name) || "ReferenciaCB".equals(column_name) || "ReferenciaCA".equals(column_name) || "Diferencia".equals(column_name) || // Analisis
																																																																											// del
																																																																											// Gatso
																																																																											// Federalizado
					"Referencia".equals(column_name) || "ServPersonalesOTG".equals(column_name) || // Gasto
																									// por
																									// Entidad
																									// Federativa
					"ServPersonalesTG3".equals(column_name) || "MatSuministrosOTG".equals(column_name) || "MatSuministrosTG3".equals(column_name) || "ServGeneralesOTG".equals(column_name) || "ServGeneralesTG3".equals(column_name) || "TransfAsigSubsiOtrsAyudasOTG".equals(column_name)
					|| "TransfAsigSubsiOtrsAyudasTG3".equals(column_name) || "BienMueInmueIntanOTG".equals(column_name) || "BienMueInmueIntanTG3".equals(column_name) || "InverPúblicaOTG".equals(column_name) || "InverFinaOtrasProvOTG".equals(column_name) || "InverFinaOtrasProvTG3".equals(column_name)
					|| "PartAportacionesOTG".equals(column_name) || "PartAportacionesTG3".equals(column_name) || "OriginalGastoCorriente".equals(column_name) || // Recursos
																																									// Federal
					"OriginalGastoCapital".equals(column_name) || "OriginalTotal".equals(column_name) || "DevengadoEjercidoGastoCorriente".equals(column_name) || "DevengadoEjercidoGastoCapital".equals(column_name) || "DevengadoEjercidoTotal".equals(column_name)
