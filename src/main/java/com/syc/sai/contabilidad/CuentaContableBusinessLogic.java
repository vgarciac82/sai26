...
public class CuentaContableBusinessLogic extends DataSourceManager {
    ...
    Logger log = LoggerFactory.getLogger(CuentaContableBusinessLogic.class);
    ...
    public String actualizaCuenta(CuentaContable c) {
        ...
        try {
            ...
            for (Iterator<CondicionCuentaContable> i = condiciones.iterator(); i.hasNext(); ) {
            ...
            if (conn != null)
                try {
                    ...
                    log.error("Error realizando rollback a la conexion. " + e2.toString(), e2);
                }
            ...
            if (conn != null)
                try {
                    ...
                    log.error("Error cerrando conexion a base de datos " + e2.toString(), e2);
                }
        }
        return msg;
    }
    ...
    public List<CuentaContable> buscaCuentas(CuentaContable cuenta) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    public ArrayList<CuentaContable> creaArbol() throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    public List<CuentaContable> buscaCuentasDeAplicacion(CuentaContable cuenta) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    // Ing J. Luis DR
    public List<GrupoEvento> autoCompletaGrupoEvento(String aux) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    public List<EventoRelacion> autoCompletaEventoRelacion(String nGrupo, String nSubGrupo, String nEvento) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    public List<CatalogoCabms> autoCompletaCABMS(String nGrupo, String nSubGrupo, String nEvento, String nCABMS) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    public List<CatalogoCabms> selectCABMS(String type, String id) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
    ...
    //************************************************************************************************
    public boolean cuentaBloqueada(String nCuenta, int nMes, String cCentroContable, String operacion) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
            return CuentaContableManager.cuentaBloqueada(conn, nCuenta, nMes, cCentroContable, operacion);
        } catch (Exception e) {
            ...
            if (conn != null)
                try {
                    ...
                    log.warn("Error cerrando conexion a la base de datos " + e, e);
                }
            conn = null;
        }
    }

    public String[] cuentasBloqueadas(String cuentasCargo, String cuentasAbono, String cCentroContable, int nMes) throws AccountingEngineException {
        Connection conn = null;
        try {
            conn = getConnection();
            return CuentaContableManager.cuentasBloqueadas(conn, cuentasCargo, cuentasAbono, cCentroContable, nMes);
        } catch (Exception e) {
            throw new AccountingEngineException(e.toString(), e);
        } finally {
            if (conn != null)
    ...
    public String insertaCuenta(CuentaContable c) {
        ...
        try {
            ...
            if (c.getNivelCuenta() > 1) {
                ...
                if (l != null && l.size() > 0) {
                    c.setnNivelBalanza(l.get(0).getnNivelBalanza() + (sinHermanos ? 1 : 0));
