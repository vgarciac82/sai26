...
public class ConsultaPolizasServlet extends HttpServlet {
	...
	private static final Logger log = Logger
			.getLogger(ConsultaPolizasServlet.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String PolEjercicioFiscal = getValor(req
				.getParameter("PolEjercicioFiscal"));
		String PolStatus = getValor(req.getParameter("PolStatus"));
		String PolFechCapturaIni = getValor(req
				.getParameter("PolFechCapturaIni"));
		String PolFechCapturaFin = getValor(req
				.getParameter("PolFechCapturaFin"));
		String PolTipo = getValor(req.getParameter("PolTipo"));
		String PolFechAplicacionIni = getValor(req
				.getParameter("PolFechAplicacionIni"));
		String PolFechAplicacionFin = getValor(req
				.getParameter("PolFechAplicacionFin"));
		...
		if (PolCtroContable == "" & PolEjercicioFiscal == "" & PolStatus == ""
				& PolFechCapturaIni == "" & PolFechCapturaFin == ""
				& PolTipo == "" & PolFechAplicacionIni == ""
				& PolFechCapturaFin == "" & PolAutorizo == ""
				& PolNumeroIni == "" & PolNumeroFin == "" & PolMontoIni == ""
			...
			String json = rbl.ConsultaPolizasResultadoJSON(PolCtroContable,
					PolEjercicioFiscal, PolStatus, PolFechCapturaIni,
					PolFechCapturaFin, PolTipo, PolFechAplicacionIni,
					PolFechAplicacionFin, PolAutorizo, PolNumeroIni,
					PolNumeroFin, PolMontoIni, PolMontoFin, PolOrigen,
					PolAutomatica );//,PolIdOper);
			resp.setContentType("application/json");
