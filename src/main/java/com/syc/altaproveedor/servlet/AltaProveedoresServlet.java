...
public class AltaProveedoresServlet extends HttpServlet implements GestionInterface {
		...
		try {
			...
			switch ( tipoOperacion ) {
				...
				case 1:// consulta
					...
					respuesta = true;
				break;
				case 2:// valida si ya se encuentra registrado el RFC
					datProveedor = fillDatProvedor( request );
				...
				case 4:// consulta documentos
					...
					jsonObj = new JSONObject();
				break;
				case 5:// valida datos de cuentas bancarias
					datProveedor = fillDatProvedor( request );
					...
					jsonObj = new JSONObject();
				break;
				case 6:// consulta documentos cta bancaria
					datProveedor = fillDatProvedor( request );
				...
				case 8:// Autoriza Proveedor
					...
					jsonObj = new JSONObject();
				break;
				case 9:// Modifica alta Proveedor
					datProveedor = fillDatProvedor( request );
					...
					jsonObj = new JSONObject();
				break;
				case 10:// Enviar (Captura, devolución de validación y
					...
					jsonObj = new JSONObject();
				break;
				case 11: // regresa a consulta el folio
					datProveedor = fillDatProvedor( request );
					...
					jsonObj = new JSONObject();
				break;
				case 12:// Eminina ctas bancarias
					datProveedor = fillDatProvedor( request );
					...
					jsonObj = new JSONObject();
				break;
				case 13://Captura proveedor incumplido
	...
	private DatosProveedorIncumplido fillDatProvedorIncumplido( HttpServletRequest request,Usuario u  ) throws Exception {
		...
		try {
			...
			datProveedorIncump.setcIdRFC( request.getParameter( "cIdRFC" ) );//validar
			...
			datProveedorIncump.setcOficioSancion( request.getParameter( "cOficioSancion" ) );//validar
			datProveedorIncump.setcRazonSocial( ( request.getParameter( "cRazonSocial" ) )  );//validar
			datProveedorIncump.setfFechaOficioSancion( request.getParameter( "fFechaOficioSancion" ) );//validar
			datProveedorIncump.setfFechaTerminoFirma( request.getParameter( "fFechaTerminoFirma" ) );//validar
