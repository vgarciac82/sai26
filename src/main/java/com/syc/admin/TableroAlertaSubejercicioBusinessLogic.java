...
public class TableroAlertaSubejercicioBusinessLogic extends DataSourceManager {
	...
	private static final Logger log = Logger.getLogger(TableroAlertaSubejercicioBusinessLogic.class);
	...
	public double sumaRenglonModificado(Map<String, String> renglon) {
		return Double.parseDouble(renglon.get("saldo_Modificado_servicios_personales") == null ? "0" : renglon.get("saldo_Modificado_servicios_personales")) 
			+ Double.parseDouble(renglon.get("saldo_Modificado_Gastos_de_Operacion") == null ? "0" : renglon.get("saldo_Modificado_Gastos_de_Operacion"))
			+ Double.parseDouble(renglon.get("saldo_Modificado_Subsidios_Corrientes") == null ? "0" : renglon.get("saldo_Modificado_Subsidios_Corrientes")) 
			+ Double.parseDouble(renglon.get("saldo_Modificado_Otros_Corrientes") == null ? "0" : renglon.get("saldo_Modificado_Otros_Corrientes"))
			+ Double.parseDouble(renglon.get("saldo_Modificado_Bienes_Muebles_e_Inmuebles") == null ? "0" : renglon.get("saldo_Modificado_Bienes_Muebles_e_Inmuebles")) 
			+ Double.parseDouble(renglon.get("saldo_Modificado_Obra_Publica") == null ? "0" : renglon.get("saldo_Modificado_Obra_Publica"))
			+ Double.parseDouble(renglon.get("saldo_Modificado_Otros_de_Inversion_Fisica") == null ? "0" : renglon.get("saldo_Modificado_Otros_de_Inversion_Fisica"))
			+ Double.parseDouble(renglon.get("saldo_Modificado_Subsidios_Inversion") == null ? "0" : renglon.get("saldo_Modificado_Subsidios_Inversion"));
	}
	...
	public double sumaRenglonDisponible(Map<String, String> renglon) {
		return Double.parseDouble(renglon.get("saldo_disponible_servicios_personales") == null ? "0" : renglon.get("saldo_disponible_servicios_personales")) 
			+ Double.parseDouble(renglon.get("saldo_disponible_Gastos_de_Operacion") == null ? "0" : renglon.get("saldo_disponible_Gastos_de_Operacion"))
			+ Double.parseDouble(renglon.get("saldo_disponible_Subsidios_Corrientes") == null ? "0" : renglon.get("saldo_disponible_Subsidios_Corrientes")) 
			+ Double.parseDouble(renglon.get("saldo_disponible_Otros_Corrientes") == null ? "0" : renglon.get("saldo_disponible_Otros_Corrientes"))
			+ Double.parseDouble(renglon.get("saldo_disponible_Bienes_Muebles_e_Inmuebles") == null ? "0" : renglon.get("saldo_disponible_Bienes_Muebles_e_Inmuebles")) 
			+ Double.parseDouble(renglon.get("saldo_disponible_Obra_Publica") == null ? "0" : renglon.get("saldo_disponible_Obra_Publica"))
			+ Double.parseDouble(renglon.get("saldo_disponible_Otros_de_Inversion_Fisica") == null ? "0" : renglon.get("saldo_disponible_Otros_de_Inversion_Fisica"))
			+ Double.parseDouble(renglon.get("saldo_disponible_Subsidios_Inversion") == null ? "0" : renglon.get("saldo_disponible_Subsidios_Inversion"));
	}
