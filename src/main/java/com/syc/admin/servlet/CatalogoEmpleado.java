...
public class CatalogoEmpleado {
    ...
    public static int insert(Connection conn, CatEmpleado ce) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("INSERT INTO cg_cat_empleado (id_empleado, ce_nombre_completo, ce_ap_paterno, ce_ap_materno, ce_os_responsable, salutacion, tipo_rem_des) VALUES (?, ?, ?, ?, ?, ?, ?)");
