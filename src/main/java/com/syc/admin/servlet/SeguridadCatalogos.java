			...
			*/
            ...
            if (req.getParameter("rn").equals("ReporteEstadisticoConsolidado.jasper")) {
                ...
                if (req.getParameter("select").equals("4")) {
                    parms1.put("consolidado", ", col_1, sum(pendientesVencidos) pendientesVencidos, sum(pendientesNoVencidos) pendientesNoVencidos, sum(pendientes) pendientes, sum(cerrado) cerrado, sum(casos) casos");
            ...
            if (req.getParameter("rn").equals("ReporteGeneral.jasper")) {
                if (!req.getParameter("DPC0_fechaInicial").equals("") && !req.getParameter("DPC0_fechaFinal").equals("")) {
                    parms1.put("whereFechaReg", "AND CONVERT(DATETIME, vimx.FECHAREGISTRO, 103) BETWEEN '" + req.getParameter("DPC0_fechaInicial") + "' AND '" + req.getParameter("DPC0_fechaFinal") + "'");
                }
                if (!req.getParameter("DPC1_fechaInicial").equals("") && !req.getParameter("DPC1_fechaFinal").equals("")) {
                    parms1.put("whereFechaLim", "AND CONVERT(DATETIME, vimx.FECHAREGISTRO, 103) BETWEEN '" + req.getParameter("DPC1_fechaInicial") + "' AND '" + req.getParameter("DPC1_fechaFinal") + "'");
                }
                ...
                if (!req.getParameter("opc").equals("")) {
                    ...
                    if (req.getParameter("opc").equals("11")) {
                        if (!req.getParameter("idareaTotal").equals("")) {
                            parms1.put("whereAreaRecibido", "AND vimx.RESPONSABLE_AREA ='" + req.getParameter("idarea") + "' AND vimx.REMITENTE_AREA = '" + req.getParameter("idareaTotal") + "'");
                        }
                        if (!req.getParameter("res_u_login").equals("")) {
                            parms1.put("whereNombreRecibido", "AND vimx.RESPONSABLE_AREA ='" + req.getParameter("idarea") + "' AND vimx.REMITENTE_ID = '" + req.getParameter("res_u_login") + "'");
                        }
                    }
                }
            ...
            if (req.getParameter("rn").equals("ReporteGen.jasper")) {
				...
				*/
                ...
                } else if (//Nombre del ï¿½rea remitente.
                name.equals("rem_area")) {
                    if (value.trim().equals(""))
                        parms1.put("remArea", null);
                    else
                        parms1.put("remArea", value);
                } else if (//ID del ï¿½rea remitente.
                name.equals("rem_idarea")) {
                    if (value.trim().equals(""))
                        parms1.put("remIdArea", null);
                    else
                        parms1.put("remIdArea", value);
                } else if (//Nombre del usuario remitente
                name.equals("rem_nombre")) {
                    if (value.trim().equals(""))
                        parms1.put("remNombre", null);
                    else
                        parms1.put("remNombre", value);
                } else if (//ID del usuario remitente
                name.equals("rem_id")) {
                    if (value.trim().equals(""))
                        parms1.put("remId", null);
                    else
                        parms1.put("remId", value);
                } else if (//Tipo de instruccion
                name.equals("tipo_instruccion")) {
                    if (value.trim().equals(""))
                        parms1.put("tipo_instruccion", null);
                    else
                        parms1.put("tipo_instruccion", value);
                } else if (//Status (Pendiente Vencido, Pendiente No Vencido, Pendiente, Concluido)
                name.equals("estatus")) {
                    //
                    if (value.trim().equals(""))
                ...
                } else if (//Prioridad (N: Normal, U: Urgente)
                name.equals("tipo_prioridad")) {
                    if (value.trim().equals(""))
                ...
                } else if (//Nombre del usuario registrado en el sistema
                name.equals("nlogin")) {
                    if (value.trim().equals(""))
                        parms1.put("nlogin", null);
                    else
                        parms1.put("nlogin", value);
                } else if (//Nombre de la cuenta de suplantaciï¿½n del usuario conectado al sistema
                name.equals("nlogine")) {
                    if (value.trim().equals(""))
            ...
            if (req.getParameter("rn").equals("ReporteDinamico.jasper")) {
                ...
                if (!req.getParameter("DPC1_fechaInicial").equals("")) {
                    parms1.put("SCfechaRegistro", "AND CONVERT(DATETIME," + req.getParameter("chk_fechaRegistro") + ", 103) BETWEEN '" + req.getParameter("DPC1_fechaInicial") + "' AND '" + req.getParameter("DPC1_fechaFinal") + "'");
                }
                if (!req.getParameter("DPC2_fechaInicial").equals("")) {
                    parms1.put("SCfechaRecepcion", "AND CONVERT(DATETIME," + req.getParameter("chk_fechaRecepcion") + ", 103) BETWEEN '" + req.getParameter("DPC2_fechaInicial") + "' AND '" + req.getParameter("DPC2_fechaFinal") + "'");
                }
                if (!req.getParameter("DPC3_fechaInicial").equals("")) {
                    parms1.put("SCfechaDocumento", "AND CONVERT(DATETIME," + req.getParameter("chk_fechaDocumento") + ", 103) BETWEEN '" + req.getParameter("DPC3_fechaInicial") + "' AND '" + req.getParameter("DPC3_fechaFinal") + "'");
                }
                if (!req.getParameter("DPC4_fechaInicial").equals("")) {
                    parms1.put("SCfechaLimite", "AND CONVERT(DATETIME," + req.getParameter("chk_fechaLimite") + ", 103) BETWEEN '" + req.getParameter("DPC4_fechaInicial") + "' AND '" + req.getParameter("DPC4_fechaFinal") + "'");
                }
