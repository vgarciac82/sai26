...
public class MensajesBusinessLogic extends DataSourceManager {
	...
	private static Logger log = Logger.getLogger(MensajesBusinessLogic.class);
	...
	public synchronized boolean EnviaMensaje(String u_login, String[] para, String asunto, String body)
