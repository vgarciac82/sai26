...
public class CatalogoRemitenteArea {
    ...
    public static int insert(Connection conn, CatRemArea cra) throws SQLException {
        ...
        try {
            String valor1 = "";
            valor1 = "SELECT Count(*) total FROM cg_cat_remitente_area" + " Where cra_id_area ='" + cra.getCra_id_area() + "'" + " AND cra_descripcion='" + cra.getCra_descripcion() + "'" + " AND tipo='" + cra.getTipo() + "'" + " AND orden='" + cra.getOrden() + "'";
