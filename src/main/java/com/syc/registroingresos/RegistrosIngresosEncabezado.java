...
public class RegistrosIngresosEncabezado {
	...
	private String cTipoIngreso; // se refiere al tipo de ingreso : Ingresos Propios, Ingresos Fiscales.
	private String fCaptura; //fecha
	...
	private int nFolioApartado; // Folio apartado para Recurso Fiscal
