/*
 * @(#)JarOutputStream.java	1.21 03/01/23
 *
...
public class JarOutputStream extends ZipOutputStream {
	...
	public JarOutputStream(OutputStream out, Manifest man, String encoding) throws IOException {
		super(out, encoding);
		if (man == null) {
			throw new NullPointerException("man");
		}
	...
	public JarOutputStream(OutputStream out, String encoding) throws IOException {
		super(out, encoding);
	}
