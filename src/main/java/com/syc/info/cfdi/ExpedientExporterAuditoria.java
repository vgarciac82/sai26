...
public class ExpedientExporterAuditoria {
	...
	public ExpedientExporterAuditoria( ) throws Exception {
		...
		log = Logger.getLogger( ExpedientExporterAuditoria.class );
	...
	private void configure() throws Exception {
		...
		for ( int i = 0; i < days.length; i++ )
			ExpedientExporterAuditoria.EXECUTION_DAYS.add( ExpedientExporterAuditoria.WEEK_DAYS_KEY.get( days[i] ) );
