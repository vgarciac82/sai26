...
import com.syc.reportes.core.ReportePlurianualesManager;
import com.syc.sai.contabilidad.utils.db.CloseObject;
import java.util.Base64;

@SuppressWarnings("unused")
public class ReportePlurianualesBusinessLogic extends DataSourceManager {

    public ReportePlurianualesBusinessLogic(String jniName) {
        super.init(jniName);
    }
    ...
    public void generaReporte(HttpServletRequest req, HttpServletResponse response, Map<String, String> plantilla) throws Exception {
        ...
        try {
            ...
            file = ReportePlurianualesManager.ReportePlurianualManager(conn, trimestre, anio, plantilla);
