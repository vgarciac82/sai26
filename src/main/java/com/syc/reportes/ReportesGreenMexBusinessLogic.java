...
import com.syc.reportes.core.ReportesGreenMexManager;
import com.syc.sai.contabilidad.utils.db.CloseObject;

public class ReportesGreenMexBusinessLogic extends DataSourceManager {

	public ReportesGreenMexBusinessLogic(String jniName) {	
		super.init(jniName);
	}
	...
	public void generaReporte(HttpServletRequest req, HttpServletResponse resp, Map<String, String> plantillas) throws Exception {
		...
		try {
			...
			file = ReportesGreenMexManager.ReporteFinancieroGreenMex(conn, fechaInicio, plantillas);
			conn.commit();
