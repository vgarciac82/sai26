...
public class PolizaCierreBusinessLogic extends DataSourceManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(PolizaCierreBusinessLogic.class);
        ...
        try {
            ...
            if (conn != null)
                try {
                    ...
                    log.warn("Error occurred", "Ocurrio un error al realizar rollback:" + e2);
                }
            throw e;
        } finally {
            CloseObject.closeObject(conn, false);
