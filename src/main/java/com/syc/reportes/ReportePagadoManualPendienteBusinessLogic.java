...
public class ReportePagadoManualPendienteBusinessLogic extends DataSourceManager {
    ...
    public ReportePagadoManualPendienteBusinessLogic(String jniName) {
        super.init(jniName);
    }
    ...
    public void generaReporte(HttpServletRequest req, HttpServletResponse resp, Map<String, String> plantilla) throws Exception {
        ...
        try {
            ...
            file = ReportePagadoManualPendienteManager.ReporteManager(conn, fechaInicio, fechaFin, cUR, todos, plantilla);
