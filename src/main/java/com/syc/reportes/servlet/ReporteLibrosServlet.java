...
@WebServlet(name = "ReporteLibrosServlet", urlPatterns = { "/reportes/ReporteLibros" })
public class ReporteLibrosServlet extends HttpServlet implements GestionInterface {

    private static final long serialVersionUID = 6723127616859732249L;

    private static final Logger log = LoggerFactory.getLogger(ReporteLibrosServlet.class);
