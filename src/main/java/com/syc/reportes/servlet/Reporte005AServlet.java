    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        synchronized (this) {
            if (plantillas == null) {
                ...
                //PLANTILLA SIN LA COLUMNA DE LA PARTIDA
                plantillas.put("Formato005A_2020", getServletContext().getRealPath("Reportes" + File.separator + "Plantilla_Formato_005A_2020.xls"));
            }
        }
    }
}
