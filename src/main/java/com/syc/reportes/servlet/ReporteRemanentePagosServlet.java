...
public class ReporteRemanentePagosServlet extends HttpServlet implements GestionInterface {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (u == null)
            throw new ServletException("Su session a caducado");
        ReporteRemanentePagosBusinessLogic rrs = new ReporteRemanentePagosBusinessLogic(jniName);
        try {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        synchronized (this) {
            if (plantillas == null) {
                ...
                plantillas.put("SALDOPAGOS", getServletContext().getRealPath("Reportes" + File.separator + "Plantilla_RemanentePagos.xls"));
            }
        }
    }
}
