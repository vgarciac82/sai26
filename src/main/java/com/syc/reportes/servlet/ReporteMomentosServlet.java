...
@WebServlet(name = "ReporteMomentosServlet", urlPatterns = { "/reportes/ReporteMomentos" })
public class ReporteMomentosServlet extends HttpServlet implements GestionInterface {

    private static final long serialVersionUID = 6723127616859732249L;

    private static final Logger log = LoggerFactory.getLogger(ReporteMomentosServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if ("2".equals(tipoReporte))
                ...
                //ReporteMomentosSolicitud.jaspe
