...
@WebServlet(name = "GuiasContablesServlet", urlPatterns = { "/reportes/GuiasContables" })
public class GuiasContablesServlet extends HttpServlet implements GestionInterface {

    private static final long serialVersionUID = 6723127616859732249L;

    private static final Logger log = LoggerFactory.getLogger(GuiasContablesServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (u == null)
            throw new ServletException("Su session a caducado");
        int res = 0;
        String versionFinal = req.getParameter("generar");
        /*Check finalizar*/
        String msg = "";
        //ruta del jasper
        ...
        try {
            if ("1".equals(versionFinal)) {
                ...
                //nombre del jasper
                String Nomjsaper = req.getParameter("id_archivo");
                ...
                if ("EstadoFinanciero".equals(Nomjsaper) || "EstadoPresupuestario".equals(Nomjsaper) || "EstadoProgramatico".equals(Nomjsaper)) {
                    rrs.cosultaFormato(req, resp, ruta, tipoFormato);
                } else if (nivel == 17 && "GuiasContabilizadoras.jasper".equals(Nomjsaper))
