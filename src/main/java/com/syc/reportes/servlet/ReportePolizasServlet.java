...
//	@SuppressWarnings("unused")
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {	
			...
			else if("ConciliaCompromiso".equals(general) || "ConciliaDevengado".equals(general) || "CONCILIAMOD".equals(general)
				|| "ConciliaEjercido".equals(general) ||"ConciliaMomentos".equals(general)||"ConciliaIngreso".equals(general)||"FFM".equals(general) 
				|| "ConciliaDevengadoIng".equals(general) || "ConciliaOrgModDispEjeIng".equals(general)
				|| "ConciliaEgresos".equals(general)|| "ConciliaRadicadoPagado".equals(general)){
