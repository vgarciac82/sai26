...
public class ReporteEstadoEjercicioManager {
	...
	private static String generaReporte(ResultSet rs, ResultSet rs2, ResultSet rs3, ResultSet rs4, ResultSet rs5, ResultSet rs6, ResultSet rs7, ResultSet rs8, ResultSet rs9, ResultSet rs10, ResultSet rs11, ResultSet rs12, ResultSet rs13, ResultSet rs14, ResultSet rs15, ResultSet rs16, ResultSet rs17, ResultSet rs18, ResultSet rs19, ResultSet rs20, ResultSet rs21, ResultSet rs22, ResultSet rs23, ResultSet rs24, ResultSet rs25, ResultSet rs26, ResultSet rs27, ResultSet rs28, ResultSet rs29, ResultSet rs30, ResultSet rs32, String plantillaPath, int mesIni) throws Exception {
		...
		sheet0 = Util.resultSetToExcel(rs, sheet0, renglonInicio, -1, 1, false); // Original, Modificado
		int renglonFinal = sheet0.getLastRowNum();
		sheet0 = Util.resultSetToExcel(rs17, sheet0, renglonInicio, 43, 2, false); // Solicitado 
		sheet0 = Util.resultSetToExcel(rs18, sheet0, renglonInicio, 103, 2, false); // Acumulado Solicitado 
		sheet0 = Util.resultSetToExcel(rs2, sheet0, renglonInicio, 199, 2, false); // Devengado, Pagado, Diferencia	--antes 147		
		sheet0 = Util.resultSetToExcel(rs3, sheet0, renglonInicio, 108, 2, false); // Radicado SIAFF --antes 56
		sheet0 = Util.resultSetToExcel(rs4, sheet0, renglonInicio, 192, 2, false); // Acumulados SIAFF --antes 140
		sheet0 = Util.resultSetToExcel(rs25, sheet0, renglonInicio, 237, 2, false); // Comprobaciones
		
		System.out.println("Impresion del detalle");
		
		sheet0 = Util.resultSetToExcel(rs5, sheet0, renglonFinal + 5, 15, 1, false); // Flujo Ingreso Orginal, Modificado
		sheet0 = Util.resultSetToExcel(rs19, sheet0, renglonFinal + 5, 43, 2, false); // Flujo Solicitado	
		sheet0 = Util.resultSetToExcel(rs20, sheet0, renglonFinal + 5, 103, 2, false); // Flujo Ingreso Acumulado Solicitado			
		sheet0 = Util.resultSetToExcel(rs6, sheet0, renglonFinal + 5, 199, 2, false); // Flujo Ingreso Devengado, Pagado, Diferencia --antes 147
		sheet0 = Util.resultSetToExcel(rs7, sheet0, renglonFinal + 5, 108, 2, false); // Flujo Ingreso Radicado SIAFF --antes 56
		sheet0 = Util.resultSetToExcel(rs8, sheet0, renglonFinal + 5, 192, 2, false); // Flujo Ingreso Acumulado SIAFF --antes 140		
		sheet0 = Util.resultSetToExcel(rs26, sheet0, renglonFinal + 5, 237, 2, false); // Flujo Ingreso Comprobaciones
		
		System.out.println("Impresion del Flujo Fiscal (Ingreso y Egreso");
		
		sheet0 = Util.resultSetToExcel(rs9, sheet0, renglonFinal + 31, 15, 1, false); // Flujo Ingreso Orginal, Modificado Ingresos Propios		
		sheet0 = Util.resultSetToExcel(rs21, sheet0, renglonFinal + 31, 43, 2, false); // Flujo Solicitado Ingresos Propios
		sheet0 = Util.resultSetToExcel(rs22, sheet0, renglonFinal + 31, 103, 2, false); // Flujo Acumulado Solicitado Ingresos Propios		
		sheet0 = Util.resultSetToExcel(rs10, sheet0, renglonFinal + 31, 108, 2, false); // Flujo Ingreso Radicado SIAFF Ingresos Propios --antes 56
		sheet0 = Util.resultSetToExcel(rs11, sheet0, renglonFinal + 31, 192, 2, false); // Flujo Ingreso Acumulado SIAFF Ingresos Propios --antes 140
		sheet0 = Util.resultSetToExcel(rs12, sheet0, renglonFinal + 31, 199, 2, false); // Flujo Ingreso Devengado, Pagado, Diferencia --antes 147
		sheet0 = Util.resultSetToExcel(rs27, sheet0, renglonFinal + 31, 237, 2, false); // Flujo Comprobaciones Ingresos Propios
		
		System.out.println("Impresion del Flujo Ingresos Propios (Egresos)");
		
		sheet0 = Util.resultSetToExcel(rs13, sheet0, renglonFinal + 44, 15, 1, false); // Flujo Ingreso Orginal, Modificado Federal + Ingresos Propios
		sheet0 = Util.resultSetToExcel(rs23, sheet0, renglonFinal + 44, 43, 2, false); // Flujo Ingreso Solicitado Federal + Ingresos Propios
		sheet0 = Util.resultSetToExcel(rs24, sheet0, renglonFinal + 44, 103, 2, false); // Flujo Ingreso Solicitado Federal + Ingresos Propios		
		sheet0 = Util.resultSetToExcel(rs14, sheet0, renglonFinal + 44, 108, 2, false); // Flujo Ingreso Radicado SIAFF Federal + Ingresos Propios del Egreso --antes 56
		sheet0 = Util.resultSetToExcel(rs15, sheet0, renglonFinal + 44, 192, 2, false); // Flujo Ingreso Acumulado SIAFF Federal + Ingresos Propios del Egreso --antes 140
		sheet0 = Util.resultSetToExcel(rs16, sheet0, renglonFinal + 44, 199, 2, false); // Flujo Ingreso Devengado, Federal + Pagado, Diferencia del Egreso --antes 147
		sheet0 = Util.resultSetToExcel(rs28, sheet0, renglonFinal + 44, 237, 2, false); // Flujo Comprobacion Federal + Ingresos Propios
		
		System.out.println("Impresion del Flujo Fiscal + Ingresos Propios (Egresos)");	
		
		sheet0 = Util.resultSetToExcel(rs29, sheet0, 6, 16, 1, false); // Flujo Comprobacion Federal + Ingresos Propios
		sheet0 = Util.resultSetToExcel(rs30, sheet0, 6, 109, 1, false); // Flujo Comprobacion Federal + Ingresos Propios 2da Parte
		sheet0 = Util.resultSetToExcel(rs32, sheet0, 6, 200, 1, false); // Flujo Comprobacion Federal + Ingresos Propios 3ra Parte
		...
		int createNewRowAt = renglonFinal + 14; //Add the new row between row 9 and 10
