...
public static String ReporteDevengadoDA(Connection conn,  Map<String, String> plantillas) throws Exception {
	...
	PreparedStatement ps = null;
	ResultSet rs = null;		
	String query = "select ctipopago, tipopoliza, cc, nfoliopago,cxp, rfc, cnombre, nfoliopoliza"
			+ ", descPoliza, faplicacion, ur, mimporteNeto, ncuenta from v_devengadoNoEjercido";
