...
public class CargaArchivosCFDIServlet extends HttpServlet implements GestionInterface {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            fileItems = Util.parseRequest(request, CargaArchivosCFDIServlet.TEMP_DIR, -1);
            ...
            while (iter.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    if (!"xlsx".equalsIgnoreCase(extension)) {
                        throw new Exception("El nombre del archivo debe contener la extensión xlsx.");
                    }
                    log.info("Object: {}", "Copiando archivo :" + nombreArchivo);
                    nombreDestino = File.createTempFile("CARGA_REPORTE_CFDI", ".xlsx", new File(System.getProperty("java.io.tmpdir")));
            ...
            ReportePolizasBusinessLogic reporte = new ReportePolizasBusinessLogic(GestionInterface.ATT_CONEXION);
            List<String> errores = reporte.cargaArchivoCFDI(nombreDestino);
