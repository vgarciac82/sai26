...
public interface ContableInterface {
    ...
    public ArrayList aplicarContable(Connection conn, Caso c, String cTablaPadre, String cTablaHija, String cFolio, int nFolioDocumento, String cTipoDocumento, Map m, String prefixPath, String uLogin);
