...
public class RectificacionAnexo1Encabezado {
	...
	private String	nFolioSAI;
	private String	nFolioSIAFF;
	private String	caNoContrarrecibo;
	private String	caNoContrarreciboMil;
	...
	private int		folioPolizaPagado;

	public int getFolioPolizaPagado() {
		return folioPolizaPagado;
	}

	public void setFolioPolizaPagado(int folioPolizaPagado) {
		this.folioPolizaPagado = folioPolizaPagado;
	}
	...
	public String getnCLC() {
		return nCLC;
	}

	public void setnCLC(String nCLC) {
		this.nCLC = nCLC;
	}
	...
	public String getnFolioSAI() {
		return nFolioSAI;
	}

	public void setnFolioSAI(String nFolioSAI) {
		this.nFolioSAI = nFolioSAI;
	}
	...
	public String getCaNoContrarreciboMil() {
		return caNoContrarreciboMil;
	}

	public void setCaNoContrarreciboMil(String caNoContrarreciboMil) {
		this.caNoContrarreciboMil = caNoContrarreciboMil;
	}
	...
	public String toString() {
		return "RectificacionEncabezado [nFolioRectificaAnexo1=" + nFolioRectificaAnexo1 + ", nIdCaso=" + nIdCaso + ", cUnidadResponsable=" + cUnidadResponsable + ", cUnidadResponsableContable=" + cUnidadResponsableContable + ", aEjercicioFiscal=" + aEjercicioFiscal + ", cRamo=" + cRamo
			+ ", cCentroContable=" + cCentroContable + ", fExp=" + fExp + ", fAplicacion=" + fAplicacion + ", cConceptoRectificacion=" + cConceptoRectificacion + ", cTipoMovto=" + cTipoMovto + ", nOrigenPPTO=" + nOrigenPPTO + ", nMes=" + nMes + ", oficioRectif=" + oficioRectif + ", ctr_int="
			+ ctr_int + ", cTipoRectificacion=" + cTipoRectificacion + ", nCLC=" + nCLC + ", nFolioSicop=" + nFolioSicop + ", nFolioSAI=" + nFolioSAI + ", nFolioSIAFF=" + nFolioSIAFF + ", caNoContrarrecibo=" + caNoContrarrecibo + ", caNoContrarreciboMil=" + caNoContrarreciboMil + ", nFolioPoliza="
			+ nFolioPoliza + ", nFolioPolizaCancelacion=" + nFolioPolizaCancelacion + ", cTipoPoliza=" + cTipoPoliza + ", cDescripcionPoliza=" + cDescripcionPoliza + ", fCancelacion=" + fCancelacion + ", concepto=" + concepto + ", totalDebe=" + totalDebe + ", totalDice=" + totalDice
			+ ", posicion1=" + posicion1 + ", nFolioTramiteSicop=" + nFolioTramiteSicop + ", tipoConcepto=" + tipoConcepto + ", tipoPago=" + tipoPago + ", folioPagado=" + folioPagado + ", folioPolizaPagado=" + folioPolizaPagado + "]";
	}
