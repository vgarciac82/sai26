...
public class RectificacionAnexo1Detalle {
    ...
    public String toString() {
        return "RectificaAnexo1Detalle [folio=" + folio + ", renglon=" + renglon + ", evento=" + evento + ", ep=" + ep + ", epRectifica=" + epRectifica + ", importe=" + importe + ", importeneg=" + importeneg + ", mes=" + mes + ", centro=" + centro + ", capitulo=" + capitulo + ", movimiento=" + movimiento + ", concepto=" + concepto + ", importeRemanente=" + importeRemanente + ", caNoContrarrecibo=" + caNoContrarrecibo + "]";
    }
}
