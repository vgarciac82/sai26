...
public class ReintegroEncabezado {
    ...
    private int causaAviso;

    private String cuentaPorPagar;

    private int folioDependencia;
    ...
    public int getCausaAviso() {
        return causaAviso;
    }

    public void setCausaAviso(int causaAviso) {
    ...
    public int getFolioDependencia() {
        return folioDependencia;
    }

    public void setFolioDependencia(int folioDependencia) {
