...
public class OperacionesAjenasIntManager {
	...
	public static int insertEncabezado( Connection conn, OperacionesAjenasIntEncabezado encabezado ) throws Exception {
		String query = "INSERT INTO dbo.tOperAjenasIntegradoEnc" + "        ( nFolioOperAjenasInt ," + "          cBeneficiario ," + "          fCaptura ," + "          fDesde ," + "          fHasta ," + "          caNoContrarreciboInt ," + "          mImporteNeto ," + "          U_LOGIN ," + "          cCentroContable ," + "          aEjercicioFiscal ," + "          cUnidadResponsable ," + "          cRamo ," + "          fCancelacion ," + "          nEnviadoSICOP ," + "          cIDRFC "
