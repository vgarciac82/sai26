	...
	public static ArrayList<String> BuscaCompromisos(Connection conn,String szTemp, String szTabla)throws Exception{
		...
		while (rs.next()){
			...
			String encabezado = var_01 + "|" + var_02 + "|" + var_03 + "|" + var_04 + "|" +	var_05 + "|" + var_06 + "|" + var_07 + "|" + var_08 + "|" + 
						var_09 + "|" + var_10 + "|" + var_11 + "|" + var_12 + "|" + var_13 + "|" + var_14 + "|" + var_15 + "|" + var_16 + "|" + var_17 ; 
			if( szTabla.equals("ExtractorPagos") ){
				encabezado = encabezado + "|" + var_18 + "|";
			}
			if( szTabla.equals("REPAJENAS") ){
					encabezado = encabezado + "|" + var_18 + "|" + var_19 + "|" + var_20 + "|" + var_21 + "|" + var_22 + "|" + var_23 + "|" + 
										var_24 + "|" + var_25 + "|" + var_26 + "|" + var_27 + "|" + var_28 + "|" + var_29 + "|" + var_30 + "|" + var_31 + 
										"|" + var_32 + "|" + var_33 + "|" + var_34 + "|" + var_35 + "|" + var_36 + "|" + var_37 + "|" + var_38 + "|" + var_39 + "|" + var_40;
			}
