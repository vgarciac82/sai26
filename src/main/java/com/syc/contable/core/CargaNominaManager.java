...
public class CargaNominaManager {
    ...
    public static boolean insertaLineaNomina(Connection conn, Integer ID_Caso, String EP, String claveInterna, String concepto, String movimiento, Double saldo, String claveCNA) throws SQLException {
        PreparedStatement pstmnt = null;
        boolean insertReg;
        String queryInsert = "INSERT INTO tNOMINACargaArchivo(" + "                                             nFolioNOMINA,ClaveSIAFF,ClaveInterna," + "                                             ID_TIPO_CONCEPTO,ID_TIPO_MOVIMIENTO,mSaldo, nClaveCNA)" + "         VALUES(" + "" + "'" + ID_Caso + "','" + EP + "','" + claveInterna + "','" + concepto + "','" + movimiento + "'," + saldo + ",'" + claveCNA + "')";
