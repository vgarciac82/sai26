...
public class PenasConvIntegradasManager {
    ...
    public static int insertEncabezado(Connection conn, PenasConvIntEncabezado encabezado) throws Exception {
        ...
        query.append("INSERT INTO tPagoPenasConvIntegradoEnc (").append(" nFolioPagoPenasConvInt,").append(" cBeneficiario,").append(" fCaptura,").append(" fDesde,").append(" fHasta,").append(" caNoContrarreciboInt,").append(" mImporteNeto,").append(" U_LOGIN,").append(" cCentroContable,").append(" aEjercicioFiscal,").append(" cUnidadResponsable,").append(" cRamo,").append(" fCancelacion,").append(" nEnviadoSICOP,").append(" cIDRFC").append(" ) VALUES (").append(" ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ").append(" )");
        int retVal = 0;
    ...
    public static int insertDetalle(Connection conn, List<PenasConvIntDetalle> detalle) throws Exception {
        ...
        queryInsert.append("INSERT INTO tPagoPenasConvIntegradoDet (").append(" nFolioPagoPenasConvInt,").append(" nDocRenglon,").append(" nFolioPagoPenasConv,").append(" caNoContrarreciboPP,").append(" cUnidadResponsable,").append(" cIDRFC,").append(" cCentroContable,").append(" aEjercicioFiscal,").append(" Ep,").append(" mImporteMasIva,").append(" nFolioDoc,").append(" caNoContrarrecibo,").append(" cTipoDoc,").append(" cRamo,").append(" nDocRenglonInt,").append(" mAjuste,").append(" cMes").append(" ) VALUES (").append(" ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?").append(" )");
        PreparedStatement ps = null;
        int retVal = 0;
        try {
    ...
    public static ArrayList<String> buscaPenasConvIntegradas(Connection conn, String cxpAI, String fecha, String cBancaria, String Leyenda, String nFolio, String cBEN) throws Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                encabezado.append(rs.getString(2)).append(",").append(rs.getString(3)).append(",").append(rs.getString(4).trim()).append(",").append(rs.getString(5).trim()).append(",").append(rs.getString(6).trim()).append(",").append(rs.getString(7).trim()).append(",").append(rs.getString(8).trim()).append(",").append(rs.getString(9).trim()).append(",").append(rs.getString(10).trim()).append(",").append(rs.getString(11).trim()).append(",").append(rs.getString(12).trim()).append(",").append(rs.getString(13).trim()).append(",").append(rs.getString(14).trim()).append(",").append(rs.getString(15).trim()).append(",").append(Leyenda).append(",").append(rs.getString(17).trim()).append(",").append(cBancaria).append(",").append(rs.getString(19).trim()).append(",").append(rs.getString(20).trim()).append(",").append(rs.getString(21).trim()).append(",").append(vreferencia).append(",").append(rs.getString(23).trim()).append(",").append(vreferencia).append(",").append(rs.getString(25).trim()).append(",").append(rs.getString(26).trim()).append(",").append(rs.getString(27).trim()).append(",").append(rs.getString(29).trim()).append(",").append(rs.getString(30).trim()).append("\r\n");
