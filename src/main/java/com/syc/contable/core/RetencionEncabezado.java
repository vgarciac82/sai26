...
public class RetencionEncabezado {
    ...
    public String toString() {
        return "RetencionEncabezado [nFolioRetencion=" + nFolioRetencion + ", nIdCaso=" + nIdCaso + ", cUnidadResponsable=" + cUnidadResponsable + ", fCarga=" + fCarga + ", fAplicacion=" + fAplicacion + ", cRamo=" + cRamo + ", nOrigenPPTO=" + nOrigenPPTO + ", aEjercicioFiscal=" + aEjercicioFiscal + ", cCentroContable=" + cCentroContable + ", cIdRFC=" + cIdRFC + ", CTAB=" + CTAB + ", NOMBRE=" + NOMBRE + ", cConcepto=" + cConcepto + ", mImporteRetencion=" + mImporteRetencion + ", caNoContrarrecibo=" + caNoContrarrecibo + ", cIdUsuarioCaptura=" + cIdUsuarioCaptura + ", cDocumentoHaplicado=" + cDocumentoHaplicado + ", nFolioPoliza=" + nFolioPoliza + ", cTipoPoliza=" + cTipoPoliza + ", nEnviadoSICOP=" + nEnviadoSICOP + ", nCompromisoSICOP=" + nCompromisoSICOP + ", cUnidadResponsableContable=" + cUnidadResponsableContable + ", nFolioPolizaCancelacion=" + nFolioPolizaCancelacion + ", fCancelacion=" + fCancelacion + ", nFolioPago=" + nFolioPago + "]";
    }
