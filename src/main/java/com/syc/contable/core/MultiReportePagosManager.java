...
public class MultiReportePagosManager {

    public MultiReportePagosManager() {
        super();
    }
    ...
    public static ArrayList<String> BuscaCompromisos(Connection conn, String szTemp) throws Exception {
        ...
        String Sql = " select * from vMultilistadorPagos " + szTemp;
        ...
        while (rs.next()) {
            ...
            String encabezado = var_01 + "|" + var_02 + "|" + var_03 + "|" + var_04 + "|" + var_05 + "|" + var_06 + "|" + var_07 + "|" + var_08 + "|" + var_09 + "|" + var_10 + "|" + var_11 + "|" + var_12 + "|" + var_13;
