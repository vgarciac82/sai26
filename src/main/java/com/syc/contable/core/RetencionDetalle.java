...
public class RetencionDetalle {
	...
	public String toString() {
		return "RectificacionDetalle [nFolioRetencion=" + nFolioRetencion + ", nDocRenglon=" + nDocRenglon + ", cMes=" + cMes + ", cEvento=" + cEvento + ", EP=" + EP + ", mImporte=" + mImporte + ", m2Millar=" + m2Millar + ", mObra5=" + mObra5 
				+ ", mImporteFlete4=" + mImporteFlete4 + ", mISRHonorarios=" + mISRHonorarios + ", mISRArrenda=" + mISRArrenda + ", mRetImpuestoCedular=" + mRetImpuestoCedular + ", mImporteIvaArrenda=" + mImporteIvaArrenda
				+ ", mImporteIvaHonorarios=" + mImporteIvaHonorarios + ", mOtrosImpuestos=" + mOtrosImpuestos + ", mImporteISRLaudos=" + mImporteISRLaudos + ", mISROtros=" + mISROtros + ", mImporteIva6=" + mImporteIva6
