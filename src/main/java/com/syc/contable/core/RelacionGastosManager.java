...
public class RelacionGastosManager {
	...
	private static final Logger	log					= Logger.getLogger( RelacionGastosManager.class );
	...
	private static void insertaLayoutCompRGEncabezado( Connection conn, int idLayout, int leyenda, String ctaBancaria, String noIntegracion, String foliosRGIntegrados, String usuario, int folioRelacionGastosCompromiso, String folioOficio ) throws Exception {
		...
		queryInsertaLayoutEnc.append( "     	'S04929' CBEN, " ); // Q
		...
		queryInsertaLayoutEnc.append( "    	LEFT('Integracion " + noIntegracion + " de RG-" + foliosRGIntegrados + "',500) CPAG_76, " );// X
		...
		queryInsertaLayoutEnc.append( "      	CONVERT(decimal(17, 2), SUM(DCD_IVADES), 0) IVA_304, " ); // AF
		...
		queryInsertaLayoutEnc.append( "      	CONVERT(DECIMAL(17, 2), SUM(DCD_IVA), 0) AS IVADES_310,	" ); // AL
	...
	private static String generaEncabezadoLayoutCompRG( Connection conn, int folioRelacionGastosCompromiso, String ctaBancaria, String noIntegracion, String foliosRGIntegrados, int leyenda ) throws Exception {
		...
		queryEncabezadoLayout.append( "      	'S04929' CBEN, " ); // Q
		queryEncabezadoLayout.append( "        '" + ctaBancaria.trim() + "' CUENTA_BANCARIA, " ); // R
		queryEncabezadoLayout.append( "      	'16RHQ' RFC_227, " ); // S
		...
		queryEncabezadoLayout.append( "      	LEFT('Integracion " + noIntegracion + " de RG-" + foliosRGIntegrados + "',500) CPAG_76, " ); // X
		queryEncabezadoLayout.append( "      	'' NotasReverso, " ); // Y
		queryEncabezadoLayout.append( "      	'' AMF, " ); // Z
		queryEncabezadoLayout.append( "      	'" + noIntegracion + "' NO_ACMI, " ); // AA
		queryEncabezadoLayout.append( "      	'" + noIntegracion + "' AuxiliarComodin, " ); // AB
		queryEncabezadoLayout.append( "      	'" + noIntegracion + "' CTR, " ); // AC
	...
	private static String generaDetalleLayoutCompRG( Connection conn, int folioRelacionGastosCompromiso, String folioAutSICOP, String folioSuficiencia ) throws Exception {
		...
		queryLayoutDetalle.append( " CASE  WHEN cRetSICOP = 'N' THEN CONVERT(DECIMAL(17, 2), CONVERT(DECIMAL(17, 2), Sum( D.mImporteMasIva))) ELSE CONVERT(DECIMAL(17, 2), CONVERT(DECIMAL(17, 2), Sum(D.mImporteNeto))) END  AS MONTO,  " );// AB
		queryLayoutDetalle.append( " D.cmes                 MES_149,  	" ); // AC
		queryLayoutDetalle.append( " '" + StringUtils.trimToEmpty( folioSuficiencia ) + "'  Suficiencia, " ); // AD
		...
		queryLayoutDetalle.append( " 0 IVADES_45,  						" ); // AL
		queryLayoutDetalle.append( " 0 ANTICIPO_46,  					" ); // AM
		queryLayoutDetalle.append( " 0 PENALIZACION_314,  				" ); // AN
		queryLayoutDetalle.append( " 0 IVAANT_47,  						" ); // AO
		queryLayoutDetalle.append( " ''  id_ctr_intdet  				" ); // AP
	...
	private static void insertaLayoutCompRGDetalle( Connection conn, int nFolioLayout, String folioAutSICOP, int folioRelacionGastosCompromiso ) throws Exception {
		...
		queryInsertLayoutCompRG.append( "       '1'                    ID_EVENTO, " ); // A
		...
		queryInsertLayoutCompRG.append( "       '0000000000' AS CCAU_162, " ); // T
		queryInsertLayoutCompRG.append( "       '00'                   CCOP_163, " ); // U
		...
		queryInsertLayoutCompRG.append( "       CASE WHEN cRetSICOP = 'N' THEN CONVERT(DECIMAL(17, 2), CONVERT(DECIMAL(17, 2), Sum(D.mImporteMasIva))) ELSE CONVERT(DECIMAL(17, 2), CONVERT(DECIMAL(17, 2), Sum(D.mImporteNeto)))  END   AS MONTO, " );// AB
		queryInsertLayoutCompRG.append( "       D.cmes                 MES_149, " ); // AC
		queryInsertLayoutCompRG.append( "       '0'                    NRES, " ); // AD
		queryInsertLayoutCompRG.append( "       CASE WHEN Substring(ep, 32, 5) = '35801' THEN 'GD' ELSE 'PN' END  TIPO_CONTRATO, " );// AE
