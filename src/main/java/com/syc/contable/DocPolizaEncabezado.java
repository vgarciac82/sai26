...
public class DocPolizaEncabezado {
    ...
    private String mTotalAbonos;

    private String mTotalCargos;

    private int nCambio;

    private int nFolioDocPoliza;

    private int nFolioPoliza;

    private int nFolioPolizaCancelacion;

    private long nIdCasoOrigen;
    ...
    public String getmTotalAbonos() {
        return mTotalAbonos;
    }

    public String getmTotalCargos() {
        return mTotalCargos;
    }

    public int getnCambio() {
        return nCambio;
    }

    public int getnFolioDocPoliza() {
    ...
    public long getnIdCasoOrigen() {
        return nIdCasoOrigen;
    }
    ...
    public void setmTotalAbonos(String mTotalAbonos) {
        this.mTotalAbonos = mTotalAbonos;
    }

    public void setmTotalCargos(String mTotalCargos) {
        this.mTotalCargos = mTotalCargos;
    }

    public void setnCambio(int nCambio) {
        this.nCambio = nCambio;
    }

    public void setnFolioDocPoliza(int nFolioDocPoliza) {
    ...
    public void setnIdCasoOrigen(long nIdCasoOrigen) {
    ...
    public String toString() {
        return "DocPolizaEncabezado [ADEFAS=" + ADEFAS + ", aEjercicioFiscal=" + aEjercicioFiscal + ", cCentroContable=" + cCentroContable + ", cComentarios=" + cComentarios + ", cConcepto=" + cConcepto + ", cDescripcionPoliza=" + cDescripcionPoliza + ", cDocumentoHaplicado=" + cDocumentoHaplicado + ", cidOrigen=" + cidOrigen + ", cIdUsuarioAprobacion=" + cIdUsuarioAprobacion + ", cIdUsuarioCaptura=" + cIdUsuarioCaptura + ", cIdUsuarioRevision=" + cIdUsuarioRevision + ", cRamo=" + cRamo + ", cRevisado=" + cRevisado + ", cTipoDocumento=" + cTipoDocumento + ", cTipoPoliza=" + cTipoPoliza + ", cUnidadResponsable=" + cUnidadResponsable + ", cUnidadResponsableContable=" + cUnidadResponsableContable + ", fAplicacion=" + fAplicacion + ", fCancelacion=" + fCancelacion + ", fCarga=" + fCarga + ", mTotalAbonos=" + mTotalAbonos + ", mTotalCargos=" + mTotalCargos + ", nCambio=" + nCambio + ", nFolioDocPoliza=" + nFolioDocPoliza + ", nFolioPoliza=" + nFolioPoliza + ", nFolioPolizaCancelacion=" + nFolioPolizaCancelacion + ", nIdCasoOrigen=" + nIdCasoOrigen + ", nMes=" + nMes + ", nTipoAjuste=" + nTipoAjuste + ", periodo13=" + periodo13 + ", referencia=" + referencia + "]";
    }
}
