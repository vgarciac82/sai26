...
public class cargaNominaServlet extends HttpServlet {
	...
	public InputStream cargarArchivoSCV(HttpServletRequest request,
	...
	public static boolean enviaRuta(InputStream in, Caso caso, String id_folioN)
			...
			while ((sCadena = br.readLine()) != null) {
				...
				if (primeraLinea) {
					...
					if (!claveCNA.equals("")) {
						...
						lineaInsert = nominaBL.insertaLineaNomina(id_caso, EP,
								claveInterna, concepto, movimiento, saldo,
								claveCNA);
					}
				}
			}
