...
public class LayoutPagoDiversoAmbientalServlet extends HttpServlet implements GestionInterface {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			BufferedWriter out = new BufferedWriter(new FileWriter(strlayoutBanorte)); // Guarda el layout BANORTE
			...
			out.close(); // fin Layout BANORTE
			
			BufferedWriter outSpei = new BufferedWriter(new FileWriter(strlayoutSpei)); // Guarda el layout SPEI
			...
			outSpei.close(); // fin Layout SPEI
			
			BufferedWriter outIP = new BufferedWriter(new FileWriter(strlayoutBanorteIP)); // Guarda el layout BANORTE IP
			...
			outIP.close(); // fin Layout BANORTE
			
			BufferedWriter outSpeiIP = new BufferedWriter(new FileWriter(strlayoutSpeiIP)); // Guarda el layout SPEI IP
			...
			outSpeiIP.close(); // fin Layout SPEI
			
			String[] filenames = new String[] { strlayoutBanorte, strlayoutSpei, strlayoutBanorteIP, strlayoutSpeiIP }; // These are the files to include in the ZIP file
