...
public class generaAdefaServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public generaAdefaServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String caNoContrarrecibo = (request.getParameter("numFolios") != null ) ? request.getParameter("numFolios").trim() : "";
		...
		try{
			...
			arrListPago = cmpBL.buscarAdefaExport(sFolioQuery);
			Long date = System.currentTimeMillis();
			
			String Cierre = "Adefa" + sufijo.trim() + ".csv";				// para dar el nombre del archivo Pago Directo
			
			BufferedWriter out = new BufferedWriter( new FileWriter(Cierre));  			// Guarda el pago 
	        ...
	        File ficheroPag = new File(Cierre);	ficheroPag.delete();
