...
@WebServlet(name = "LayoutPagoAcuerdosAMFServlet", urlPatterns = { "/gstnmngr/generaPagoAcuerdosAMF" })
public class LayoutPagoAcuerdosAMFServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String layoutPago = "PagoAMF" + sufijo.trim() + ".csv";
            // para dar el nombre del archivo Documentación Comprobatoria
            String layoutDocu = "DOCCOMPAMF" + sufijo.trim() + ".csv";
            // para dar el nombre del archivo Pago Directo ZIP
            String layoutPagoZip = "PagoAMF" + sufijo.trim() + ".zip";
            // para dar el nombre del archivo Documentación Comprobatoria ZIP
            String layoutDocuZip = "DOCCOMPAMF" + sufijo.trim() + ".zip";
