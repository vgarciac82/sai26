...
public class LayoutPagoAcuerdosAMFServlet extends HttpServlet {
	/**
	 * 
	 */
	 ...
	 */
	public LayoutPagoAcuerdosAMFServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			//Actualiza nEnviadoSICOP a 1
			arrListDocu = cmpBL.ArmaDocumentoComprobatorio(sFolioQuery);
			
			
			String layoutPago = "PagoAMF" + sufijo.trim() + ".csv";				// para dar el nombre del archivo Pago Directo
			String layoutDocu = "DOCCOMPAMF" + sufijo.trim() + ".csv";					// para dar el nombre del archivo Documentación Comprobatoria
			String layoutPagoZip = "PagoAMF" + sufijo.trim() + ".zip";			// para dar el nombre del archivo Pago Directo ZIP
			String layoutDocuZip = "DOCCOMPAMF" + sufijo.trim() + ".zip";				// para dar el nombre del archivo Documentación Comprobatoria ZIP
			//String layoutZip = "PagoAMFTodo" + sufijo + ".zip";
