...
import com.syc.contable.ExtraeEdoCtaBussinessLogic;
...
public class LayoutExtraeEdoCtaServlet extends HttpServlet {
	 ...
	 */
	public LayoutExtraeEdoCtaServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ExtraeEdoCtaBussinessLogic cmpBL =new ExtraeEdoCtaBussinessLogic(GestionInterface.ATT_CONEXION);
		try{
			...
			String layoutPago = "EdoCta" + sufijo.trim() + ".txt";				// para dar el nombre del archivo Pago Directo
			String layoutPagoZip = "EdoCta" + sufijo.trim() + ".zip";			// para dar el nombre del archivo Pago Directo ZIP
