...
import com.syc.contable.anteproyecto.RelacionEFProgramaBusinessLogic;
...
@WebServlet(name = "RelacionEFProgramaServlet", urlPatterns = { "/gstnmngr/RelacionEFPrograma/CargaMasiva" })
public class RelacionEFProgramaServlet extends HttpServlet implements GestionInterface {

    private static final Logger log = LoggerFactory.getLogger(RelacionEFProgramaServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("CargaMasiva".equals(accion)) {
            ...
            try {
                fileItems = Util.parseRequest(req, RelacionEFProgramaServlet.TEMP_DIR, -1);
                ...
                while (iter.hasNext()) {
                    ...
                    nombreDestino = RelacionEFProgramaServlet.TEMP_DIR + "CATALOGO_RELACION_" + System.currentTimeMillis() + "." + extension;
                    ...
                    RelacionEFProgramaBusinessLogic refpbl = new RelacionEFProgramaBusinessLogic(u.getLogin());
                    List<String> mensajes = refpbl.cargaExcelRelacionEFPrograma(nombreDestino);
                    if (mensajes.size() > 0) {
            ...
            resp.sendRedirect("../../admin/RelacionEFPrograma.jsp");
        } else if ("CapturaManual".equals(accion)) {
            String operacion = req.getParameter("accion");
            String strRedirect = "";
            try {
                strRedirect = "../../admin/RelacionEFPrograma.jsp?";
            } catch (Exception e) {
                e.printStackTrace();
            }
