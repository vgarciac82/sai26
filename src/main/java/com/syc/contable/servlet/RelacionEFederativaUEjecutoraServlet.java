...
public class RelacionEFederativaUEjecutoraServlet extends HttpServlet implements GestionInterface {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("CargaMasiva".equals(accion)) {
            ...
            try {
                fileItems = Util.parseRequest(req, RelacionEFederativaUEjecutoraServlet.TEMP_DIR, -1);
            ...
            resp.sendRedirect("../../admin/RelacionEFederativaUEjecutora.jsp");
        } else if ("CapturaManual".equals(accion)) {
            String operacion = req.getParameter("accion");
            String strRedirect = "";
            try {
                strRedirect = "../../admin/RelacionEFederativaUEjecutora.jsp?";
            } catch (Exception e) {
                e.printStackTrace();
            }
