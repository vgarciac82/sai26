...
public class LayoutPagoAcuerdosAMFConLayoutServlet extends HttpServlet {
	 ...
	 */
	public LayoutPagoAcuerdosAMFConLayoutServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
		    ...
		    response.setContentType("text/html");
		    PrintWriter out = response.getWriter();
		    out.println("<script type='text/javascript' charset='utf-8'>window.location.href = '../Generador/IntegraLayoutPagoAcuerdosAMF.jsp';</script>");
