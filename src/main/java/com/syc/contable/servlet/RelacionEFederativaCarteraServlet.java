...
import com.syc.contable.anteproyecto.RelacionEFederativaCarteraBusinessLogic;
...
@WebServlet(name = "RelacionEFederativaCarteraServlet", urlPatterns = { "/gstnmngr/RelacionEFederativaCartera/CargaMasiva" })
public class RelacionEFederativaCarteraServlet extends HttpServlet implements GestionInterface {

    private static final Logger log = LoggerFactory.getLogger(RelacionEFederativaCarteraServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("CargaMasiva".equals(accion)) {
            ...
            try {
                fileItems = Util.parseRequest(req, RelacionEFederativaCarteraServlet.TEMP_DIR, -1);
                ...
                while (iter.hasNext()) {
                    ...
                    nombreDestino = RelacionEFederativaCarteraServlet.TEMP_DIR + "CATALOGO_RELACION_" + System.currentTimeMillis() + "." + extension;
            ...
            resp.sendRedirect("../../admin/RelacionEFederativaCartera.jsp");
        } else if ("CapturaManual".equals(accion)) {
            String operacion = req.getParameter("accion");
            String strRedirect = "";
            try {
                strRedirect = "../../admin/RelacionEFederativaCartera.jsp?";
            } catch (Exception e) {
                e.printStackTrace();
            }
