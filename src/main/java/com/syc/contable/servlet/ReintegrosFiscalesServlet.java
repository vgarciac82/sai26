...
public class ReintegrosFiscalesServlet extends HttpServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(ReintegrosFiscalesServlet.class);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (borraTodo != null && !"".equals(borraTodo) && "1".equals(borraTodo)) {
            ...
            try {
                ...
                reintegro.borraReintegro(Integer.parseInt(folioReintegro, 10));
                Caso c = (Caso) session.getAttribute(GestionInterface.ATT_CASE);
    ...
    public void generaCasoInserts(HttpServletResponse response, HttpServletRequest request) throws Exception {
        ...
        if ("IF".equals(cTipoReintegro)) {
            //TODO: Tipo Poliza Reintegro Ingreso Fiscal.
            re.setcTipoPoliza("IN");
        } else {
            //TODO: Tipo Poliza Reintegro Ingreso Propio.
            re.setcTipoPoliza("EG");
        }
        re.setLc("N/A");
        ...
        for (int i = 0; i < valuesCLC.length; i++) {
            ...
            if ("IF".equals(cTipoReintegro)) {
                if ("RN".equals(r_Interno)) {
                    //TODO: Evento Apartado para Ingreso Fiscal.
                    rdaux.setcEvento("RN");
                } else {
                    //TODO: Evento Apartado para Ingreso Fiscal.
                    rdaux.setcEvento("REIN_TRAM_IF");
                }
            } else {
                //TODO: Evento para Ingreso Propio.
                rdaux.setcEvento(cEvento);
            }
