...
import com.syc.contable.ExtraeOABussinessLogic;
...
public class LayoutExtraeOAServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String szTabla = (request.getParameter("szTabla")!= null)? request.getParameter("szTabla").trim(): "";
		...
		ExtraeOABussinessLogic cmpBL =new ExtraeOABussinessLogic(GestionInterface.ATT_CONEXION);
		try{
			...
			arrListPago = cmpBL.buscaCompromisos(szTemp, szTabla);
			
			Long date = System.currentTimeMillis();
			String layoutPago = szTabla + sufijo.trim() + ".txt";				// para dar el nombre del archivo Pago Directo
			String layoutPagoZip = szTabla + sufijo.trim() + ".zip";			// para dar el nombre del archivo Pago Directo ZIP
