...
public class LayoutPagoDiversoRelGastosConLayoutServlet extends HttpServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(LayoutPagoDiversoRelGastosConLayoutServlet.class);

    /**
     * Constructor of the object.
     */
    public LayoutPagoDiversoRelGastosConLayoutServlet() {
        super();
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            cmpBL.ActualizaStatusPagoDiversoRelGastos(sFolioQuery);
        } catch (FileNotFoundException ex) {
            ex.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();
        }
        response.sendRedirect("../Generador/IntegraLayoutPagosDiversosRelGastos.jsp");
    }
