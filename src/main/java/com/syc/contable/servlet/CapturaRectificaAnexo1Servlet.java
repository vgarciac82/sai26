                ...
                for (int i = 0; i < detalle.length; i += 6) {
                    ...
                    if (rd.getEvento().contains("DICE")) {
                        ...
                        if (banderaRemanente)
                            ...
                            log.warn("Object: {}", "No hay suficiente remanente para poder aplicar la rectificacion para " + rd.getEp() + " renglon " + secuenciaCLC + " mes " + rd.getMes() + " cxp " + caNoContrarrecibo + " remanente " + remanente + " importe a rectificar " + rd.getImporte() + "\n");
