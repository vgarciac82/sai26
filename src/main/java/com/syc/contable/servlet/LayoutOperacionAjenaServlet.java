...
public class LayoutOperacionAjenaServlet extends HttpServlet {
	 ...
	 */
	public LayoutOperacionAjenaServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String layoutPago = "OperaAjena" + sufijo.trim() + ".csv";				// para dar el nombre del archivo Pago Directo
			String layoutDocu = "DOCCOMP" + sufijo.trim() + ".csv";					// para dar el nombre del archivo Documentación Comprobatoria
			String layoutPagoZip = "OperaAjena" + sufijo.trim() + ".zip";			// para dar el nombre del archivo Pago Directo ZIP
			String layoutDocuZip = "DOCCOMP" + sufijo.trim() + ".zip";				// para dar el nombre del archivo Documentación Comprobatoria ZIP
			String layoutZip = "OperaAjenaTodo" + sufijo + ".zip";
