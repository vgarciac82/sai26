...
import com.syc.contable.anteproyecto.CatalogoEPAnteproyectoPlurianualesBusinessLogic;
...
@WebServlet(name = "CatalogoEPAnteproyectoPlurianualesServlet", urlPatterns = { "/gstnmngr/CatalogoEPAnteproyectoPlurianuales/CargaMasiva" })
public class CatalogoEPAnteproyectoPlurianualesServlet extends HttpServlet implements GestionInterface {

    private static final Logger log = LoggerFactory.getLogger(CatalogoEPAnteproyectoPlurianualesServlet.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("CargaMasiva".equals(accion)) {
            ...
            try {
                fileItems = Util.parseRequest(req, CatalogoEPAnteproyectoPlurianualesServlet.TEMP_DIR, -1);
                ...
                while (iter.hasNext()) {
                    ...
                    nombreDestino = CatalogoEPAnteproyectoPlurianualesServlet.TEMP_DIR + "CATALOGO_RELACION_" + System.currentTimeMillis() + "." + extension;
                    ...
                    CatalogoEPAnteproyectoPlurianualesBusinessLogic ceppbl = new CatalogoEPAnteproyectoPlurianualesBusinessLogic(u.getLogin());
                    List<String> mensajes = ceppbl.CatalogoEPAnteproyectoPlurianuales(nombreDestino);
                    if (mensajes.size() > 0) {
            ...
            resp.sendRedirect("../../admin/CatalogoEPAnteproyectoPlurianuales.jsp");
        } else if ("CapturaManual".equals(accion)) {
            String operacion = req.getParameter("accion");
            String strRedirect = "";
            try {
                strRedirect = "../../admin/CatalogoEPAnteproyectoPlurianuales.jsp?";
            } catch (Exception e) {
                e.printStackTrace();
            }
