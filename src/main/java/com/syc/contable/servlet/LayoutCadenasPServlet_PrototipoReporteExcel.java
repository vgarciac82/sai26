...
public class LayoutCadenasPServlet_PrototipoReporteExcel extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String layoutPago = System.getProperty( "java.io.tmpdir" ) + File.separatorChar + "ReporteCadenas" + sufijo.trim() + ".csv";				// para dar el nombre del archivo Pago Directo
			String layoutPagoZip = System.getProperty( "java.io.tmpdir" ) + File.separatorChar + "Cadenas" + sufijo.trim() + ".zip";			// para dar el nombre del archivo Pago Directo ZIP
