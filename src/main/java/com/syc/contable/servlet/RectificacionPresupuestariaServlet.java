...
public class RectificacionPresupuestariaServlet extends HttpServlet {
	...
	private static Logger		log					= Logger.getLogger(RectificacionPresupuestariaServlet.class);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * SE GENERA EL EXCEL DE CAPTURA (CARGA)
		 */
		else if (generaExcel != null && !"".equals(generaExcel) && "2".equals(generaExcel)) {
			try {
		...
		} else if (request.getParameter("aplica") != null && request.getParameter("aplica").equals("2")) { // AUTORIZACION
																											// RECTIFICACION
																											// MIL
			try {
				PrintWriter out = response.getWriter();
