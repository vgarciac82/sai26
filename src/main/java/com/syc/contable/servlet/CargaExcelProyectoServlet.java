...
public class CargaExcelProyectoServlet extends HttpServlet implements GestionInterface {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            fileItems = Util.parseRequest(req, CargaExcelProyectoServlet.TEMP_DIR, -1);
            ...
            while (iter.hasNext()) {
                ...
                nombreDestino = CargaExcelProyectoServlet.TEMP_DIR + "CARGA_PROYECTO_" + System.currentTimeMillis() + "." + extension;
        ...
        resp.sendRedirect("../Generador/CargaArchivoProyecto.jsp");
    }
