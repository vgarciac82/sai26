...
public class Fap01 {
	...
	public String toString() {
		return "Fap01 [nfolioconsolidacion=" + nfolioconsolidacion + ", ep=" + ep + ", movimiento=" + movimiento + ", montos=" + Arrays.toString(montos) + ", ejercicio=" + ejercicio + ", ramo=" + ramo + ", unidadResponsable=" + unidadResponsable + ", gf=" + gf + ", f=" + f + ", sf=" + sf + ", PG="
			+ PG + ", AI=" + AI + ", PP=" + PP + ", OG=" + OG + ", tg=" + tg + ", ff=" + ff + ", ef=" + ef + ", cartera=" + cartera + ", AE=" + AE + "]";
	}
}
