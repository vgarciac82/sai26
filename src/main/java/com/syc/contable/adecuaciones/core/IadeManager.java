...
public class IadeManager {
    ...
    public static List<Fap01> cargaFAP01(Connection conn, int nFolioConsolidacion) throws Exception {
        String query = "SELECT nfolioconsolidacion ," + "        ep ," + "        movimiento ," + "        enero ," + "        febrero ," + "        marzo ," + "        abril ," + "        mayo ," + "        junio ," + "        julio ," + "        agosto ," + "        septiembre ," + "        octubre ," + "        noviembre ," + "        diciembre ," + "        anual ," + "        ejercicio ," + "        ramo ," + "        unidad_responsable ," + "        gf ," + "        f ," + "        sf ," + "        PG ," + "        AI ," + "        PP ," + "        OG ," + "        tg ," + "        ff ," + "        ef ," + "        cartera ," + "        AE," + "        nfolioconsolidacion" + " FROM  vFAP01 WITH(NOLOCK) " + "WHERE nfolioconsolidacion = ?";
