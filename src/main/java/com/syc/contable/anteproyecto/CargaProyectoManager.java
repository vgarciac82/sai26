...
public class CargaProyectoManager {
	...
	private static Logger	log	= Logger.getLogger(CargaProyectoManager.class);
	...
	public static File generaArchivoCalendarioProyecto(Connection conn, boolean esAdministrador, String ue, int ejercicioFiscal, int[] capitulosExcluir, String nombreArchivo) throws Exception {
		...
		String query = "SELECT	EP, " + "		MONTO AS monto_anual, " + "		CONVERT(int,'0') as monto_enero, " + "		CONVERT(int,'0') as monto_febrero, " + "		CONVERT(int,'0') as monto_marzo, " + "		CONVERT(int,'0') as monto_abril, " + "		CONVERT(int,'0') as monto_mayo, "
			+ "		CONVERT(int,'0') as monto_junio, " + "		CONVERT(int,'0') as monto_julio, " + "		CONVERT(int,'0') as monto_agosto, " + "		CONVERT(int,'0') as monto_septiembre, " + "		CONVERT(int,'0') as monto_octubre, " + "		CONVERT(int,'0') as monto_noviembre, "
			+ "		CONVERT(int,'0') as monto_diciembre " + " FROM	tProyecto_PF " + " WHERE	aEjercicioFiscal = " + ejercicioFiscal + " AND cUnidadEjecutora = '" + ue + "' ";
		try {
			...
			if (esAdministrador && capitulosExcluir != null && capitulosExcluir.length > 0) {
				String token = "";
				query += " UNION " + " SELECT	EP, " + "		MONTO AS monto_anual, " + "		CONVERT(int,'0') as monto_enero, " + "		CONVERT(int,'0') as monto_febrero, " + "		CONVERT(int,'0') as monto_marzo, " + "		CONVERT(int,'0') as monto_abril, " + "		CONVERT(int,'0') as monto_mayo, "
					+ "		CONVERT(int,'0') as monto_junio, " + "		CONVERT(int,'0') as monto_julio, " + "		CONVERT(int,'0') as monto_agosto, " + "		CONVERT(int,'0') as monto_septiembre, " + "		CONVERT(int,'0') as monto_octubre, " + "		CONVERT(int,'0') as monto_noviembre, "
					+ "		CONVERT(int,'0') as monto_diciembre " + " FROM	tProyecto_PF " + " WHERE	cUnidadEjecutora <> '" + ue + "' ";
				query += " AND ( ";
				for (int i = 0; i < capitulosExcluir.length; i++) {
	...
	public static File generaArchivoCalendarioProyectoFinal(Connection conn, String unidadEjecutora, String unidadNormativa, int ejercicioFiscal, String nombreArchivo) throws Exception {
		...
		ResultSet rs = null;
		String token = " WHERE ";
		String query = "SELECT	EP AS EP,  " + "		mMonto_ANUAL AS	monto_anual, " + "		mMonto_Enero AS	monto_enero, " + "		mMonto_Febrero AS monto_febrero, " + "		mMonto_Marzo AS monto_marzo, " + "		mMonto_Abril AS monto_abril,  " + "		mMonto_Mayo AS monto_mayo,  " + "		mMonto_Junio AS monto_junio, "
			+ "		mMonto_Julio AS monto_julio,  " + "		mMonto_Agosto AS monto_agosto,  " + "		mMonto_Septiembre AS monto_septiembre, " + "		mMonto_Octubre AS monto_octubre,  " + "		mMonto_Noviembre AS monto_noviembre,  " + "		mMonto_Diciembre AS monto_diciembre " + " FROM	tProyecto_Calendario ";
	...
	public static File generaArchivoProyectoPorUN(Connection conn, String unidadNormativa, String nombreArchivo, int ejercicioFiscal, int[] capitulosExcluir) throws Exception {
		String query = "SELECT EP, " + "	MONTO AS monto_anual, " + "	CONVERT(int,'0') as monto_enero, " + "	CONVERT(int,'0') as monto_febrero, " + "	CONVERT(int,'0') as monto_marzo, " + "	CONVERT(int,'0') as monto_abril, " + "	CONVERT(int,'0') as monto_mayo, " + "	CONVERT(int,'0') as monto_junio, "
			+ "	CONVERT(int,'0') as monto_julio, " + "	CONVERT(int,'0') as monto_agosto, " + "	CONVERT(int,'0') as monto_septiembre, " + "	CONVERT(int,'0') as monto_octubre, " + "	CONVERT(int,'0') as monto_noviembre, " + "	CONVERT(int,'0') as monto_diciembre "
			+ " FROM tProyecto_PF WHERE aEjercicioFiscal =" + ejercicioFiscal + " AND cUnidadNormativa = '" + unidadNormativa + "' ";
		ResultSet rs = null;
		Statement stmt = null;
