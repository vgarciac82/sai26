...
public class EPManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(EPManager.class);
    ...
    public static boolean epSinCapitulosRestringidos(boolean esAdmin, Map<String, String> ep, int[] capitulosRestringidos) {
        if (esAdmin || capitulosRestringidos == null)
            ...
            for (int i = 0; i < capitulosRestringidos.length; i++) contieneRestingida = contieneRestingida && !capitulo.startsWith(String.valueOf(capitulosRestringidos[i]));
