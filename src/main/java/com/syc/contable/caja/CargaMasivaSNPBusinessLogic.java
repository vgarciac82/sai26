...
public class CargaMasivaSNPBusinessLogic extends DataSourceManager {
	...
	private static final Logger log = Logger.getLogger( CargaMasivaSNPBusinessLogic.class );
	...
	public String generaReporteExpedientesFaltantes( String reportePath, List<String> filtros, String cUnidadEjecutora ) throws Exception {
		...
		try {
			...
			fileName = System.getProperty( "java.io.tmpdir" ) + File.separatorChar + 
					"ReporteExpFaltantes_" + System.currentTimeMillis() + "_" + String.valueOf((int) (Math.random() * 100)) + ".xls";
