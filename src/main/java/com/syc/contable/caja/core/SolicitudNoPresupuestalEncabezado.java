...
public class SolicitudNoPresupuestalEncabezado {
	...
	public String toString() {
		return "SolicitudNoPresupuestalEncabezado [folioCaja=" + folioCaja + ", fechaCreacion=" + fechaCreacion + ", fechaAplicacion=" + fechaAplicacion + ", mes=" + mes + ", tipoPoliza=" + tipoPoliza + ", folioPoliza=" + folioPoliza + ", descripcionPoliza=" + descripcionPoliza + ", uLogin="
			+ uLogin + ", documentoHAplicado=" + documentoHAplicado + ", motivoRechazo=" + motivoRechazo + ", unidadResponsableContable=" + unidadResponsableContable + ", folioPolizaCancelacion=" + folioPolizaCancelacion + ", fechaCancelacion=" + fechaCancelacion + ", ejercicioFiscal="
			+ ejercicioFiscal + ", ramo=" + ramo + ", unidadEjecutora=" + unidadEjecutora + ", firmanteVoBo=" + firmanteVoBo + ", puestoVoBo=" + puestoVoBo + ", firmanteAut=" + firmanteAut + ", puestoAut=" + puestoAut + ", idCaso=" + idCaso + ", idGrupoEvento=" + idGrupoEvento + ", montoSolicitud="
			+ montoSolicitud + ", folioComprobacion=" + folioComprobacion + ", nombreBenCheque=" + nombreBenCheque + ", paternoBenCheque=" + paternoBenCheque + ", maternoBenCheque=" + maternoBenCheque + ", comprobado=" + comprobado + "]";
	}
