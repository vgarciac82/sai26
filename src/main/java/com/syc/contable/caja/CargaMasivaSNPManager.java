...
public class CargaMasivaSNPManager {
	...
	private static final Logger log = Logger.getLogger(CargaMasivaSNPManager.class);
	...
	public static void generaReporteExpedientesFaltantes(Connection conn, List<String> filtros, String cUnidadEjecutora, String  plantillaPath) throws Exception{
		...
		ResultSet rs = null;
		String query = "SELECT	titulo_aplicacion,	nfolio	,canocontrarrecibo,	fechaaplicacion , cunidadresponsable, Solicitud_de_Pago_Firmada, CLC,	"
					 + " Comprobante_Banco, Otros, TipoTramite, tipoIngreso, cDescripcionPoliza, cTipoPoliza, oficioPago " 
					 + "  FROM	v_ControlExpedientesSAI with(nolock) " 
					 +"  WHERE	cumpleExpediente = 'N' " ;
		String cond = "";
		String token ="";
