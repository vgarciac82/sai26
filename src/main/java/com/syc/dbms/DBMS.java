...
public class DBMS {
	...
	private static final String[] dbmsList = { "SQL SERVER", "ORACLE", "INFORMIX", "SYBASE", "ANYWHERE", "ANTS", "DB2",
			"ISERIES" };
		...
		switch (currentDbms) {
			...
			case ISERIES:
				if ("YYYYMMDD".equals(format.toUpperCase()))
					retValue = "SUBSTR(CHAR(" + value + "),1,4) || SUBSTR(CHAR(" + value + "),6,2) || SUBSTR(CHAR("
							+ value + "),9,2)";
