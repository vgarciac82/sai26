...
public class EstimacionObra {
    ...
    public String toString() {
        return "EstimacionObra [cveContrato=" + cveContrato + ", eFiscalPago=" + eFiscalPago + ", fEntregaVentanilla=" + fEntregaVentanilla + ", folioSAI=" + folioSAI + ", fPeriodoEstimacionFin=" + fPeriodoEstimacionFin + ", fPeriodoEstimacionIni=" + fPeriodoEstimacionIni + ", mesEstimado=" + mesEstimado + ", montoEstimacion=" + montoEstimacion + ", montoEstimacionAmortizado=" + montoEstimacionAmortizado + ", montoEstimacionIva=" + montoEstimacionIva + ", montoEstimacionMasIva=" + montoEstimacionMasIva + ", montoEstimacionRetencion=" + montoEstimacionRetencion + ", montoFisicoEjecutado=" + montoFisicoEjecutado + ", montoFisicoProgramado=" + montoFisicoProgramado + ", noEstimacion=" + noEstimacion + ", porceAvanceFisicoEjecutado=" + porceAvanceFisicoEjecutado + ", porceAvanceFisicoEstimado=" + porceAvanceFisicoEstimado + ", porceAvanceFisicoProgramado=" + porceAvanceFisicoProgramado + ", esCapitalizable=" + esCapitalizable + ", ultimaEstimacion=" + ultimaEstimacion + "]";
    }
