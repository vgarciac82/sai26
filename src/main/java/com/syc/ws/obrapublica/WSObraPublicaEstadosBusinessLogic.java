...
public class WSObraPublicaEstadosBusinessLogic extends DataSourceManager {
	...
	private static Logger	log			= Logger.getLogger(WSObraPublicaEstadosBusinessLogic.class);
	...
	public boolean registraEstimacionObra(EstimacionObra estimacion,Usuario u) throws Exception {
		...
		try {
			...
			if(esFonden != 1 ) { //ARLA 08102021 si el contrato esta marcado con FONDEN no notifica al sistema de inmuebles
