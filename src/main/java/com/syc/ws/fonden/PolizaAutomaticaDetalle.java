...
public class PolizaAutomaticaDetalle {
	...
	public PolizaAutomaticaDetalle(String cuentaContable, String evento, BigDecimal importeMovimiento,
			String subcuenta) {
		super();
	...
	public String toString() {
		return "PolizaAutomaticaDetalle [cuentaContable=" + cuentaContable + ", evento=" + evento
				+ ", importeMovimiento=" + importeMovimiento + ", partida=" + partida + ", subcuenta=" + subcuenta
				+ "]";
	}
