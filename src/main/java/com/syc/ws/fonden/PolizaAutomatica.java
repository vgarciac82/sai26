...
public class PolizaAutomatica {
	...
	public PolizaAutomatica(String centroContable, String descripcion, List<PolizaAutomaticaDetalle> detalle,
			int mesCierre, String tipoPoliza, BigDecimal totalPoliza, String unidadEjecutora) {
		super();
	...
	public String toString() {
		return "PolizaAutomatica [centroContable=" + centroContable + ", descripcion=" + descripcion + ", detalle="
				+ detalle + ", mesCierre=" + mesCierre + ", tipoPoliza=" + tipoPoliza + ", totalPoliza=" + totalPoliza
