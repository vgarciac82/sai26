...
public class UsuarioBusinessLogic extends DataSourceManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(UsuarioBusinessLogic.class);
    ...
    public Usuario validaCredenciales(String u_login, String u_password) throws GestionException {
        ...
        try {
            ...
            log.debug("Object: " + String.valueOf("Buscando Usuario:" + u_login + " password:" + u_password));
    ...
    public Usuario setUserUR(Usuario u) throws GestionException {
        ...
        try {
            ...
            if (u != null) {
                ...
                log.debug("Object: " + String.valueOf("Usuario encontrado:" + u.getLogin() + " UR:" + u.getU_UR()));
            }
            return u;
    ...
    public Usuario validaCredencialesActivo(String u_login, String u_password) throws GestionException {
        ...
        try {
            ...
            try {
                if (ru != null) {
                    // para
                    ru = UsuarioManager.getRamoUR(conn, ru);
                    // complementar
                    // Unidad
                    // responsable y
                    // Ramo
                    log.debug("Object: " + String.valueOf("Usuario encontrado:" + ru.getLogin() + " UR:" + ru.getU_UR()));
                }
            } catch (Exception exc1) {
    ...
    public Element toParaXML() throws GestionException {
        ...
        try {
            ...
            for (Iterator iter = usrList.iterator(); iter.hasNext(); ) elUsers.addContent(((Usuario) iter.next()).toXML());
            elPara.addContent(elUsers);
            List grpList = GrupoManager.selectAll(conn);
            Element elGroup = new Element("grupos");
            for (Iterator iter = grpList.iterator(); iter.hasNext(); ) elGroup.addContent(((Grupo) iter.next()).toXML());
