...
@WebServlet(name = "GestionActionsServlet", urlPatterns = { "/caso/actions" })
public class GestionActionsServlet extends HttpServlet implements GestionInterface {

    private static final long serialVersionUID = 1L;

    private static Logger log = LoggerFactory.getLogger(GestionActionsServlet.class);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            throw new ServletException("Creando " + (isFolder ? "carpeta" : "documento " + (isDocImg ? "Fortimax" : "externo")), exc);
        }
        PrintWriter out = resp.getWriter();
        out.println("<script type=\"text/javascript\">");
        out.println("parent.frames[\"main\"].location.href=\"resp-carpeta-docto.jsp?fldr=" + isFolder + "&img=" + isDocImg + "&name=" + nombre + "\"");
