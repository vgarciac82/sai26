...
@WebServlet(name = "GestionAdminMantoCasoServlet", urlPatterns = { "/admin/mantoCaso" })
public class GestionAdminMantoCasoServlet extends HttpServlet implements GestionInterface {

    private static final long serialVersionUID = 1L;

    private static Logger log = LoggerFactory.getLogger(GestionAdminMantoCasoServlet.class);
    ...
    private void mantenimientoTipoCaso(HttpServletRequest req, HttpServletResponse resp, int mode) throws ServletException, IOException {
        ...
        try {
            ...
            tc.setTiempoLimite(Integer.parseInt(((tc_tiempo_limite == null) || ("".equals(tc_tiempo_limite.trim()))) ? "-1" : tc_tiempo_limite));
    ...
    private void mantenimientoCasoVariable(HttpServletRequest req, HttpServletResponse resp, int mode) throws ServletException, IOException {
        ServletOutputStream out = resp.getOutputStream();
        try {
            String id_tc = req.getParameter("id_tc");
            ...
            tcv.setLongitud(Integer.parseInt(((tcv_longitud == null) || ("".equals(tcv_longitud.trim()))) ? "-1" : tcv_longitud));
    ...
    private void mantenimientoOperacion(HttpServletRequest req, HttpServletResponse resp, int mode) throws ServletException, IOException {
        ServletOutputStream out = resp.getOutputStream();
        try {
            String id_tc = req.getParameter("id_tc");
            ...
            o.setTiempoLimite(Integer.parseInt(((o_tiempo_limite == null) || ("".equals(o_tiempo_limite.trim())) ? "-1" : o_tiempo_limite)));
    ...
    private void mantenimientoOperacionResponsable(HttpServletRequest req, HttpServletResponse resp, int mode) throws ServletException, IOException {
        ServletOutputStream out = resp.getOutputStream();
        try {
            String id_tc = req.getParameter("id_tc");
            String id_oper = req.getParameter("id_oper");
            ...
            os.setIdOperacionSigte(Integer.parseInt(((id_oper_sigte == null) || ("".equals(id_oper_sigte.trim()))) ? "-1" : id_oper_sigte.trim()));
