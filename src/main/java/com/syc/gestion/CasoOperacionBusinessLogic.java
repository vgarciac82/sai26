...
public class CasoOperacionBusinessLogic extends DataSourceManager {
	...
	private static Logger log = Logger.getLogger( CasoOperacionBusinessLogic.class );
	...
	public void revisaTiempoLimiteDeCasosOperacion( String prefixPath, boolean extMail ) throws GestionException {// Ethiel,
																													// se
																													// agrega
																													// extMail
		...
		try {
			...
			CasoOperacionManager.revisaTiempoLimiteDeCasosOperacion( conn, prefixPath, extMail );// Ethiel,
																									// se
																									// agrega
																									// extMail
