...
import com.syc.contratosplurianuales.SolicitudContratoPlurianualManager;
import java.util.Base64;

public class ModificaContratosPlurianualesImpl implements TipoCasoInterface {
    ...
    public void onTerminaCaso(Connection conn, String u_login, Caso c, String observ, String[] resp, String[] oper, Map data) throws SQLException {
        try {
            SolicitudContratoPlurianualManager.descartaModificacionContrato(conn, u_login, c);
        } catch (Exception e) {
            throw new SQLException(e);
        }
    }
