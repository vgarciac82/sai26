...
public class BitacoraOperacionBusinessLogic extends DataSourceManager {
	...
	private static Logger log = Logger.getLogger(BitacoraOperacionBusinessLogic.class);
	...
	public ITree getArbolBitacoraOperacion(
			//BitacoraCaso bc, 
	...
	public String getGestionXML(String tituloAplicacion, 
			String folio,
			String realPath) throws GestionException {
		...
		try {
			conn = getConnection();
			//GAF 2009-02-24
			retVal = BitacoraOperacionManager.getGestionXml(conn,
															tituloAplicacion,
															folio,
															realPath);
		} catch (SQLException exc) {
