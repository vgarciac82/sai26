...
public class CasoDatoByNameBusinessLogic extends DataSourceManager {
    ...
    private static Logger log = LoggerFactory.getLogger(CasoDatoByNameBusinessLogic.class);
    ...
    public String select(int id_caso, String id_tcv) throws GestionException {
        ...
        try {
            ...
            log.debug("Object: " + String.valueOf("[CasoDatoByNameBusinessLogic] variable='" + id_tcv + "', Caso='" + id_caso + "', Valor='" + v + "'"));
