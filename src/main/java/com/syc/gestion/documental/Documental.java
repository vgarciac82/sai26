...
public class Documental implements Serializable {
    ...
    public static final int[] OPR_STACK_LST = { // OPR_CONTINUAR
    OPR_STACK_NOP, // OPR_RECEPCION
    OPR_STACK_PUSH, // OPR_ATENCION
    OPR_STACK_PUSH, // OPR_TURNADO
    OPR_STACK_NOP, // OPR_RESPUESTA_TOTAL
    OPR_STACK_POP, // OPR_POR_CERRAR
    OPR_STACK_POP, // OPR_RECHAZAR
    OPR_STACK_POP, // OPR_COPIA_PARA
    OPR_STACK_NOP, // OPR_PRORROGA
    OPR_STACK_POP, // OPR_RECHAZO_PRORROGA
    OPR_STACK_PUSH, // OPR_RECHAZO_RESPUESTA
    OPR_STACK_PUSH, // OPR_ACEPTAR_PRORROGA
    OPR_STACK_PUSH, // OPR_RESPUESTA_COORD
    OPR_STACK_NOP, // OPR_RESPUESTA_PARCIAL
    OPR_STACK_POP };
