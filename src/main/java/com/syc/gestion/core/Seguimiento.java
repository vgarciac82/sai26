...
public class Seguimiento implements Serializable{
	...
	private String tipo_instruccion; //RDMB: Se agrega para el seguimiento
	public int getIdTC() {
	...
	public String getTipoInstruccion(){return tipo_instruccion;}  //RDMB: Se agrega geter y seter para tipo_instruccion
	public void setTipoInstruccion(String idInstruccion) {this.tipo_instruccion = idInstruccion;}
