...
public class EmpleadoAreaManager {
    ...
    public static int insert(Connection conn, EmpleadoArea ea) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("INSERT INTO cg_cat_areas " + "(ID_AREA, D_DESCRIPCION, TIPO_AREA, PREFIJO_FOLIO, ID_AREA_PADRE) " + "VALUES (?, ?, ?, ?, ?)");
    ...
    public static int update(Connection conn, EmpleadoArea r) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("UPDATE cg_cat_areas " + "SET D_DESCRIPCION = ?, " + "TIPO_AREA = ?, " + "PREFIJO_FOLIO = ?, " + "ID_AREA_PADRE = ?, " + "BANDEJA_COMPARTIDA_IN = ?, " + "BANDEJA_COMPARTIDA_OUT = ? " + "WHERE ID_AREA = ?");
