...
public class SeguimientoTurnoCasoManager {
    ...
    public static int insert(Connection conn, SeguimientoTurnoCaso stc_new) throws SQLException {
        ...
        try {
            pstmnt = conn.prepareStatement("INSERT INTO CG_SEGUIMIENTO_TURNADO_CASO ( " + "org_id_caso, " + "org_id_caso_oper, " + "org_id_tc, " + "org_id_oper, " + "org_co_responsable, " + "des_id_caso, " + "des_id_caso_oper, " + "des_id_tc, " + "des_id_oper, " + "des_co_responsable, " + "des_co_instruccion, " + "fecha_registro " + ")  " + "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public static int deleteOneByOne(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("DELETE FROM CG_SEGUIMIENTO_TURNADO_CASO " + "org_id_caso = ? and " + "org_id_caso_oper = ? and " + "org_id_tc = ? and " + "org_id_oper = ? and " + "des_id_caso = ? and " + "des_id_caso_oper = ? and " + "des_id_tc = ? and " + "des_id_oper = ? ");
    ...
    public static int deleteByDesIdCaso(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("DELETE FROM CG_SEGUIMIENTO_TURNADO_CASO WHERE " + "des_id_caso = ? ");
    ...
    public static int deleteByDes(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("DELETE FROM CG_SEGUIMIENTO_TURNADO_CASO WHERE" + "des_id_caso = ? and " + "des_id_caso_oper = ? and " + "des_id_tc = ? and " + "des_id_oper = ? ");
            pstmnt.setInt(1, stc.getDesIdCaso());
    ...
    public static int deleteByOrgIdCaso(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("DELETE FORM CG_SEGUIMIENTO_TURNADO_CASO WHERE " + "org_id_caso = ? ");
            pstmnt.setInt(1, stc.getOrgIdCaso());
            retval = pstmnt.executeUpdate();
        } finally {
            if (pstmnt != null)
    ...
    public static int deleteByOrg(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("DELETE FROM CG_SEGUIMIENTO_TURNADO_CASO WHERE " + "org_id_caso = ? and " + "org_id_caso_oper = ? and " + "org_id_tc = ? and " + "org_id_oper = ? ");
            pstmnt.setInt(1, stc.getOrgIdCaso());
            pstmnt.setInt(2, stc.getOrgIdCasoOper());
            pstmnt.setInt(3, stc.getOrgIdTc());
            pstmnt.setInt(4, stc.getOrgIdOper());
    ...
    public static SeguimientoTurnosCasos selectByDes(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        ResultSet rs = null;
        try {
            pstmnt = conn.prepareStatement("SELECT " + "org_id_caso, " + "org_id_caso_oper, " + "org_id_tc, " + "org_id_oper, " + "org_co_responsable, " + "des_id_caso, " + "des_id_caso_oper, " + "des_id_tc, " + "des_id_oper, " + "des_co_responsable, " + "des_co_instruccion, " + "fecha_registro " + "FROM CG_SEGUIMIENTO_TURNADO_CASO " + "WHERE " + "des_id_caso = ? and " + "des_id_caso_oper = ? and " + "des_id_tc = ? and " + "des_id_oper = ? ");
            pstmnt.setInt(1, stc.getDesIdCaso());
            pstmnt.setInt(2, stc.getDesIdCasoOper());
            pstmnt.setInt(3, stc.getDesIdTc());
            pstmnt.setInt(4, stc.getDesIdOper());
    ...
    public static SeguimientoTurnosCasos selectByOrg(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("SELECT " + "org_id_caso, " + "org_id_caso_oper, " + "org_id_tc, " + "org_id_oper, " + "org_co_responsable, " + "des_id_caso, " + "des_id_caso_oper, " + "des_id_tc, " + "des_id_oper, " + "des_co_responsable, " + "FROM CG_SEGUIMIENTO_TURNADO_CASO " + "WHERE " + "org_id_caso = ? and " + "org_id_caso_oper = ? and " + "org_id_tc = ? and " + "org_id_oper = ? ");
            pstmnt.setInt(1, stc.getOrgIdCaso());
            pstmnt.setInt(2, stc.getOrgIdCasoOper());
            pstmnt.setInt(3, stc.getOrgIdTc());
            pstmnt.setInt(4, stc.getOrgIdOper());
    ...
    public static int selectCountByDes(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        ResultSet rs = null;
        try {
            pstmnt = conn.prepareStatement("SELECT " + "COUNT(des_id_caso) " + "FROM CG_SEGUIMIENTO_TURNADO_CASO " + "WHERE " + "des_id_caso = ? and " + "des_id_caso_oper = ? and " + "des_id_tc = ? and " + "des_id_oper = ? ");
            pstmnt.setInt(1, stc.getOrgIdCaso());
            pstmnt.setInt(2, stc.getOrgIdCasoOper());
            pstmnt.setInt(3, stc.getOrgIdTc());
            pstmnt.setInt(4, stc.getOrgIdOper());
    ...
    public static int selectCountByOrg(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("SELECT " + "count (org_id_caso) " + "FROM CG_SEGUIMIENTO_TURNADO_CASO " + "WHERE " + "org_id_caso = ? and " + "org_id_caso_oper = ? and " + "org_id_tc = ? and " + "org_id_oper = ? ");
            pstmnt.setInt(1, stc.getOrgIdCaso());
            pstmnt.setInt(2, stc.getOrgIdCasoOper());
            pstmnt.setInt(3, stc.getOrgIdTc());
            pstmnt.setInt(4, stc.getOrgIdOper());
    ...
    public static int selectCountByOrgDes(Connection conn, SeguimientoTurnoCaso stc) throws SQLException {
        ...
        int retVal = -1;
        try {
            pstmnt = conn.prepareStatement("SELECT " + "count(org_id_caso) " + "FROM CG_SEGUIMIENTO_TURNADO_CASO " + "WHERE " + "org_id_caso = ? and " + "org_id_caso_oper = ? and " + "org_id_tc = ? and " + "org_id_oper = ? and " + "des_id_caso = ? and " + "des_id_caso_oper = ? and " + "des_id_tc = ? and " + "des_id_oper = ? ");
            pstmnt.setInt(1, stc.getOrgIdCaso());
            pstmnt.setInt(2, stc.getOrgIdCasoOper());
            pstmnt.setInt(3, stc.getOrgIdTc());
            pstmnt.setInt(4, stc.getOrgIdOper());
    ...
    public static int selectCountTotalRows(Connection conn) throws SQLException {
        ...
        int retVal = -1;
        try {
            pstmnt = conn.prepareStatement("SELECT " + "count(org_id_caso) " + "FROM CG_SEGUIMIENTO_TURNADO_CASO ");
            ResultSet rs = null;
            rs = pstmnt.executeQuery();
            while (rs.next()) {
                retVal = rs.getInt(1);
    ...
    public static int update(Connection conn, SeguimientoTurnoCaso stc_new) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("UPDATE CG_SEGUIMIENTO_TURNADO_CASO SET " + //"org_co_responsable = ? , " +
            "des_co_responsable = ?, " + "des_co_instruccion = ? " + "WHERE " + //"org_id_caso = ? and " +
            //"org_id_caso_oper = ? and " +
            //"org_id_tc = ? and " +
            //"org_id_oper = ? " +
            "des_id_caso = ? and " + "des_id_caso_oper = ? and " + "des_id_tc = ? and " + "des_id_oper = ? ");
