...
public class GrupoPropiedadesManager {
    ...
    public static int insert(Connection conn, GrupoPropiedades gp) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("INSERT INTO cg_grupo_propiedades (g_nombre, gp_nombre, gp_valor) VALUES (?, ?, ?)");
    ...
    public static int update(Connection conn, GrupoPropiedades gp) throws SQLException {
        ...
        PreparedStatement pstmnt = null;
        try {
            pstmnt = conn.prepareStatement("UPDATE cg_grupo_propiedades " + "SET gp_valor = ?" + "WHERE g_nombre = ?  AND gp_nombre = ?");
