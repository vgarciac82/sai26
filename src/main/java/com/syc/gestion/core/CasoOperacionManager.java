...
public class CasoOperacionManager {
	...
	public static void revisaTiempoLimiteDeCasosOperacion( Connection conn, String prefixPath, boolean extMail ) throws IOException, SQLException, GestionException {// Ethiel,
																																										// se
																																										// agrga
																																										// extMail
