...
public class ReporteManager {
	...
	public static List callMultiReportePresupuestal(Connection conn, String EPs, String ProgramaPresupuestario, String Partida, String UnidadResponsableEP, 
		String UnidadEjecutora, String Cartera, String ChkReintegros, String ChkRectificaciones, String ChkAdecuaciones, String ChkPagosAnticipados, String ChkPlurianuales, String ChkOriginal, 
		String ChkModificado, String ChkAmpAutorizada, String ChkRedAutorizada, String ChkAmpenTramite, String ChkRedenTramite, String ChkReienTramite, String ChkRectificacion, String ChkRedSHCPenTramite, String ChkRedSHCPAplicada, 
		String ChkApartado, String ChkPrecomprometido, String ChkComprometido, String ChkDevengado, String ChkEjernoPagado, String ChkDisponibleNeto, String ChkDisponibleBruto, String ChkEjercidoPagado, String sULogin) throws SQLException {
		...
		try {
			...
			while (rs.next()) {
				...
				anual = Double.parseDouble(rs.getString("Enero")) + Double.parseDouble(rs.getString("Febrero")) + Double.parseDouble(rs.getString("Marzo")) + Double.parseDouble(rs.getString("Abril")) + Double.parseDouble(rs.getString("Mayo")) + Double.parseDouble(rs.getString("Junio")) + 
						Double.parseDouble(rs.getString("Julio")) + Double.parseDouble(rs.getString("Agosto")) + Double.parseDouble(rs.getString("Septiembre")) + Double.parseDouble(rs.getString("Octubre")) + Double.parseDouble(rs.getString("Noviembre")) + Double.parseDouble(rs.getString("Diciembre"));
			...
			Statement stmt = conn.createStatement();
		      String sql = "DELETE FROM tMultiReportePresupuestos " +
		                   "WHERE u_login = '"+sULogin.trim()+"'";
...
//			rs = pstmnt.executeQuery();
			...
			while (rs.next()) {
				...
				if (cGroupBy.equals("aEjercicioFiscal_1")||cGroupBy.equals("cSubCuenta")){epSaldo.setEjercicioFiscal(rs.getString("aEjercicioFiscal_1"));}
				if (cGroupBy.equals("cRamo_2")||cGroupBy.equals("cSubCuenta")){epSaldo.setRamoEP(rs.getString("cRamo_2"));}
				if (cGroupBy.equals("cUnidadResponsable_3")||cGroupBy.equals("cSubCuenta")){epSaldo.setUnidadResponsableEP(rs.getString("cUnidadResponsable_3"));}
				if (cGroupBy.equals("cGrupoFuncional_4")||cGroupBy.equals("cSubCuenta")){epSaldo.setGrupoFuncional(rs.getString("cGrupoFuncional_4"));}
				if (cGroupBy.equals("cFuncion_5")||cGroupBy.equals("cSubCuenta")){epSaldo.setFuncion(rs.getString("cFuncion_5"));}
				if (cGroupBy.equals("cSubFuncion_6")||cGroupBy.equals("cSubCuenta")){epSaldo.setSubFuncion(rs.getString("cSubFuncion_6"));}
				if (cGroupBy.equals("cProgramaGeneral_7")||cGroupBy.equals("cSubCuenta")){epSaldo.setProgramaGeneral(rs.getString("cProgramaGeneral_7"));}
				if (cGroupBy.equals("cActividadInstitucional_8")||cGroupBy.equals("cSubCuenta")){epSaldo.setActividadInstitucional(rs.getString("cActividadInstitucional_8"));}
				if (cGroupBy.equals("cProgramaPresupuestario_9")||cGroupBy.equals("cSubCuenta")){epSaldo.setProgramaPresupuestario(rs.getString("cProgramaPresupuestario_9"));}
				if (cGroupBy.equals("cPartida_10")||cGroupBy.equals("cSubCuenta")){epSaldo.setPartida(rs.getString("cPartida_10"));}
				if (cGroupBy.equals("cTipoGasto_11")||cGroupBy.equals("cSubCuenta")){epSaldo.setTipoGasto(rs.getString("cTipoGasto_11"));}
				if (cGroupBy.equals("cFuenteFinanciamiento_12")||cGroupBy.equals("cSubCuenta")){epSaldo.setFuenteFinanciamiento(rs.getString("cFuenteFinanciamiento_12"));}
				if (cGroupBy.equals("cEntidadFederativa_13")||cGroupBy.equals("cSubCuenta")){epSaldo.setEntidadFederativa(rs.getString("cEntidadFederativa_13"));}
				if (cGroupBy.equals("cCartera_14")||cGroupBy.equals("cSubCuenta")){epSaldo.setCartera(rs.getString("cCartera_14"));}
				if (cGroupBy.equals("cUnidadResponsable_15")||cGroupBy.equals("cSubCuenta")){epSaldo.setUnidadEjecutora(rs.getString("cUnidadResponsable_15"));}
				if (cGroupBy.equals("cUnidadResponsable_16")||cGroupBy.equals("cSubCuenta")){epSaldo.setUnidadNorativa(rs.getString("cUnidadResponsable_16"));}

				if (cGroupBy.equals("cSubCuenta")){epSaldo.setEp(rs.getString("cSubCuenta"));}
				if (cGroupBy.equals("cSubCuenta")){epSaldo.setClaveCNA(rs.getString("nClaveCNA"));}
				...
				for (int contador =0; contador <nCtasPresup.length; contador++ ){
					if (Cuenta==""||Cuenta.contains(nCtasPresup[contador])){
						...
						if (opcion.equals("ORIGINAL")){epSaldo.setMontoOriginal(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("MODIFICADO")){epSaldo.setMontoModificado(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("AMPLIACION_AUTORIZADA")){epSaldo.setMontoAmpliacionAutorizada(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("REDUCCION_AUTORIZADA")){epSaldo.setMontoReduccionAutorizada(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("AMPLIACION_EN_TRAMITE")){epSaldo.setMontoAmpliacionTramite(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("APARTADO")){epSaldo.setMontoApartado(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("PRECOMPROMETIDO")){epSaldo.setMontoPrecomprometido(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("COMPROMETIDO")){epSaldo.setMontoComprometido(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("DEVENGADO")){epSaldo.setMontoDevengado(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("EJERCIDO_NO_PAGADO")){epSaldo.setMontoEjercidoNoPagado(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("DISPONIBLE_NETO")){epSaldo.setMontoDisponibleNeto(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("DISPONIBLE_NETO_RADICADO")){epSaldo.setMontoDisponibleNetoRadicado(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("DISPONIBLE_BRUTO")){epSaldo.setMontoDisponibleBruto(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("EJERCIDO_PAGADO")){epSaldo.setMontoEjercidoPagado(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("REDUCCION_EN_TRAMITE")){epSaldo.setMontoReduccionTramite(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("REINTEGRO_EN_TRAMITE")){epSaldo.setMontoReintegroTramite(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("RECTIFICACION")){epSaldo.setMontoRectificacion(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("REDUCCION_SHCP_EN_TRAMITE")){epSaldo.setMontoReduccionSHCPTramite(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("REDUCCION_SHCP_APLICADA")){epSaldo.setMontoReduccionSHCPAplicada(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						if (opcion.equals("PRECOMPROMISO_MATERIALES")){epSaldo.setMontoPrecompromisoMateriales(rs.getString(dCtasPresup[contador].replace(" ", "_")));}
						};
					}
...
//			rs = pstmnt.executeQuery();
			...
			rsmd = rs.getMetaData();
			 ...
			 while (rs.next()) 
			 {
				 ...
				 {
					 if ((TipoReporte.equals("GENERAL") && i>=3 && i<=18 ) || 
						 (!TipoReporte.equals("GENERAL") && i>=5 && i<=20)){
						 if (Componentes.compareTo("INCLUIR")==0)
							 if ((rsmd.getColumnName(i).equals("aEjercicioFiscal_1")) || 
								 (rsmd.getColumnName(i).equals("cRamo_2")) || 
								 (rsmd.getColumnName(i).equals("cUnidadResponsable_3")) ||
								 (rsmd.getColumnName(i).equals("cGrupoFuncional_4")) ||
								 (rsmd.getColumnName(i).equals("cFuncion_5")) ||
								 (rsmd.getColumnName(i).equals("cSubFuncion_6")) ||
								 (rsmd.getColumnName(i).equals("cProgramaGeneral_7")) ||
								 (rsmd.getColumnName(i).equals("cActividadInstitucional_8")) ||
								 (rsmd.getColumnName(i).equals("cProgramaPresupuestario_9")) ||
								 (rsmd.getColumnName(i).equals("cPartida_10")) ||
								 (rsmd.getColumnName(i).equals("cTipoGasto_11")) ||
								 (rsmd.getColumnName(i).equals("cFuenteFinanciamiento_12")) ||
								 (rsmd.getColumnName(i).equals("cEntidadFederativa_13")) ||
								 (rsmd.getColumnName(i).equals("cCartera_14")) ||
								 (rsmd.getColumnName(i).equals("cUnidadResponsable_15")) ||
...
//		System.out.println("Salida: "+Salida);
	...
	public static List callBalanza(Connection conn, String buscaCuentaIni,String buscaCuentaFin, String aEjercicioFiscal, String DepuraLineas, String DepuraColumnas,
		String cCentroContable, String TipoReporte, String mesIni, String mesFin, String FiltroSubcuenta) throws SQLException {
	...
	try {
		...
		cs1.setString(11, FiltroSubcuenta);System.out.println("Se pidio que se depuraran columnas? "+DepuraColumnas);
	...
	public static ArrayList<String> generaAnalitico(Connection conn, String buscaCuentaIni,String buscaCuentaFin, String aEjercicioFiscal, String DepuraLineas, String DepuraColumnas,
		String cCentroContable, String TipoReporte, String mesIni, String mesFin, String FiltroSubcuenta) throws SQLException {
	...
	public static ArrayList<String> generaBalanza(Connection conn, String buscaCuentaIni,String buscaCuentaFin, String aEjercicioFiscal, String DepuraLineas, String DepuraColumnas,
		String cCentroContable, String TipoReporte, String mesIni, String mesFin, String FiltroSubcuenta) throws SQLException {
...
//		cs1.setString(1, strCondMultiR);
	...
	public static List selectAll(Connection conn, String sql, int opc) throws SQLException {
		...
		try {
			...
			while (rs.next()) {
				...
				switch(opc){
					case 0: /*Datos necesarios para el grid de detalle del Reporte Estadï¿½stico por Area*/
						g.setArea("");
						...
						g.setFechaEnvio(rs.getString("fecha_envio"));//Tambien se puede proyectar
					...
					case 2:
						...
						g.setNombreRemitente(rs.getString("nombre_rem"));
						g.setAreaRemitente(rs.getString("desc_area_rem"));
						g.setFechaEnvio(rs.getString("fecha_envio"));//MFR - Se agrega a peticiï¿½n de Conagua para el Reporte Estadistico por Empleado
						g.setFechaAtencion(rs.getString("user03"));
						//g.setFechaAtencion(rs.getString("fechalimite"));
						g.setCerrado(rs.getString("cerrado"));
						//g.setDestinatario(rs.getString("nombre_resp"));
						g.setPrioridad(rs.getString("prioridad"));
						g.setAsunto(rs.getString("asunto"));//MFR - Se agrega a peticiï¿½n de Conagua para el Reporte Estadistico por Empleado
	...
	protected static String depura(String valor){//Ricardo:se declara este metodo de depura para que no este pintando valores null en la tabla
		String aux="";
		if(valor!=null)aux= valor;
		return aux;
	}
	...
	public static List<AnteProyectoAut> callReporteAnteproyecto(Connection conn, String ep, String ejercicioFiscal, String cOrderBy, String cGroupBy, String cuenta) throws SQLException {
		...
		try {
			...
			sqlAnteproyectoDetalleAut = "SELECT nFolioAnteProyectoAut, nConsecutivo, aEjercicioFiscal, cUnidadResponsable, " +
										"cUnidadEjecutora, cClaveSiaff, cClaveInterna, ISNULL(mCalculado,'') AS mCalculado, " +
										"ISNULL(mOptimo,'') AS mOptimo, ISNULL(mIreductible,'') AS mIreductible " +
										" FROM tAnteProyectoDetalleAut " +
										" WHERE CCLAVESIAFF = " + sqlCLAVESIAFF + 
										" AND CCLAVEINTERNA = " + sqlCLAVEINTERNA;

			pstmnt = conn.prepareStatement(sqlAnteproyectoDetalleAut);
			rs = pstmnt.executeQuery();

			while (rs.next()) {
				String sqlAnteproyectoEncabezadoAut = 	" SELECT nFolioAnteProyectoAut, cRevisor, cAutorizado FROM tAnteProyectoEncabezadoAut " +
														" WHERE nFolioAnteProyectoAut = '" + rs.getString("nFolioAnteProyectoAut") + "' " +
														" AND aEjercicioFiscal = '" + rs.getString("aEjercicioFiscal") + "' ";
				...
				if(rsH.next()){
					...
					if( ( (" ").equals(revisor) || ("A").equals(revisor)  || (" ").equals(autorizador) || ("A").equals(autorizador)) && nFolioAnteProyectoAut != null ){
						...
						if (cGroupBy.equals("aEjercicioFiscal_1")||cGroupBy.equals("cSubCuenta")){anteproyAut.setEjercicioFiscal(rs.getString("aEjercicioFiscal"));}
						if (cGroupBy.equals("cUnidadResponsable_3")||cGroupBy.equals("cSubCuenta")){anteproyAut.setUnidadResponsableEP(rs.getString("cUnidadResponsable"));}
						if (cGroupBy.equals("cUnidadResponsable_15")||cGroupBy.equals("cSubCuenta")){anteproyAut.setD_CUnidadEjecutora(rs.getString("cUnidadEjecutora"));}
						if (cGroupBy.equals("cSubCuenta")){anteproyAut.setD_CClaveSIAFF(rs.getString("cClaveSiaff"));}
						if (cGroupBy.equals("cSubCuenta")){anteproyAut.setD_CClaveInterna(rs.getString("cClaveInterna"));}

						if (cuenta==""||cuenta.contains("calculado")){anteproyAut.setD_MCalculado(rs.getString("mCalculado"));}
						if (cuenta==""||cuenta.contains("optimo")){anteproyAut.setD_MOptimo(rs.getString("mOptimo"));}
						if (cuenta==""||cuenta.contains("irreductible")){anteproyAut.setD_MIreductible(rs.getString("mIreductible"));}
	...
	public static List<AnteProyectoAut> callReporteAnteproyectoParametros(Connection conn, String ejercicioFiscal, String ramoEP, String unidadResponsableEP, String grupoFuncional, String funcion, String subFuncion, String programaGeneral, String programaPresupuestario, String actividadInstitucional, String partida, String tipoGasto, String fuenteFinanciamiento, String entidadFederativa, String cartera, String unidadEjecutora, String unidadNormativa, String cOrderBy, String cGroupBy, String cuenta, String usuario, String filtro) throws SQLException {
		...
		try{
			...
			sqlAnteproyectoDetalleAut = "SELECT header.cRevisor as cRevisor" +
										",header.cAutorizado AS cAutorizado" +
										",detail.nFolioAnteProyectoAut AS nFolioAnteProyectoAut" +
										",detail.nConsecutivo AS nConsecutivo" +
										",detail.aEjercicioFiscal AS aEjercicioFiscal" +
										",detail.cUnidadResponsable AS cUnidadResponsable" +
										",detail.cUnidadEjecutora AS cUnidadEjecutora" +
										",detail.cClaveSiaff AS cClaveSiaff" +
										",detail.cClaveInterna AS cClaveInterna" +
										",ISNULL(detail.mCalculado,'') AS mCalculado" +
										",ISNULL(detail.mOptimo,'') AS mOptimo" +
										",ISNULL(detail.mIreductible,'') AS mIreductible " +
										" FROM tAnteProyectoEncabezadoAut header with(nolock) , tAnteProyectoDetalleAut detail with(nolock)" +
										" WHERE header.nFolioAnteProyectoAut = detail.nFolioAnteProyectoAut" +
										" AND detail.CCLAVESIAFF IN " + subQueryCLAVESIAFF + 
										" AND detail.CCLAVEINTERNA IN " + subQueryCLAVEINTERNA +
										" ORDER BY nFolioAnteProyectoAut, nConsecutivo ASC";
			...
			while (rsSubQuery.next()) {
				...
				if((" ").equals(revisor) || ("A").equals(revisor)  || (" ").equals(autorizador) || ("A").equals(autorizador)){
					...
					if (cGroupBy.equals("aEjercicioFiscal_1")||cGroupBy.equals("cSubCuenta")){anteproyAut.setEjercicioFiscal(rsSubQuery.getString("aEjercicioFiscal"));}
					if (cGroupBy.equals("cUnidadResponsable_3")||cGroupBy.equals("cSubCuenta")){anteproyAut.setUnidadResponsableEP(rsSubQuery.getString("cUnidadResponsable"));}
					if (cGroupBy.equals("cUnidadResponsable_15")||cGroupBy.equals("cSubCuenta")){anteproyAut.setD_CUnidadEjecutora(rsSubQuery.getString("cUnidadEjecutora"));}
					if (cGroupBy.equals("cSubCuenta")){anteproyAut.setD_CClaveSIAFF(rsSubQuery.getString("cClaveSiaff"));}
					if (cGroupBy.equals("cSubCuenta")){anteproyAut.setD_CClaveInterna(rsSubQuery.getString("cClaveInterna"));}

					if (cuenta==""||cuenta.contains("calculado")){anteproyAut.setD_MCalculado(rsSubQuery.getString("mCalculado"));}
					if (cuenta==""||cuenta.contains("optimo")){anteproyAut.setD_MOptimo(rsSubQuery.getString("mOptimo"));}
					if (cuenta==""||cuenta.contains("irreductible")){anteproyAut.setD_MIreductible(rsSubQuery.getString("mIreductible"));}
	...
	public static List<AnteProyectoAutCalendario> callReporteAnteproyectoCalendarizado(Connection conn, String ep, String ejercicioFiscal, String cOrderBy, String cGroupBy) throws SQLException {
		...
		try {
			...
			sqlAnteproyectoCalendario = " SELECT nConsecutivo" +
										"		,nFolioAnteProyectoAut" +
										"		,aEjercicioFiscal"	+
										"		,cUnidadResponsable" +
										"		,cClaveSiaff" +
										"		,cClaveInterna" +
										"		,cCentroContable" +
										"		,nFolioAnteProyecto" +
										"		,ISNULL(mAnualAutorizado,'') AS mAnualAutorizado" +
										"		,ISNULL(mEnero,'') AS mEnero" +
										"		,ISNULL(mFebrero,'') AS mFebrero" +
										"		,ISNULL(mMarzo,'') AS mMarzo" +
										"		,ISNULL(mAbril,'') AS mAbril" +
										"		,ISNULL(mMayo,'') AS mMayo" +
										"		,ISNULL(mJunio,'') AS mJunio" +
										"		,ISNULL(mJulio,'') AS mJulio" +
										"		,ISNULL(mAgosto,'') AS mAgosto" +
										"		,ISNULL(mSeptiembre,'') AS mSeptiembre" +
										"		,ISNULL(mOctubre,'') AS mOctubre" +
										"		,ISNULL(mNoviembre,'') AS mNoviembre" +
										"		,ISNULL(mDiciembre,'') AS mDiciembre" +
										" FROM tAnteProyectoAUTCalendario with(nolock)" +
										" WHERE cClaveSiaff = " + sqlCLAVESIAFF + 
										" AND cClaveInterna = " + sqlCLAVEINTERNA+
										" ORDER BY nFolioAnteProyecto ASC";
	...
	public static List<AnteProyectoAutCalendario> callReporteAnteproyectoCalendarizadoParametros(Connection conn, String ejercicioFiscal, String ramoEP, String unidadResponsableEP, String grupoFuncional, String funcion, String subFuncion, String programaGeneral, String programaPresupuestario, String actividadInstitucional, String partida, String tipoGasto, String fuenteFinanciamiento, String entidadFederativa, String cartera, String unidadEjecutora, String unidadNormativa, String cOrderBy, String cGroupBy, String usuario, String filtro) throws SQLException {
		...
		try{
			...
			sqlAnteproyectoCal = "SELECT nConsecutivo" +
								"		,nFolioAnteProyectoAut" +
								"		,aEjercicioFiscal"	+
								"		,cUnidadResponsable" +
								"		,cClaveSiaff" +
								...
								"		,ISNULL(mDiciembre,'') AS mDiciembre" +
								" FROM tAnteProyectoAUTCalendario with(nolock)" +
								" WHERE cClaveSiaff IN " + subQueryCLAVESIAFF + 
								" AND cClaveInterna IN " + subQueryCLAVEINTERNA +
								" ORDER BY nFolioAnteProyecto ASC";
