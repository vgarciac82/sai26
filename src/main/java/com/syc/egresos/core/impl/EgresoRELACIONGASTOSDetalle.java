...
public class EgresoRELACIONGASTOSDetalle extends EgresoDetalle {
	...
	private static final Logger log = Logger.getLogger( EgresoRELACIONGASTOSDetalle.class );
	...
	public int insertaRenglon( Connection conn ) throws Exception {
		...
		try {
			int cnt = 1;
			log.trace( query );
			log.trace("[" + getEjercicioFiscal()+ "]" );
			log.trace("[" + getAlm()+ "]" );
			log.trace("[" + getAltaAlmacen()+ "]" );
			log.trace("[" + getCentroContable()+ "]" );
			log.trace("[" + getEjercicioFiscal()+ "]" );
			log.trace("[" + getEvento()+ "]" );
			log.trace("[" + getIdCuentaContable()+ "]" );
			log.trace("[" + getcIdEntidadContable()+ "]" );
			log.trace("[" + getcIdRelacion()+ "]" );
			log.trace("[" + getMesCalendario()+ "]" );
			log.trace("[" + getcTipoPoliza()+ "]" );
			log.trace("[" + getEp()+ "]" );
			log.trace("[" + getIdTipoConcepto()+ "]" );
			log.trace("[" + getIdTipoMovimiento()+ "]" );
			log.trace("[" + getImporte23IVA()+ "]" );
			log.trace("[" + getImporte2Millar()+ "]" );
			log.trace("[" + getImporte5Millar()+ "]" );
			log.trace("[" + getImporteAmortizacionAnticipo()+ "]" );
			log.trace("[" + getImporteBruto()+ "]" );
			log.trace("[" + getImporteCedular()+ "]" );
			log.trace("[" + getImporteCNIC()+ "]" );
			log.trace("[" + getImporteMasIva()+ "]" );
			log.trace("[" + getImporteDevolucion()+ "]" );
			log.trace("[" + getImporteFletes()+ "]" );
			log.trace("[" + getImporteIMDT()+ "]" );
			log.trace("[" + getImporte()+ "]" );
			log.trace("[" + getImporteAmortiza()+ "]" );
			log.trace("[" + getImporteBruto()+ "]" );
			log.trace("[" + getImporteFlete23()+ "]" );
			log.trace("[" + getImporteFlete4()+ "]" );
			log.trace("[" + getImporteHospedaje()+ "]" );
			log.trace("[" + getImporteISRLaudos()+ "]" );
			log.trace("[" + getImporteIva()+ "]" );
			log.trace("[" + getImporteIvaArrenda()+ "]" );
			log.trace("[" + getImporteIvaHonorarios()+ "]" );
			log.trace("[" + getImporteIvaProv()+ "]" );
			log.trace("[" + getImporteMasIva()+ "]" );
			log.trace("[" + getImporteImporteNegativo()+ "]" );
			log.trace("[" + getImporteNeto()+ "]" );
			log.trace("[" + getImporteObra()+ "]" );
			log.trace("[" + getImporteISRArrenda()+ "]" );
			log.trace("[" + getImporteISRHonorarios()+ "]" );
			log.trace("[" + getImporteISROtros()+ "]" );
			log.trace("[" + getImporteIVA()+ "]" );
			log.trace("[" + getImporteNeto()+ "]" );
			log.trace("[" + getImporteObra5()+ "]" );
			log.trace("[" + getImportePenalizacion()+ "]" );
			log.trace("[" + getImporteRetencion()+ "]" );
			log.trace("[" + getImporteRetImpuestoCedular()+ "]" );
			log.trace("[" + getImporteSancion()+ "]" );
			log.trace("[" + getImporteTesofe()+ "]" );
			log.trace("[" + getCapitulo()+ "]" );
			log.trace("[" + getNumeroRenglon()+ "]" );
			log.trace("[" + getFolioPoliza()+ "]" );
			log.trace("[" + getFolioRelacionGastos()+ "]" );
			log.trace("[" + getMesCalendario()+ "]" );
			log.trace("[" + getNumeroPoliza()+ "]" );
			log.trace("[" + getObgt()+ "]" );
			log.trace("[" + getRfc()+ "]" );
			log.trace("[" + getImporteISRResico()+ "]" );
