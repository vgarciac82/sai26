...
public class EgresoPAGOOBRADetalle extends EgresoDetalle {
    ...
    public int insertaRenglon(Connection conn) throws Exception {
        ...
        queryBuilder.append("    nFolioPAGOOBRA, ");
        /* 1 */
        queryBuilder.append("    nDocRenglon, ");
        /* 2 */
        queryBuilder.append("    nMes, ");
        /* 3 */
        queryBuilder.append("    cEjercicio, ");
        /* 4 */
        queryBuilder.append("    cIdEntidadContable, ");
        /* 5 */
        queryBuilder.append("    cIdRelacion, ");
        /* 6 */
        queryBuilder.append("    EP, ");
        /* 7 */
        queryBuilder.append("    cIdCuentaContable, ");
        /* 8 */
        queryBuilder.append("    mComprometido, ");
        /* 9 */
        queryBuilder.append("    nPoliza, ");
        /* 10 */
        queryBuilder.append("    ID_TIPO_MOVIMIENTO, ");
        /* 11 */
        queryBuilder.append("    ID_TIPO_CONCEPTO, ");
        /* 12 */
        queryBuilder.append("    cEvento, ");
        /* 13 */
        queryBuilder.append("    aEjercicioFiscal, ");
        /* 14 */
        queryBuilder.append("    cCentroContable, ");
        /* 15 */
        queryBuilder.append("    cMes, ");
        /* 16 */
        queryBuilder.append("    RFC, ");
        /* 17 */
        queryBuilder.append("    mImporteNeto, ");
        /* 18 */
        queryBuilder.append("    ALM, ");
        /* 19 */
        queryBuilder.append("    mImporteBruto, ");
        /* 20 */
        queryBuilder.append("    mImporteMasIva, ");
        /* 21 */
        queryBuilder.append("    mImporteIva, ");
        /* 22 */
        queryBuilder.append("    nCapitulo, ");
        /* 23 */
        queryBuilder.append("    cDocumentoHaplicado, ");
        /* 24 */
        queryBuilder.append("    nFolioPoliza, ");
        /* 25 */
        queryBuilder.append("    cTipoPoliza, ");
        /* 26 */
        queryBuilder.append("    mSancion, ");
        /* 27 */
        queryBuilder.append("    mDevolucion, ");
        /* 28 */
        queryBuilder.append("    mImporteAmortiza, ");
        /* 29 */
        queryBuilder.append("    mRetencion, ");
        /* 30 */
        queryBuilder.append("    mPenalizacion, ");
        /* 31 */
        queryBuilder.append("    m2Millar, ");
        /* 32 */
        queryBuilder.append("    m23IVA, ");
        /* 33 */
        queryBuilder.append("    mISRHonorarios, ");
        /* 34 */
        queryBuilder.append("    mObra5, ");
        /* 35 */
        queryBuilder.append("    mImporteFlete4, ");
        /* 36 */
        queryBuilder.append("    mISRArrenda, ");
        /* 37 */
        queryBuilder.append("    mRetImpuestoCedular, ");
        /* 38 */
        queryBuilder.append("    mBruto, ");
        /* 39 */
        queryBuilder.append("    mAmortizacionAnticipo, ");
        /* 40 */
        queryBuilder.append("    mIVA, ");
        /* 41 */
        queryBuilder.append("    mNeto, ");
        /* 42 */
        queryBuilder.append("    m5Millar, ");
        /* 43 */
        queryBuilder.append("    mFletes, ");
        /* 44 */
        queryBuilder.append("    mCedular, ");
        /* 45 */
        queryBuilder.append("    mImporte, ");
        /* 46 */
        queryBuilder.append("    mImporteIvaArrenda, ");
        /* 47 */
        queryBuilder.append("    mImporteIvaHonorarios, ");
        /* 48 */
        queryBuilder.append("    mImporteFlete23, ");
        /* 49 */
        queryBuilder.append("    mImporteIvaProv, ");
        /* 50 */
        queryBuilder.append("    mImporteObra, ");
        /* 51 */
        queryBuilder.append("    mCNIC, ");
        /* 52 */
        queryBuilder.append("    mIMDT, ");
        /* 53 */
        queryBuilder.append("    mTesofe, ");
        /* 54 */
        queryBuilder.append("    altaAlmacen, ");
        /* 55 */
        queryBuilder.append("    Periodo13, ");
        /* 56 */
        queryBuilder.append("    ADEFAS, ");
        /* 57 */
        queryBuilder.append("    OBGT, ");
        /* 58 */
        queryBuilder.append("    mImporteISRLaudos, ");
        /* 59 */
        queryBuilder.append("    mImporteNegativo, ");
        /* 60 */
        queryBuilder.append("    mISROtros, ");
        /* 61 */
        queryBuilder.append("    mImporteIva6");
        /* 62 */
        queryBuilder.append(") ");
        ...
        try {
            ...
            /* 4: cEjercicio */
            ps.setString(i++, getcIdEntidadContable());
            ...
            /* 23: nCapitulo */
            ps.setString(i++, getDocumentoAplicado());
            /* 24: cDocumentoHaplicado */
            ps.setInt(i++, getFolioPoliza());
            /* 25: nFolioPoliza */
            ps.setString(i++, getcTipoPoliza());
            /* 26: cTipoPoliza */
