...
public class EgresoPAGOFEDERALIZADOEncabezado extends EgresoEncabezado {
    ...
    private static final Logger log = LoggerFactory.getLogger(EgresoPAGOFEDERALIZADOEncabezado.class);
...

    {
        ...
        //aEjercicioFiscal
        queryIns.append("		?,");
        //mAmortizacionAcumulado
        queryIns.append("		?,");
        //mImporteSancionAcumulado
        queryIns.append("		?,");
        //mImporteDevolucionAcumulado
        queryIns.append("		?,");
        //cTipoPoliza
        queryIns.append("		?,");
        //NumPagoAMF
