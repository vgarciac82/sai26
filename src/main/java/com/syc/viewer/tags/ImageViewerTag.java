...
public class ImageViewerTag extends TagSupport implements ViewerParametersInterface {
    ...
    private static final Logger log = LoggerFactory.getLogger(ImageViewerTag.class);
    ...
    public int doEndTag() throws JspException {
        ...
        try {
            ...
            out.print("<img id=\"" + getId() + "\" src=\"" + request.getContextPath() + "/imagestore/" + newFileName + "?" + getParam() + "=" + selectId + "&" + INDEX_KEY + "=" + fileIndex + "\" width=\"" + widthSize + "\" height=\"" + heightSize + "\" alt=\"Tamaño " + widthSize + " x " + heightSize + "\">");
