...
public class ImageViewerServlet extends HttpServlet implements ViewerParametersInterface {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<frame name=\"viewerFrame\" src=\"VisualizadorDeImagen.jsp" + queryString.toString()
				+ "\" scrolling=\"no\" noresize>");
		out.println("<frame name=\"listFrame\" src=\"ListaDeImagenes.jsp?select=" + treeNodeId + "&" + INDEX_MAX + "="
				+ maxIndx + "\" scrolling=\"no\" noresize>");
