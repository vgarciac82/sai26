...
public class ReintegroContBussinesLogic extends DataSourceManager {
	...
	private static Logger	log	= Logger.getLogger(ReintegroContBussinesLogic.class);
				...
				if (acr.isSuccess()) {
					...
					if("2013".equals(year))
						...
						+ "Mismo que ya se encuentra con estatus de autorizado en el SAI con el No. "+c.getFolio()+", " +
							...
							+	"-       Memorando dirigido  al Lic. Sergio Ramirez Rosales, indicando Ejercicio, Clc y Clave Presupuestal del reintegro<br>"
