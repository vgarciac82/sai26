...
public class ContratoArt25 {
	...
	public String getfFechaFallo() {
		return fFechaFallo;
	}
	
	public void setfFechaFallo( String fFechaFallo ) {
		this.fFechaFallo = fFechaFallo;
	}
	...
	public String getcNumProcedCET() {
		return cNumProcedCET;
	}
	
	public void setcNumProcedCET( String cNumProcedCET ) {
		this.cNumProcedCET = cNumProcedCET;
	}
	...
	public double getmMontoBruto() {
		return mMontoBruto;
	}
	
	public void setmMontoBruto( double mMontoBruto ) {
		this.mMontoBruto = mMontoBruto;
	}
