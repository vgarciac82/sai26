			...
			try{
				...
				if(centralizado.toUpperCase().equals("DESCENTRALIZADO")){
					for(int i=0; i<centrosContables.length; i++){
						...
						cmst.setString(2, cEjercicio);//@cEjercicio
						cmst.setString(3, cIdDocumentoDefinitivo);//@cIdDocumentoDefinitivo
						cmst.setString(4, tem[1]);//@centroContable
						cmst.setString(5, ramo);//@ramo
						cmst.setString(6, tem[0]);//@cIdUnidadEjecutora
						cmst.setInt(7, folio);//@cFolio
						cmst.setInt(8, consecutivoModificacion);//@nConsecutivoMod
						cmst.setString(9, centralizado);//@CENT
						cmst.setString(10, numCompromisos[i]);//@caNoCompromiso
						cmst.setString(11, tipo);//@tipo
						cmst.setString(12, folioCaso);//@folio Caso
						cmst.execute();
					...
					cmst.setString(2, cEjercicio);//@cEjercicio
					cmst.setString(3, cIdDocumentoDefinitivo);//@cIdDocumentoDefinitivo
					cmst.setString(4, request.getParameter("centrosContables"));//@centroContable
					cmst.setString(5, ramo);//@ramo
					cmst.setString(6, uE);//@cIdUnidadEjecutora
					cmst.setInt(7, folio);//@cFolio
					cmst.setInt(8, consecutivoModificacion);//@nConsecutivoMod
					cmst.setString(9, centralizado);//@CENT
					cmst.setString(10, request.getParameter("numCompromisos"));//@caNoCompromiso
					cmst.setString(11, tipo);//@tipo
					cmst.setString(12, folioCaso);//@folio Caso
					cmst.execute();		
					outputValue = cmst.getInt(1);
