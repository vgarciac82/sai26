...
public class ContratacionFormalizadaServlet extends HttpServlet {
	...
	private static Logger log = Logger.getLogger(ContratacionFormalizadaServlet.class);
		...
		try {
			...
			switch(tipoOperacion){
				...
				case 3: //Guardar
					...
					break;
				case 4://pestaña Libera garantas
		...
		try {
			...
			switch(tipoOperacion){
				case 1: //Pestaña consulta
					...
					respuesta=true;
					break;
				case 2: //Consulta de datos migrados.
				...
				case 3://Add EP
					...
					break;
				case 4:// Pestaña presupuesto, Aprobar contrato
	...
	protected void conveniosContratosCap4(HttpServletRequest request, HttpServletResponse response, Usuario usuario,HttpSession session) throws UnsupportedEncodingException {
		...
		try {
			...
			out = response.getWriter();
			switch(tipoOperacion){
				case 1: //Consulta Datos nuevo convenio
					jsonObj=business.queryDataNewConvCap4();
					break;
				case 2: //Genera nuevo convenio cap4
					...
					break;
				case 3: //Consulta Datos  convenio
					jsonObj=business.queryDataConvCap4();
					break;
				case 4: //caratula Datos  convenio
					conv=fillObjectConvenioCap4( request, usuario );
				...
				case 9://Precomprometer
					...
					respuesta=true;
					break;
				case 10://devuelve el Precompromiso
					conv=fillObjectConvenioCap4( request, usuario );
	...
	protected void contratos(HttpServletRequest request, HttpServletResponse response, Usuario usuario,HttpSession session) throws UnsupportedEncodingException {
		...
		try {
			...
			cont=new Contrato();
			switch(tipoOperacion){
				case 1: //obtiene datos de los selects 
					...
					respuesta=true;
					break;
				case 2: //obtiene datos de los selects Nuevo Procedimiento
				...
				case 4://Guarda datos PSP
					...
					jsonObj=new JSONObject();
					break;
				case 5://Aprueba Contrato Art 25 LAASSP
					cont=fillContrato( request, response );
