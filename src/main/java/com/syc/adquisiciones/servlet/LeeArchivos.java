		...
		try {
			...
			switch (datosArchivo.getnOperacion()) {
				...
				case 2://Carga contrato fisico
					...
					isCorrect=resp.isResp();
					break;
				case 3://carga de archivo para los contratos de terminación anticipada.
					...
					isCorrect=resp.isResp();
					break;
				case 4://Lee retorno de apartado
				...
				case 5://Recisión de contratos
					...
					isCorrect=resp.isResp();
					break;
				case 6://Carga de contratos del CAAS
					...
					break;
				case 7://Carga layout de presupuesto para requisiciones
