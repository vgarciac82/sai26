...
public class DatosEP_TMP {
    ...
    private String cIdClaveEgresos;
    ...
    public String getcIdClaveEgresos() {
        return cIdClaveEgresos;
    }

    public void setcIdClaveEgresos(String cIdClaveEgresos) {
        this.cIdClaveEgresos = cIdClaveEgresos;
    }
