...
public class DatosRequisicion {
    ...
    private String cidTipoSolicitud;
    ...
    public String getCidTipoSolicitud() {
        return cidTipoSolicitud;
    }

    public void setCidTipoSolicitud(String cidTipoSolicitud) {
        this.cidTipoSolicitud = cidTipoSolicitud;
    }
}
