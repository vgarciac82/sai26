...
public class ComparativaBusinessLogic extends DataSourceManager {
	...
	private static Logger log = Logger.getLogger(ComparativaBusinessLogic.class);
		...
		try {
			...
			PartidasComparativaList= ComparativaManager.callLista(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo);
			 if ( PartidasComparativaList.isEmpty()) {
					tabla = "<tr class=\"alternateRow\">"
							+ "	<td colspan=\"4\"><i>No hay informaci&oacute;n para mostrar</i></td>"
							+ "</tr>";
					//sb.append(tr);
				} else {
				 row++;
					...
					ProveedorComparativaList= ComparativaManager.callProveedor(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo);
						if (ProveedorComparativaList.isEmpty()) {
							...
							encabezado+="</tr>";
							encabezadoDesierta="<tr><td colspan="+col+" align='center' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'></td></tr>" +
											   "<tr><td colspan="+col+" align='center' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'>Partidas Desiertas</td></tr>";
							encabezadoCotizadas="<tr><td colspan="+col+" align='center' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'></td></tr>" +
												"<tr><td colspan="+col+" align='center' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'>Partidas Cotizadas</td></tr>";
							encabezadoNoAdjudica="<tr><td colspan="+col+" align='center' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'></td></tr>" +
												"<tr><td colspan="+col+" align='center' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'>Partidas No adjudicadas</td></tr>";
						}
						...
						if (ProveedorComparativaList.isEmpty()) {
							...
							//	tabla+=Partida;
								...
								for(int i=0;i<ProveedorComparativaList.size();i++){
									rProveedorComparativa = null;
									rProveedorComparativa =(ProcedimientoComparativa)ProveedorComparativaList.get(i);
									Partida+="<td >Cantidad</td>" +//style='border-right:0.1pt solid black;border-bottom:0.1pt solid black'
											"<td>Precio Unitario</td>" +
											"<td>Tipo de Cambio</td>" +
											"<td style='border-right:1.0pt solid black'>Total</td>";
								}
								Partida+="</tr><tr>";
								float montoUnit=0;
								...
								for(int i=0;i<ProveedorComparativaList2.size();i++){
									...
									partidaDesierta=rProveedorComparativa.getNumRfc(); /// partida desierta =0 partida activa=1
									montoUnit=rProveedorComparativa.getmontoMinimo();// style='border-right:1.0pt solid black;border-bottom:1.0pt solid black;'
			...
			if (procedimientoList.isEmpty()) {
				tr = "<tr>"
						+ "	<td colspan=\"4\"><i>No hay procedimiento</i></td>"
						+ "</tr>";
				sb.append(tr);
			} else {
				...
				for(int i=0;i<procedimientoList.size();i++){
					...
					tr+="<tr><td colspan='2'>"+rProcedimiento.getcCategoria() +"</td>" +
					   	"<td td colspan='2'>S.C. : VARIAS</td>" ;
			 ...
			 if ( proveedorList.isEmpty()) {
					tr = "<tr class=\"alternateRow\">"
							+ "	<td colspan=\"4\"><i>No hay proveedor</i></td>"
							+ "</tr>";
				//	sb.append(tr);
				} else {
					...
					//tr+="</tr>";
					tr+="</tr><tr>" +
					"<td colspan='2'>VIGENCIA DE LA COTIZACIÓN:</td>";
					for(int i=0;i<proveedorList.size();i++){
						rProvedor = null;
						rProvedor =(ProcedimientoComparativa)proveedorList.get(i) ;
					...
					tr+="</tr><tr>" +
					"<td colspan='2' style='border-bottom:1.0pt solid black'>FECHA DE SU COTIZACIÓN:</td>";
					for(int i=0;i<proveedorList.size();i++){
						rProvedor = null;
						rProvedor =(ProcedimientoComparativa)proveedorList.get(i) ;
					...
					tr+="<tr>" +
					"<td rowspan=2 style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>PART.</td>" +
					"<td rowspan=2 style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>DESCRIPCION DE LOS BIENES O SERVICIOS</td>" +
					"<td rowspan=2 style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>CANTIDAD</td>" +
					"<td rowspan=2 style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>UNIDAD</td>";
					...
					for (Iterator<?> iter1 =  proveedorList.iterator(); iter1.hasNext();) {
						rProvedor =(ProcedimientoComparativa) iter1.next();
						tr+="<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>Lugar ocupado</td>" +
								"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>Cumple E.T.</td>" +
								"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>Unitario</td>" +
								"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>Total</td>";
					}
			...
			lineasList= ComparativaManager.callLista(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo);
					...
					for (Iterator<?> iter =  lineasList.iterator(); iter.hasNext();) {
						...
						partidas = ComparativaManager.callComparativa(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo, linea, " where mMontoMinimo<>0.00  order by ganadorSug");
							...
							for (Iterator<?> iter1 =  partidas.iterator(); iter1.hasNext(); row++) {
								 ...
								 mMin=tCambio*mMin;//rComparativa.getmontoMinimoTexto()
								 total=cant*mMin;
							...
							for (Iterator<?> iter1 =  partidasList.iterator(); iter1.hasNext(); row++) {
								 ...
								 ganador=rComparativa.getGanador();
									 if (ganador==1){
										 tr+="<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black;background:#00FF00'>"+ rComparativa.getcganadorSug()+"°/"+lugarPrecio+"°</td>" +
											"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black;background:#00FF00'>"+ rComparativa.getEvaluacionTecnica()+"</td>" +
											"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black;background:#00FF00'>"+rComparativa.getmontoMinimoTexto() +"</td>" +
											"<td  style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black;background:#00FF00'>$"+total+"</td>";
									 }else{
										 tr+="<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>"+ rComparativa.getcganadorSug()+"°/"+lugarPrecio+"°</td>" +
											"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>"+ rComparativa.getEvaluacionTecnica()+"</td>" +
											"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>"+rComparativa.getmontoMinimoTexto() +"</td>" +
											"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black'>$"+total+"</td>";
									 }
			 ...
			 float tot=0;
			 float total1=0;
			 tr+="<tr><td colspan='2' style='border-left:1.0pt solid black;border-top:1.0pt solid black'>Acotaciones</td>" +
				"<td colspan='2' style='border-right:1.0pt solid black;border-top:1.0pt solid black'>Subtotal</td>";
			 ...
			 for(int i=0;i<rfcList.size();i++){
					...
					tr+="<td colspan='3' style='border-top:1.0pt solid black;border-right:1.0pt solid black'>&nbsp;</td>" +
						"<td style='border-top:1.0pt solid black;border-right:1.0pt solid black'>$"+new BigDecimal(tot).setScale(2,BigDecimal.ROUND_UP)+"</td>";
				}
			 tr+="</tr>";
			 float iva=0;
			 float ivat=0;
			 ...
			 ivat=(float) (iva/0.01);
			 tr+="<tr><td colspan='2' style='border-left:1.0pt solid black'></td>" +
		 	 "<td colspan='2' style='border-right:1.0pt solid black'>+"+ivat+"% DEL IVA</td>" ;
			 for(int i=0;i<rfcList.size();i++){
					rfc=rfcList.get(i).toString();
					montoList=ComparativaManager.callMontosTotales(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo, rfc);
					tot=Float.parseFloat(montoList.get(0).toString());
					...
					totalIVA=tot*iva;
					tr+="<td colspan='3'>&nbsp;</td>" +
						"<td style='border-left:1.0pt solid black;border-right:1.0pt solid black' >$"+new BigDecimal(totalIVA).setScale(2,BigDecimal.ROUND_UP)+"</td>";
			}
			 tr+="</tr>";
			 tr+="<tr><td colspan='2' style='border-left:1.0pt solid black;border-bottom:1.0pt solid black'></td>" +
			 		"<td colspan='2' style='border-right:1.0pt solid black;border-bottom:1.0pt solid black'>Total Neto</td>" ;
			 for(int i=0;i<rfcList.size();i++){
					rfc=rfcList.get(i).toString();
					montoList=ComparativaManager.callMontosTotales(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo, rfc);
					tot=Float.parseFloat(montoList.get(0).toString());
					...
					tr+="<td colspan='3' style='border-bottom:1.0pt solid black;border-right:1.0pt solid black'>&nbsp;</td>" +
						"<td style='border-bottom:1.0pt solid black;border-right:1.0pt solid black'>$"+new BigDecimal(totalneto).setScale(2,BigDecimal.ROUND_UP)+"</td>";
			}
			tr+="</tr>";
			...
			if(firmantesList.isEmpty()) {
					tr = "<tr class=\"alternateRow\">"
					+ "	<td colspan=\"4\"><i>No hay informaci&oacute;n Partida</i></td>"
					+ "</tr>";
					sb.append(tr);
			}else{
					rFirmante=(ProcedimientoComparativa) firmantesList.get(0);
							 tr+="<tr><td rowspan='8' colspan='8' style='border-right:1.0pt solid black;border-bottom:1.0pt solid black'></td>" +
							 		 "<td colspan='4' style='border-right:1.0pt solid black'> Elaboro</td></tr>" +
							     "<tr><td colspan='4' style='border-right:1.0pt solid black'></td></tr>"+
							     "<tr><td colspan='4' style='border-right:1.0pt solid black'>_________________________________</td></tr>"+
							 	 "<tr><td colspan='4' style='border-right:1.0pt solid black'>"+rFirmante.getcFirmante()+"</td></tr>" +
							 	 "<tr><td colspan='4' style='border-right:1.0pt solid black'>Aprobo</td></tr>";
							 tr+="<tr><td colspan='4' style='border-right:1.0pt solid black'></td></tr>" +
							 	 "<tr><td colspan='4' style='border-right:1.0pt solid black'>_________________________________</td></tr>";
			...
			PartidasComparativaList= ComparativaManager.callLista(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo);
			 if ( PartidasComparativaList.isEmpty()) {
				 obsPartidas = "<tr class=\"alternateRow\">"
							+ "	<td colspan=\"4\"><i>No hay informaci&oacute;n para mostrar</i></td>"
							+ "</tr>";
					//sb.append(tr);
				} else {
				 row++;//class="+((row % 2) == 0 ? "AlternateRow": "NormalRow")+ 
				 obsPartidas="<tr>" +
				 			 "<td colspan='4' style='border-top:1.0pt solid black;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'>Partida/Proveedor</td></tr>" ;
				 for (Iterator<?> iter =  PartidasComparativaList.iterator(); iter.hasNext();) {
					rProveedorComparativa =(ProcedimientoComparativa) iter.next();
					int linea1=0;
	...
	//				int total=ProveedorComparativaList.size();
						...
						PartidaOrdenadaList= ComparativaManager.callPartidaOrdenado(conn, cEjercicio, cIdTipoProcedimiento, cIdUnidadEjecutora, nIdConsecutivo,linea1);
							if (PartidaOrdenadaList.isEmpty()) {
								...
								for (Iterator<?> iter1 =  PartidaOrdenadaList.iterator(); iter1.hasNext();) {
									rPartidaOrdenada =(ProcedimientoComparativa) iter1.next();
									obsPartidas+="<tr>" +
													"<td style='border-right:1.0pt solid black;border-bottom:1.0pt solid black'>"+rPartidaOrdenada.getLineaConsolidado()+"</td>";
			 ...
			 obs="<table>"+obs+"</table>";
			 String partidasObservaciones="<table><tr><td colspan='4'></td><td colspan="+numObs+"></td></tr>" +
			 		"<tr><td colspan='4'></td><td colspan="+numObs+">Observaciones</td></tr>" +
			 		"<tr><td colspan='4'>"+obsPartidas+"</td><td colspan="+numObs+">"+obs+"</td></tr></table>";
			/* tabla=encabezadoCotizadas+tablaCotizadas;
			 tabla+=encabezadoNoAdjudica+tablaNoAdjudica;
			 tabla+=encabezadoDesierta+tablaDesierta;*/
