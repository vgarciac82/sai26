...
public class PedidoModLinea {
		...
		if (idlineaconsm == 0) {
			if (original.size() == 1){
				...
				for (PedidoModLinea lineao : original){
					if (partidaInicial.equals("")) partidaInicial = lineao.getPartida();
					else partidaFinal = lineao.getPartida();
	...
	public String toString(){
		String value = "";
		if (this.nIdLineaConsolidado != null) value += this.nIdLineaConsolidado;
		if (this.tipo != null) value += "-" + this.tipo;
		if (this.partida != null) value += "-" + this.partida;
		if (this.descripcion != null) value += "-" + this.descripcion;
		if (this.cantidad != null) value += "-" + this.cantidad;
		if (this.unidad != null) value += "-" + this.unidad;
		if (this.precioUN != null) value += "-" + this.precioUN;
		if (this.precioTN != null) value += "-" + this.precioTN;
		return value;
	}
}
