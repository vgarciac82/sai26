...
public class SubirArchivosCadenasPServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(pathBase + "Generador/SubirArchivoCadenasP.jsp?mensaje=" + mensaje);
    }
    ...
    public String enviaRuta(InputStream in, String tipoArchivo) throws FileNotFoundException {
        // Si es true se agrega para ejecutar
            ...
            while ((sCadenas = br.readLine()) != null) {
                ...
                if (subirInformacion) {
                    ...
                    if (tipoArchivo.equals("ERRORES")) {
                        ...
                        guardaLinea = guardaSicop.insertaLineaSiaff(RFC_0, caNoContrarrecibo_1, fEmision_2, fVencimiento_3, FIJO_01_4, FIJO_1_5, FIJO_N_6, tipoPago_7, cCentroContable_8, dato1_9, dato2_10, dato3_11, dato4_12, dato5_13, dato6_14);
                        ...
                        // Archivo SICOP
                        if (primerLinea == 1) {
                            if (!celdas[0].trim().equals("Nombre del proveedor")) {
                                guardaLinea = "Nombre del proveedor";
                                break;
                            }
                            if (!celdas[1].trim().equals("Número del documento")) {
                            ...
                            if (!celdas[4].trim().equals("Fecha de Vencimiento")) {
                            ...
                            if (!celdas[8].trim().equals("Intermediario Financiero")) {
                            ...
                            if (!celdas[15].trim().equals("Número de Proveedor")) {
                            ...
                            if (!celdas[18].trim().equals("Porcentaje de Descuento")) {
                            ...
                            if (!celdas[20].trim().equals("Digito Identificador")) {
                                guardaLinea = "Digito Identificador";
                                break;
                            }
                            if (!celdas[21].trim().equals("Fecha de Recepción de Bienes y Servicios")) {
                                guardaLinea = "Fecha de Recepción de Bienes y Servicios";
                                break;
                            }
                            if (!celdas[22].trim().equals("Tipo de Compra (procedimiento)")) {
                                guardaLinea = "Tipo de Compra (procedimiento)";
                                break;
                            }
                            if (!celdas[23].trim().equals("Clasificador por Objeto del Gasto")) {
                            ...
                            guardaLinea = guardaSicop.insertaLineaSicop(cNombreProv_0, caNoContrarrecibo_1, nNumAcuse_2, fEmision_3, fVencimiento_4, cMoneda_5, mMonto_6, cEstatus_7, cIntermediarioF_8, nNumSolicitud_9, cCentroContable_10, cCampoAdi2_11, cCampoAdi3_12, cCampoAdi4_13, cCampoAdi5_14, RFC_15, cConcepto_16, nClaveEstatus_17, nPorcentajeDes_18, mMontoDesc_19, nNumIdentificador_20, fRecepcion_21, cTcompra_22, cClasificador_23, cPlazoMax_24);
                            if (guardaLinea.equals("no_guardado")) {
                                break;
                            }
