...
@WebServlet(name = "LayoutOperAjenaServlet", urlPatterns = { "/gstnmngr/LayoutOperAjenaServlet" })
public class LayoutOperAjenaServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String valor = "";
        try {
            CargaOperAjenaBussinessLogic guardaInformacion = new CargaOperAjenaBussinessLogic();
        ...
        //out.println(valor);
        response.sendRedirect(pathBase + "Generador/cargaOperAjena.jsp?mensaje=" + valor);
    }
