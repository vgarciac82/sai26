...
public class SubirArchivosBaseServlet extends HttpServlet {
	...
	public InputStream cargarArchivo(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			fu.setSizeThreshold(1048576); // Si excede el 1 Gb en memoria lo escribe a disco.
	...
	public String enviaRuta(InputStream in, String tipoArchivo)
		...
		boolean subirInformacion = false; // Si es true se agrega para ejecutar el procedimeinto y si es false es para insertar directamente en columna
				...
				if (subirInformacion) {
					...
					if (tipoArchivo.equals("SIAFF")) {
						...
						if (primerLinea == 1) {
							...
							String fechaPago = "";
							if(celdas.length >= 35){ fechaPago = celdas[34]; }
							String cuantos = String.valueOf(commitCien);
							guardaLinea = guardaSicop.insertaLineaSiaff(idRamoCrS, idUnidadCrS, tipoCLC, folioCLC,folioDependendia, estatusCLC, proceso,
									fechaCaptura, fechaAplicacion,aplicacionContable, usuarioCaptura,aprobRevisor,usuarioRevisor,
									fechaRevision, aprobAutorizador,usuarioAutorizador,fechaAutorizacion,numeroAMF,leyenda,descLeyenda,
									referencia1,referencia2,folioAMF,noOfAMF, fechaReferencia1,divisa,totalDivisa,tipoCambio,totalMN,
									claveBeneficiario,beneficiario,ctaBancaria, fechaPropuesta, medioPago,fechaPago,cuantos);
						...
						if (primerLinea == 1) {
							...
							guardaLinea = guardaSicop.insertaLineaSicop(hojaVisor,idRamoCr,idUnidadCr,folioClc45,fechaExp,FechaApl,TTRANS34,
									TSOL35,TPPTO36,TMON37,TCAM38,Volante39,FechaOficio42,NCLC43,CPAG44,Estimacion46,NCTR47,SOLP48,TIPOMOVTO_51,
									NoPoliza56,NoPolizaCancela57,TipoPoliza58,FechaIni59,FechaFin60,TipoCLC67,CVELeyenda68,Bene69,CTAB70,
									RFC6,ApepatApematNombre,Replace,TDOC71,Descripcion100092,Negociable97,CIFI98,CTIF99,NACU100,FechaNego101,NacuCP102,
									Total103,TotalDivisa104,FechaRef105,FechaPago106,Referencia1108,Referencia2109,FolioSiaff112,
									FechaSiaff113,CCCTRERROR116,CentroContable,DSUFPRE172,AOT173,Pagado175,RFC184,Estatus,PRCSClave,
									ProcClave,IdUsuarioCancela,FechaCancela,IdUsuarioAplica,IdUsuarioCR,IdRolCR,IdRenglon,IdEvento,Evento,IdRamoML,
									IdUnidadML,NCOM15,CBEN16,NRES17,NOIF18,ISR20,Iva21,MIL522,IvaDes23,Anticipo24,IVAANT25,ImpRete26,ImpDivisa27,
									ImpEstim28, Imp500032, TCONC49, ConcMov50,FechaDocto75, ImpNeto107, CCMSGError115,TPAG117, ImpRema133, Importe148,
									Mes149,Cani150,CGFU151,CFun152,CSFU153,CPRG154,Cain155,CPPT156,Ccap157,Ccon158,CParg300,CPar159,CTGA160,
									CFin161, CGeo164, CPpi166, CCau162,CCop163, CPla165, OFin167, AUX1168,
									AUX2169, AUX3170, SPag176, PPag177,TNom178, COBG183, Tunr80);
							if (guardaLinea.equals("no_guardado")) {
								break;
							}
