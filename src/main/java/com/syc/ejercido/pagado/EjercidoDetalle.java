...
public class EjercidoDetalle {
    ...
    /**
     * @return the importeImporteFlete23
     */
    ...
    /**
     * @param importeImporteFlete23
     *            the importeImporteFlete23 to set
     */
    ...
    /**
     * @param importeISRLaudos
     *            the importeISRLaudos to set
     */
    ...
    public String toString() {
        return "EjercidoDetalle [ALM=" + ALM + ", altaAlmacen=" + altaAlmacen + ", capitulo=" + capitulo + ", centroContable=" + centroContable + ", cMes=" + cMes + ", CTAB=" + CTAB + ", docRenglon=" + docRenglon + ", ejercicioFiscal=" + ejercicioFiscal + ", EP=" + EP + ", evento=" + evento + ", folioEjercido=" + folioEjercido + ", folioPAGO=" + folioPAGO + ", folioPoliza=" + folioPoliza + ", idCuentaContable=" + idCuentaContable + ", idEntidadContable=" + idEntidadContable + ", idRelacion=" + idRelacion + ", idTipoConcepto=" + idTipoConcepto + ", idTipoMovimiento=" + idTipoMovimiento + ", importe=" + importe + ", importe23IVA=" + importe23IVA + ", importe2Millar=" + importe2Millar + ", importeAmortiza=" + importeAmortiza + ", importeBruto=" + importeBruto + ", importeCNIC=" + importeCNIC + ", importeComprometido=" + importeComprometido + ", importeDevolucion=" + importeDevolucion + ", importeFlete23=" + importeFlete23 + ", importeFlete4=" + importeFlete4 + ", importeIMDT=" + importeIMDT + ", importeISRArrenda=" + importeISRArrenda + ", importeISRHonorarios=" + importeISRHonorarios + ", importeIva=" + importeIva + ", importeIvaArrenda=" + importeIvaArrenda + ", importeIvaHonorarios=" + importeIvaHonorarios + ", importeIvaProv=" + importeIvaProv + ", importeMasIva=" + importeMasIva + ", importeNeto=" + importeNeto + ", importeObra=" + importeObra + ", importeObra5=" + importeObra5 + ", importePenalizacion=" + importePenalizacion + ", importeRetencion=" + importeRetencion + ", importeRetImpuestoCedular=" + importeRetImpuestoCedular + ", importeSancion=" + importeSancion + ", importeTesofe=" + importeTesofe + ", nMes=" + nMes + ", poliza=" + poliza + ", RFC=" + RFC + ", tipoPago=" + tipoPago + ", cUnidadResponsable=" + cUnidadResponsable + "]";
    }
}
