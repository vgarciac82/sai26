...
public class Anexo1Encabezado {
    ...
    public Date getfApliacion() {
        return fApliacion;
    }

    public void setfApliacion(Date fApliacion) {
        this.fApliacion = fApliacion;
    }
    ...
    public void setcaNoContrarrecibo(String cxp) {
        caNoContrarrecibo = cxp;
    }
    ...
    public String getcTipoAnexo() {
        return cTipoAnexo;
    }

    public void setcTipoAnexo(String cTipoAnexo) {
        this.cTipoAnexo = cTipoAnexo;
    }
    ...
    public String getcPuestoVo() {
        return cPuestoVo;
    }

    public void setcPuestoVo(String cPuestoVo) {
        this.cPuestoVo = cPuestoVo;
    }
    ...
    public String getcPuestoA() {
        return cPuestoA;
    }

    public void setcPuestoA(String cPuestoA) {
        this.cPuestoA = cPuestoA;
    }
}
