...
public class CLCAttachmentLogManager {
	...
	public static final Logger log = Logger.getLogger(CLCAttachmentLogManager.class);
	...
	public static int insertLogCLC( Connection conn, String nombreArchivo, int clc, String caNoContraRecibo, int folioPago, String tipoPago, char estatusPago, String log, String proceso, String cIDProceso ) throws Exception{
		String  query = "INSERT INTO tLogAdjuntaCLC"
									+"( fProceso, " 
									+"  nombreArchivo, "
									+"  noCLC, "
									+"  caNoContraRecibo, "
									...
									+"  cEstatusAdjunto, "
									+"  cLogOperacion "
									+ ( StringUtils.isEmpty(proceso) ? "": ", cProceso"  )
									+ ( StringUtils.isEmpty(cIDProceso) ? "": ", cIDProceso"  )
									+")"
									+"VALUES  ( GETDATE() ,"
									+"          ? ,"
									+"          ? ,"
									...
									+"          ? ,"
									+"          ?"
									+ ( StringUtils.isEmpty(proceso) ? "" : ", ?"  )
									+ ( StringUtils.isEmpty(cIDProceso) ? "" : ", ?"  )
									+"        )";
