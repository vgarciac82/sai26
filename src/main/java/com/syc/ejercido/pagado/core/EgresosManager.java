...
public class EgresosManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(EgresosManager.class);
    ...
    public static void actualizaInformacionEmpleados(Connection conn, String document, String nFolio, String headerTable, String detailTable, String field, String usuarioCaptura, String usuarioVoBo, String usuarioAutoriza) throws Exception {
        ...
        try {
            ...
            log.debug("Object: " + String.valueOf("Se actualizaron " + afectados + " registros con los firmantes Captura: " + usuarioCaptura + " VoBo " + usuarioVoBo + " Autoriza " + usuarioAutoriza + " Para el tramite " + headerTable + " con Folio " + nFolio));
        } finally {
