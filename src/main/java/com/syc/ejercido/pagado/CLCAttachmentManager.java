...
public class CLCAttachmentManager {
	...
	private static final Logger	log				= Logger.getLogger(CLCAttachmentManager.class);
	...
	public static int attachCLC(Connection conn, boolean ignorarExistentes, String clcFilePath, CallableStatement csBuscaCLC, CallableStatement csBuscaGabinete, PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder, PreparedStatement psNexIDFolder,
		PreparedStatement psSearchFolder, PreparedStatement psSearchVolumenUnit, PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, ProcesoAdjunta pa) throws Exception {
	...
	public static int attachFactura(Connection conn, boolean ignorarExistentes, String clcFilePath, CallableStatement csBuscaGabinete, PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder, PreparedStatement psNexIDFolder,
			PreparedStatement psSearchFolder, PreparedStatement psSearchVolumenUnit, PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, ProcesoAdjunta pa) throws Exception {
	...
	public static int attchToExpedient(PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder, PreparedStatement psNexIDFolder, PreparedStatement psSearchFolder, String tituloAplicacion, int idGabinete, String clcPathFile, PreparedStatement psSearchVolumenUnit,
		PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, Connection conn, String nombreCarpeta ) throws Exception{
	...
	public static int attchToExpedient(PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder, PreparedStatement psNexIDFolder, PreparedStatement psSearchFolder, String tituloAplicacion, int idGabinete, String clcPathFile, PreparedStatement psSearchVolumenUnit,
		PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, Connection conn, String nombreCarpeta, String nombreDocumento) throws Exception {
	...
	public static final void insertaDocumento(Connection conn, String tituloAplicacion, int idGabinete, int idCarpeta, String nombreDocumento, String ext, String nombreUsuario, String archivo, PreparedStatement psSearchVolumenUnit, PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, boolean eliminaTemporal)
		throws Exception {
	...
	public static List<AttachResult> attachComprobanteBancario(Connection conn, String centroContable, boolean ignorarExistentes, String cbFilePath, CallableStatement csBuscaCxP, CallableStatement csBuscaGabinete, PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder,
		PreparedStatement psNexIDFolder, PreparedStatement psSearchFolder, PreparedStatement psSearchVolumenUnit, PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, String cTipoPago) throws Exception {
		int procesados = 0;
	...
	public static List<AttachResult> attachComprobanteBancarioSNP( Connection conn, String centroContable, boolean ignorarExistentes, String cbFilePath, PreparedStatement csBuscaCxP, PreparedStatement csBuscaGabinete, PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder,
		PreparedStatement psNexIDFolder, PreparedStatement psSearchFolder, PreparedStatement psSearchVolumenUnit, PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, ProcesoAdjunta procesoAdjunta) throws Exception {
		int procesados = 0;
	...
	public static List<AttachResult> attachDocumentoSNP( Connection conn, String centroContable, boolean ignorarExistentes, String cbFilePath, PreparedStatement csBuscaCxP, PreparedStatement csBuscaGabinete, PreparedStatement psInsertFolderHierarchy, PreparedStatement psInsertFolder,
		PreparedStatement psNexIDFolder, PreparedStatement psSearchFolder, PreparedStatement psSearchVolumenUnit, PreparedStatement psSearchVolumen, PreparedStatement psSearchVolPath, ProcesoAdjunta procesoAdjunta, String nombreCarpeta, String nombreDocumento) throws Exception {
		int procesados = 0;
