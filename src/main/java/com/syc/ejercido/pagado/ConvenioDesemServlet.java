...
@WebServlet(name = "ConvenioDesemServlet", urlPatterns = { "/gstnmngr/ConvenioDesemServlet" })
public class ConvenioDesemServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ConvenioCarga Carga = new ConvenioCarga();
