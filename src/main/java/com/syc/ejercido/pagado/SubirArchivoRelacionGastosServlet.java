...
@WebServlet(name = "SubirArchivoRelacionGastosServlet", urlPatterns = { "/gstnmngr/SubirArchivoRelacionGastosServlet" })
public class SubirArchivoRelacionGastosServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // 1=Becas, 2=Alimentacion a Brigadistas, 3=Certificado de Transito.
            String sTipoCarga = fieldMap.get("tipoCarga");
