...
public class ComprobacionLaudosManager {
    ...
    public static int insertaInformacionLaudos(Connection conn, ComprobacionLaudos comprobacion) throws Exception {
        String query = "INSERT INTO tComprobacionLaudos " + "         ( nFolioRELACIONGASTOS , " + "           nFolioCaja , " + "           mImporteCaja , " + "           mImporteRet , " + "           mImporteNeto , " + "           cRetSICOP , " + "           cEsDevengado , " + "           cEsLiquidacion " + "          ) " + "           VALUES  ( ?, " + "                     ?, " + "                     ?, " + "                     ?, " + "                     ?, " + "                     ?, " + "                     ?, " + "                     ?)";
