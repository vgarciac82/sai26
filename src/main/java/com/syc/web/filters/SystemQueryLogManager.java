...
public class SystemQueryLogManager {
    ...
    public static void insertLog(Connection conn, SystemQueryLog sql) throws Exception {
        ...
        String query = "INSERT INTO tloghttprequest(curi, ccontenttype, clocaladdr, cmethod, cpathinfo, " + "							cpathtranslated, cprotocol, cquerystring, cremoteaddr, " + "							cremotehost, nremoteport,  cremoteuser, crequestedsessionid, " + "							cscheme, cservername, cservletpath, ncontentlength, clocale, " + "							nlocalport, nsystemtime)" + "VALUES     (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ) ";
        try {
