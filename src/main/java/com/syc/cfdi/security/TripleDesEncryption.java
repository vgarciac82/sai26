...
public class TripleDesEncryption {
     ...
     */
    public static byte[] encrypt(SecretKey key, String data) throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, BadPaddingException, IllegalBlockSizeException {
