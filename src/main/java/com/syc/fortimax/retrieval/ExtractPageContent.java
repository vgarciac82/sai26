...
public class ExtractPageContent extends Thread {
	...
	private static Logger log = Logger.getLogger(ExtractPageContent.class);
	...
	public ExtractPageContent(Caso c,
							  Documento d,
							  Pagina p,
							  String OCRProgramPath,
							  String OCRInFileName,
		...
		try{
			...
			if (pagina != null) {
				...
				if (pagina.getProcesado()!='1') {
					PaginaIndexManager pim = new PaginaIndexManager(this.OCR_PROGRAM_PATH, 
																	this.OCR_PARAMETER1, 
																	this.OCR_PARAMETER2, 
																	this.LUCENE_DB_PATH, 
																	this.LUCENE_STOPWORDS_PATH, 
																	this.LUCENE_MERGEFACTOR, 
																	this.LUCENE_MAXMERGEDOCS);
					pim.extraeContenidoPagina(caso, 
											  documento, 
											  pagina.getNomArchivoVol(), 
