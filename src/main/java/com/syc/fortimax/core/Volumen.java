...
public class Volumen {
	...
	public Volumen(String unidad, String ruta_base, String ruta_directorio, String volumen, int estado_unidad,
			String tipo_dispositivo, String capacidad, String tipo_volumen) {
