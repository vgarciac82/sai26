...
public class Descripcion {
    ...
    public Descripcion(String titulo_aplicacion, String nombre_campo, String nombre_columna, int posicion_campo, String nombre_tipo_datos, int id_tipo_datos, int longitud_campo, String valor_def_campo, String mascara_campo, String nombre_indice, int indice_tipo, String multivaluado, String requerido, String editable, String lista) {
