...
public class Pagina {
    ...
    // A=Archivo (D), I=ImaxFile
    private String tipo_pagina;

    private String anotaciones;

    // V=Vigente (D), T=Transitorio, H=Historico
    ...
    public String getFullPathFileName() {
        return StringUtils.trimToEmpty(getUnidadDisco()) + StringUtils.trimToEmpty(getRutaBase()) + StringUtils.trimToEmpty(getRutaDirectorio()) + StringUtils.trimToEmpty(getNomArchivoVol());
    }
}
