			...
			<tr>
				<td width="100%" align="center" valign="middle">
					<table width="100%" height="100%">
						...
						<tr>
							<td>- <a href="../gstnmngr/gestion?<%=GestionInterface.PRM_CMD%>=<%=GestionInterface.CMD_DOWNLOAD_KEYS%>&opt=key">Llave privada</a></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>- <a href="../gstnmngr/gestion?<%=GestionInterface.PRM_CMD%>=<%=GestionInterface.CMD_DOWNLOAD_KEYS%>&opt=cer">Certificado p&uacute;blico</a></td>
						</tr>						
						<%} %>
					</table>
				</td>
