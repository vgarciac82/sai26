...
<html>
	<head>
		...
		<title>Reporte Contratos Acumulado</title>
	...
	<body id="dt_example">
		<form method="get" action="../ObraPublica/reportes" id="frmOP">
			<h1>
				<label id="titulo">
					Contratos de Obras Públicas y Servicios Relacionados con las
					Mismas, Revalidaciones, Refrendos y Convenios, Adjudicados
					Acumulados  ( Capítulo 6000 )
				</label>
			</h1>
			...
			<input type="hidden" name="rt" id="rt" value="REPORTE_ACUMULADO" />
		</form>
	</body>
</html>