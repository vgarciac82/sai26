<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%
	//String tipRep = "1"; // Por omisión se ejecuta l formato 10
	String rt = "FORMATO_10"; // Por omisión se ejecuta l formato 10
...
<html>
	<head>
		...
		<title>Reporte Obra Publica Formato 10</title>
	...
	<body id="dt_example">
		<form method="get" action="../ObraPublica/reportes" id="frmOP">
			<h1>
				<label id="titulo">
					Consulta Obra P&uacute;blica (Formato 10)
				</label>
			</h1>
					...
					<table id="reportTbl">
						<tbody>
							...
							<tr>
								...
								<td align="left">
									<select id="cCentroContable" name="cCentroContable"
										style="width: 300px;">
										<option value="">
			...
			<div id="fechas">
									<table border="0" align="center" cellSpacing="0">
										...
										<tr>
											<td id="nn" class="calendar_2" style="text-align: right">
												Fecha Inicio:
											</td>
											<td class="calendar_2">
			...
			<input type="hidden" name="idunidadresponsable" id="idunidadresponsable" value="" />
