...
<title>Cat&aacute;logo Entidad Federativa / Unidad Ejecutora</title>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						$("#RelacionEFUejecutora").change(function() {
							validaCamposPorSeparado();
						});

						$("#Guardar").button().click(function() {
							queryFormPost({
								queryName : "tInsertCatalogoEFederativaUEjecutora",
								async : false,
								callback : function() {
						...
						$("#Limpiar").button().click(function() {
							window.location.href = "RelacionEFederativaUEjecutora.jsp";
						});
								...
								.dataTable(
										{
											...
											sAjaxSource : window.location.protocol
													...
													+ window.location.pathname
															.split("/")[1]
													+ "/crud?rt=t&ql=vtCatalogoEFederativaUEjecutoradt",
											aoColumns : [
													{
	...
	function validaCamposPorSeparado() {
		if ($("#RelacionEFUejecutora").val() != '') {
			var elementos = $("#RelacionEFUejecutora").val().split(".");

			var txtGridcEntidadFederativa = elementos[0];
			var txtGridcUnidadEjecutora = elementos[1];

			if ((elementos.length != 2)
					|| (txtGridcEntidadFederativa == "" || txtGridcUnidadEjecutora == "")) {
				alert("No se capturaron correctamente los elementos de la relación");
				return false;
			}
			$("#txtGridcEntidadFederativa").val(txtGridcEntidadFederativa);
			$("#txtGridcUnidadEjecutora").val(txtGridcUnidadEjecutora);
			return true;
		} else
			return true;
	}
...
<body id="dt_example" bottomMargin="0" bgColor="red" leftMargin="0"
	...
	<div id="container" class="container">
		<h1>Cat&aacute;logo Entidad Federativa / Unidad Ejecutora</h1>
					...
					<tr>
						<td>
							<fieldset>
								...
								<table width="100%">
									<tr>
										<td align="left" colspan="2">Relaci&oacute;n Entidad Federativa / Unidad Ejecutora: <input type="text"
											name="RelacionEFUejecutora" id="RelacionEFUejecutora" class="" size="14">
										</td>
									</tr>
									<tr>
										...
										<td align="left"><input type="text"
											name="txtGridcUnidadEjecutora" id="txtGridcUnidadEjecutora"
											class="AyudaSyC autoCompletaSyC" size="3">
										</td>
									</tr>
								</table>
								<table align="right">
		...
		<form action="../gstnmngr/RelacionEFederativaUEjecutora/CargaMasiva"
