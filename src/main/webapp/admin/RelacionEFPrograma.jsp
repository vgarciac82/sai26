...
<title>Catalogo relaci&oacute;n EF / Programa</title>
...
<script type="text/javascript">
	...
	$(document)
			.ready(
					function() {
						$("#RelacionEFProg").change(function() {
							validaCamposPorSeparado();
						});

						$("#Guardar").button().click(function() {
							queryFormPost({
								queryName : "tInsertCatalogoEFPrograma",
								async : false,
								callback : function() {
						...
						$("#Limpiar").button().click(function() {
							window.location.href = "RelacionEFPrograma.jsp";
						});
								...
								.dataTable(
										{
											...
											sAjaxSource : window.location.protocol
													...
													+ window.location.pathname
															.split("/")[1]
													+ "/crud?rt=t&ql=vtCatalogoEFProgramadt",
											aoColumns : [
													{
	...
	function validaCamposPorSeparado() {
		if ($("#RelacionEFProg").val() != '') {
			var elementos = $("#RelacionEFProg").val().split(".");

			var txtGridcGrupoFuncional = elementos[0];
			var txtGridcFuncion = elementos[1];
			var txtGridcSubFuncion = elementos[2];
			var txtGridcProgramaGeneral = elementos[3];
			var txtGridcActividadInstitucional = elementos[4];
			var txtGridcProgramaPresupuestario = elementos[5];

			if ((elementos.length != 6)
					|| (txtGridcGrupoFuncional == "" || txtGridcFuncion == ""
							|| txtGridcSubFuncion == ""
							|| txtGridcProgramaGeneral == ""
							|| txtGridcActividadInstitucional == "" || txtGridcProgramaPresupuestario == "")) {
				alert("No se capturaron correctamente los elementos de la relación");
				return false;
			}
			$("#txtGridcGrupoFuncional").val(txtGridcGrupoFuncional);
			$("#txtGridcFuncion").val(txtGridcFuncion);
			$("#txtGridcSubFuncion").val(txtGridcSubFuncion);
			$("#txtGridcProgramaGeneral").val(txtGridcProgramaGeneral);
			$("#txtGridcActividadInstitucional").val(txtGridcActividadInstitucional);
...
<body id="dt_example" bottomMargin="0" bgColor="red" leftMargin="0"
	...
	<div id="container" class="container">
		...
		<form action="../gstnmngr/RelacionEFPrograma/CapturaManual"
			id="CapturaManual" name="CapturaManual" method="post">
			<fieldset>
				<table width="100%">
					<tr>
					</tr>
					<tr>
						<td>
							<fieldset>
								...
								<table width="100%">
									<tr>
										<td align="left" colspan="6">Relaci&oacute;n Estructura
											Funcional / Programa : <input type="text"
											name="RelacionEFProg" id="RelacionEFProg" class="" size="18">
										</td>
									</tr>
									<tr>
										<td align="right">Grupo Funcional :</td>
										<td align="left"><input type="text"
											name="txtGridcGrupoFuncional" id="txtGridcGrupoFuncional"
											class="AyudaSyC autoCompletaSyC" size="5"></td>
										<td align="right">Función :</td>
										<td align="left"><input type="text"
											name="txtGridcFuncion" id="txtGridcFuncion"
											class="AyudaSyC autoCompletaSyC" size="5">
										</td>
										<td align="right">SubFunción :</td>
										<td align="left"><input type="text"
											name="txtGridcSubFuncion" id="txtGridcSubFuncion"
											class="AyudaSyC autoCompletaSyC" size="5"></td>
									</tr>
									<tr>
										<td align="right">Programa General :</td>
										<td align="left"><input type="text"
											name="txtGridcProgramaGeneral" id="txtGridcProgramaGeneral"
											class="AyudaSyC autoCompletaSyC" size="5"></td>
										<td align="right">Actividad Institucional :</td>
										<td align="left"><input type="text"
											name="txtGridcActividadInstitucional"
											id="txtGridcActividadInstitucional"
											class="AyudaSyC autoCompletaSyC" size="5">
										</td>
										<td align="right">Programa Presupuestario :</td>
										<td align="left"><input type="text"
											name="txtGridcProgramaPresupuestario"
											id="txtGridcProgramaPresupuestario"
											class="AyudaSyC autoCompletaSyC" size="5"></td>
									</tr>
								</table>
								<table align="right">
		...
		<form action="../gstnmngr/RelacionEFPrograma/CargaMasiva"
