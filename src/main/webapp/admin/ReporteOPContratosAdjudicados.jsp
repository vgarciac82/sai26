...
<html>
	<head>
		...
		<title>Reporte Contratos Adjudicados</title>
	...
	<body id="dt_example">
		<form method="get" action="../ObraPublica/reportes" id="frmOP">
			<h1>
				<label id="titulo">
					Consulta Obra P&uacute;blica Contratos de Obra Pública y de
					Servicios Relacionados Adjudicados
				</label>
			</h1>
			...
			<input type="hidden" name="rt" id="rt" value="REPORTE_CONTRATOS" />
		</form>
	</body>
</html>