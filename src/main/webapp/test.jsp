...
<script type="text/javascript" src="Generador/js/jquery.dataTables.js">
...
<body id="dt_example" bottomMargin="0" bgColor="red" leftMargin="0"
	topMargin="0">
	<form id="uploadFileProyecto" name="uploadFileProyecto" action="reportes/guardaPDF" method="post" enctype="multipart/form-data" >
