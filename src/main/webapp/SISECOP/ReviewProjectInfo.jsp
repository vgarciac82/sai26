...
boolean consulta = "true".equals( StringUtils.trimToEmpty( request.getParameter( "consulta" ) ) );
...
<title>Emite Dictamen de Proyecto</title>
...
<jsp:include page="ReviewProjectUI.jsp" flush="true" />
