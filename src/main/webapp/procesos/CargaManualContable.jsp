...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function cargaDataTable(){
				...
				oTable = $('#dtDetalleManuales').dataTable(
			    {
			    	"bLengthChange" : true,
					"bFilter" : true,
					"bSort" : true,
					...
					sAjaxSource : window.location.protocol + "//"
							...
							+ "/crud?rt=t&ql=vInfoManualContable&qw=" + cond,
			...
			function cargaManual(nIDVersion, nIDManual){
				 $('#cargaFrm').attr('src','../Generador/CargaManualesContables.jsp?version='+nIDVersion+'&idManual='+nIDManual);
	...
	<body id="dt_example" bottomMargin="0" bgColor="red" leftMargin="0" topMargin="0">
		<div id="container" class="container" style="width:100%">
			<div class="card-header"> <h3> Carga de Manual Contable Firmado </h3> </div>
			<hr class="mt-3"/>
			
			<form id="mainFrm" name="mainFrm">
				
				<div id="dtDetalleManualesDiv">
					<table class="table table-striped" cellspacing="0" cellpadding="0" align="center" id="dtDetalleManuales">
						<thead>
							<tr>
			...
			<div id="CargaDialog" title="Seleccion de pago">
