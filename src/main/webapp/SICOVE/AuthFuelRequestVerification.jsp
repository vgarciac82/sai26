...
<body>
	<form>
		...
		<div class="container-lg pt-3 mt-3">
			...
			<ul class="nav nav-tabs" id="pendingAuthVerificationTabs" role="tablist">
				<li class="nav-item" role="presentation">
					<button class="nav-link active" id="pendingAuthVerification-tab" data-bs-toggle="tab" data-bs-target="#pendingAuthVerification-tab-pane" type="button" role="tab" aria-controls="pendingAuthVerification-tab-pane" aria-selected="true">Por Autorizar</button>
				</li>
			...
			<div class="tab-content" id="pendingAuthVerificationTabsContent">
				
				<div class="tab-pane fade show active" id="pendingAuthVerification-tab-pane" role="tabpanel" aria-labelledby="pendingAuthVerification-tab" tabindex="0">
					<jsp:include page="fuelRequest/PendingFuelingList.jsp">
						<jsp:param value="Seleccione una solicitud" name="header" />
						<jsp:param value="pendingAuthVerificationDataTable" name="tableId" />
						<jsp:param value="Autoriza Comprobacion" name="title" />
					</jsp:include>
				</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			dts.push({"id":"pendingAuthVerificationDataTable","status":VALIDATING_VERIFICATION,"fn": processVerification});
