...
<html>
<head>
	<title>Cuentas por Pagar de Obras</title>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function(){
			...
			fnGrid($("#cIdUnidadEjecutora").val(), $("#FechaInicial").val().split('-').reverse().join('/'), $("#FechaFinal").val().split('-').reverse().join('/'),radicado);
			fnGridConLayout($("#cIdUnidadEjecutora").val(), $("#FechaInicial").val().split('-').reverse().join('/'), $("#FechaFinal").val().split('-').reverse().join('/'));
			...
			var vacio = true;
 			try {
				...
				{   
 				...
 				if (!vacio) {
	 				$.ajax({
						url: '../gstnmngr/PagoObrasConLayout',
						type: 'post',
						dataType: 'json',
		...
		function enviar(){
 		...
 		function generar(){
 			try 
 			{
            	...
            	document.location.href = '../gstnmngr/generaLayoutPagoObras?archivo=1';
 		...
 		function generarDocumentacion(){
 			try {
				...
				document.location.href = '../gstnmngr/generaLayoutPagoObras?archivo=2';
				document.envioSICOPObra.submit();
	...
	<body id="dt_example" onLoad="inicio();">
		<div id="container" class="ms-5" class="container" style="width: 90%">
			<input  type="hidden" value="N" id="cEsRadicado" name="cEsRadicado" />
			
			<div class="card-header"> <h3> Layout Pagos de Obra</h3> </div>
			<hr class="mt-3"/>				
			...
			<div class="row d-flex justify-content-center">
				...
				<div class="tab-content mt-3" id="tabContent">	
					<div class="tab-pane fade show active" id="tabs-1-layout" role="tabpanel" aria-labelledby="tabs-layout">
						...
						<jsp:include page="listaPagoObras.jsp"></jsp:include>
					...
					<div class="tab-pane fade" id="tabs-2-enviar" role="tabpanel" aria-labelledby="tabs-enviar">				
					    ...
					    <jsp:include page="listaPagoObrasEnviados.jsp"></jsp:include>
			        ...
			        <div class="tab-pane fade" id="tabs-3-generados" role="tabpanel" aria-labelledby="tabs-generados">
					    ...
					    <jsp:include page="listaPagoObrasConLayout.jsp"></jsp:include>
