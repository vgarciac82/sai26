...
<html>
	<head>
		...
		<script type="text/javascript" src="js/BuscaContratoEstimacion.js"></script>
	...
	<br/>
	<body id="dt_example">
		<form action="../CapturaEstimacion" method="post" id="mainForm">
			<input type="hidden" value="" id="folioSAI" name="folioSAI">
			<input type="hidden" value="ACTUALIZACION_DATOS" id="accion" name="accion">
			<input type="hidden" value="" id="OperacionActual" name="OperacionActual">
			
			<div id="container" style="width: 80%" class="container" >
				<div class="card-header"> <h3> Actualizaci&oacute;n de Datos Obra Publica </h3> </div>
				<hr class="mt-3"/>
				...
				<h6> Doble Click en el contrato para iniciar la captura de Estimacion. </h6>
				...
				<div id="question" style="display: none; cursor: default">
					...
					<div class="row d-flex">								
						<div class="col-12 col-lg-12 col-md-12 col-sm-12 p-1">
							<p> Presione Aceptar para agregar una Estimacion al contrato seleccionado. </p>
							<hr class="mt-3"/>
						</div>
					</div>	
