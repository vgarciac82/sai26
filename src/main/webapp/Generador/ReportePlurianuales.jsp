...
<body id="dt_example">
<br/>
	<form id="ExportarForm" name="ExportarForm" action="../reportes/ReportePlurianuales" method="get" target="_blank">
		...
		<div id="container" class="container" style="width: 60%">
			...
			<div class="card-header"> <h3> Contratos Plurianuales </h3> </div>
			<hr class="mt-3"/>						
				...
				<div class="row">
					<div class="col-12 col-md-6 mb-3 d-flex justify-content-center">							
						<div class="form-check">
							<input type="radio" name="TIPO_REPORTE" class="form-check-input" onclick="selecciona(this)" value="1" checked/>								
							<label for="1" class="form-check-label">Reporte</label>
						</div>
						<!-- 
						<div class="form-check">								
							<input type="radio" name="TIPO_REPORTE" class="form-check-input" onclick="selecciona(this)" value="2"/>
							<label for="2" class="form-check-label">Cedula</label>
						</div>
						 -->
					</div>
				</div>
