...
<%
	...
	if (request.getParameter("nFolioTramite")  != null) {
...
<form id="formViaticos" name="formViaticos" class="needs-validation" >
	<div class="form-group mx-auto">
		...
		<input type="hidden" name="agendaDifAnio" 	id="agendaDifAnio" />
		<input type="hidden" name="tieneCertificado" 	id="tieneCertificado" value ="0"/>
			...
			<div class="col-md-12">
				<div class="card">
				        <div class="card-header">
					        <ul class="nav nav-tabs card-header-tabs" id="comprobacion-list" role="tablist">
					            <li class="nav-item">
					              <a class="nav-link active" href="#consulta" role="tab" aria-controls="consulta" aria-selected="true">Consulta</a>
					            </li>
					            <li class="nav-item">
					              <a class="nav-link"  href="#pagos" role="tab" aria-controls="pagos" aria-selected="false" >Pagos/Comprobaciones</a>
					            </li>
					            <li class="nav-item">
					              <a class="nav-link" href="#editar" role="tab" aria-controls="editar" aria-selected="false">Editar</a>
					            </li>
					        </ul>
				        </div>
					    <div class="card-body">
					        <div class="tab-content mt-3">
					            	<div class="tab-pane active" id="consulta" role="tabpanel">
					            		<div id="divConsultaAgenda" class="col-12">
																	...
																	<div class="row">
																		<div id="resumen1" class="col-6"> 
														              	...
														              	<div id="resumen2" class="col-6">
																			...
																			<div class="row" id="divCertificadoTransito">
																				<div class="col-5"></div>
																				<div class="col-6">
																					<div class="input-group">
																						<span class="input-group-text"><i class="bi bi-bus-front-fill" onclick="imprimeCertificado()"></i></span>
																						<input type="button" class="btn btn-secondary" id="btnImprimirCert" name="btnImprimirCert" onclick="imprimeCertificado()" value ="Cert. Transito"/>
																					</div>
																				</div>
																			</div>
														              	</div>
					            ...
					            <div class="tab-pane" id="pagos" role="tabpanel" aria-labelledby="pagos-tab">  
					             	<div id="divPagosComprob">
					             		<jsp:include page="CompruebaComision.jsp"></jsp:include>
					             	</div>
					             </div> <!-- Fin div pagos -->
					             
					            <div class="tab-pane" id="editar" role="tabpanel" aria-labelledby="editar-tab">
					             	<div id="divEditarAgenda">
					             		<jsp:include page="EditarComisionViaticos.jsp"></jsp:include>
					             	</div>
					            </div>
					        </div>
					    </div>
...
<div class="modal" tabindex="-1" role="dialog" id="dialog-modificaCuenta" data-mdb-keyboard="true" data-mdb-backdrop="static">
	...
	<div id="DivFormJust">
			<form id="formJustificacion" name="formJustificacion" action="../admin/SeguridadCatalogos" target="_blank" method="post">
				<input type="hidden" id="catalogo" name="catalogo" value="REPORTE"/>
				<input type="hidden" id="accion" name="accion" value="run"/>
				<input type="hidden" id="rn" name="rn" value="ReporteJustificaciones.jasper"/>
				<input type="hidden" id="sWhere" name="sWhere" value=""/>
			</form>
	</div>
	...
	<script type="text/javascript" src="js/CompruebaComision.js"></script>
	<script type="text/javascript" src="js/CompruebaComisionViaticos.js"></script>
	<script type="text/javascript" src="../plantillasCasos/ComponentesPago/js/EgresoFirmantes.js"></script>
	<script type="text/javascript" src="js/FacturaRelGastos.js"></script>
	<script type="text/javascript" src="../plantillasCasos/ComponentesPago/js/CapturaMovimientosRG.js"></script>
	<script type="text/javascript" src="../plantillasCasos/ComponentesPago/js/EgresoFirmantes.js"></script>
