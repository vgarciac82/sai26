...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var tipo = "";
		eval( "tipo = window.opener."  + formName + ".value");
		$("#tipo").val(tipo);
	...
	function cargaGrid(){
		...
		var sV_CatalogoCLAVE = "tRazonSocialIP";
		...
		oTable = $("#dt_Beneficiario").dataTable({
			...
			"bServerSide": true, 
			sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql="+ sV_CatalogoCLAVE +"&qw=" + " " + encodeURI($("#cWhere").val()),
			aoColumns: [
				{ sName: "cClave",	bSearchable: false,	bSortable: false, bVisible: true, sClass: "alignLeft"},
