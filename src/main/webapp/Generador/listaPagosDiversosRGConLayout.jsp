<script type="text/javascript">
	function fnGridConLayout(pParam, pFechaIni, pFechaFin){
 		...
 		var oTableCuentaConLayout = $('#dt_CuentaConLayout').dataTable({
			...
			sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vListaPagosDiversosRGConLayout&qw=" + (pParam == 0 ? "" : "UNIDAD_EJECUTORA='" + pParam + "' AND ") + "FECHA_PROGRAMADAQuery BETWEEN convert(datetime,'" + pFechaIni + " 00:00',103) AND convert(datetime,'" + pFechaFin + " 23:59:59',103)",			
			aoColumns: [
...
<div id="container" class="ms-5" class="container" style="width: 90%">
	<form name="RGConLayout" id="RGConLayout" action="../gstnmngr/PagosDiversosRGConLayout" method="post">	
