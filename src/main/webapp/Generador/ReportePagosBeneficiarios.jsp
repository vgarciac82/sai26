...
$(document).ready(function() {	
	...
	function listareportes(rep){
		if (rep == 1) {
			...
			$("#reporteTipo").val("todos");
			$("#divEp").show();
			$("#contrato").show();
			$("#usuario").show();
		} else if (rep == 3) {
			$("#reporteTipo").val("conBancos");
			$("#ep").val("");
			$("#cContrato").val("");
			$("#cUsuario").val("");
			$("#divEp").hide();
...
<br/>
	<form id="ExportarForm" name="ExportarForm" action="../reportes/ReportePagosBeneficiarios" method="get" target="_blank">
		...
		<input type="hidden" id="reporteTipo" name="reporteTipo" value="presupuestal"/>
		<input type="hidden" id="cUR" name="cUR" />
		<input type="hidden" id="fecha_inicio" name="fecha_inicio"/>
		<input type="hidden" id="fecha_fin" name="fecha_fin"/>
		
		<div id="container" style="width: 80%" class="container">			
			<div class="card-header"> <h3> Consulta de Pagos a Beneficiarios </h3> </div>
			<hr class="mt-3"/>
			...
			<div class="row">
				...
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
					<div class="input-group">								
						...
						<input type="text" name="rfc" id="rfc" class="form-control form-control-sm" placeholder="AABC220101ABC"/>
					</div>
				</div>							
			</div>
			...
			<div class="row" id="usuario">
	        	...
	        	<div class="col-12 col-lg-2 col-md-2 col-sm-12 d-flex p-1">
					<label for="cUsuario" class="form-label"> Nombre del usuario:&nbsp; </label>												
				</div>		
				<div class="col-12 col-lg-5 col-md-5 col-sm-12 p-1">
					<div class="input-group">								
						<span class="input-group-text"><i class="bi bi-person"></i></span>
						<input type="text" name="cUsuario" id="cUsuario" class="form-control form-control-sm"/>
					</div>
				</div>							
			</div>
			...
			<div class="row" id="CBAN">
				<div class="col-12 col-lg-1 col-md-1 col-sm-12 d-flex p-1">																	
				</div>
	        	<div class="col-12 col-lg-2 col-md-2 col-sm-12 d-flex p-1">
	        		<label for="cContrato" class="form-label"> Cuenta bancaria:&nbsp; </label>																
				</div>		
				<div class="col-12 col-lg-3 col-md-3 col-sm-12 p-1">
					<div class="input-group">								
						<span class="input-group-text"><i class="bi bi-bank"></i></span>
						<input type="text" name="cBanco" id="cBanco" class="form-control form-control-sm"/>
					</div>
				</div>							
			</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-12 col-lg-2 col-md-2 col-sm-12">
					<input type="radio" name="conFacturas" id="Presupuestal" onclick="listareportes(1)" value="presupuestal" class="form-check-input" checked/>
					<label for="Presupuestal" class="form-check-label">Presupuestal</label>
				</div>
				<div class="col-12 col-lg-3 col-md-3 col-sm-12">
					<input type="radio" name="conFacturas" id="todos" onclick="listareportes(2)" class="form-check-input"/>
					<label for="todos" class="form-check-label">Incluye Solicitudes Caja</label>
				</div>
				<div class="col-12 col-lg-3 col-md-3 col-sm-12">
					<input type="radio" name="conFacturas" id="datosBanco" onclick="listareportes(3)" class="form-check-input"/>
					<label for="datosBanco" class="form-check-label">con datos Bancarios</label>
				</div>
			</div>
