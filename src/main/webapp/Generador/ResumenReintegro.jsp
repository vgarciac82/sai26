...
<script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function() {
		...
		oTableDetalle = $("#tblDetalle").dataTable({
			...
			bServerSide : true,
			sAjaxSource : window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=fnResumenReint(" + $("#nFolioReintegro").val() + ")",
			bJQueryUI : true,
			aaSorting : [ [ 0, "asc" ] ],
			aoColumns : [
				{sName : "cmes"	},
	...
	function init() {
		$("#nFolioReintegro").val("<%=nFolioReintegro%>");
	...
	<form id="FormContrato" name="FormContrato">
		<div id="container" class="container">
			...
			<div id ="generalDiv">
				<fieldset>
					...
					<table>
						<tr>
							<td> Folio </td>
							<td> <input name = "nFolioReintegro" id = "nFolioReintegro" value = "<%=nFolioReintegro%>" size = "15">
							<td> Fecha Solicitud </td>
							<td> <input name = "fSolicitud" id = "fSolicitud" size = "15" readonly >
							<td> Tipo de Reintegro </td>
							<td> <input name = "tipoR" id = "tipoR" size = "15" readonly>
							</td>
						</tr>	
						<tr>
							<td> Unidad:
			...
			<div id="detalle">
				...
				<table>		
					<tr>
						...
						<td>
							<input type="text" name="aEjercicioFiscal" id="aEjercicioFiscal" size = "5" readonly/>
						</td>
						<td>
							 Importe</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="CatCausaAvisoReintegro" id="CatCausaAvisoReintegro" value = "AVISO DE REINTEGRO" size="20" readonly>
						</td>
						<td> Capturado por:</td>
						<td colspan="1">
					...
					<tr>
						...
						<td colspan="5">
							<input type="text" name="observaciones" id="observaciones" size="110" maxlength="60" readonly/>
						</td>
					</tr>
					<tr>
						<td> Concepto
					...
					<tr>
						...
						<td align="left">
							<input id="cprograma" name="cprograma" readonly>
						</td>
					
						<td align="right">
							<label id="lblSubPrograma">SubPrograma:</label>
						</td>
						<td align="left">
							<input id="dSubprograma" name="dSubprograma" readonly>
						</td>
					</tr>											
				</table>
				</fieldset>				
			...
			<div id="pago" class="margenA">
				<h1> <a href="#">Datos del pago</a>
				</h1>
				<table>
					<tr>
						<td> Cta Bancaria
						</td>
						<td><input type="text" name="cuentaBancaria" id="cuentaBancaria" size="18" readonly>
						</td>
						<td> Linea Cap.
						</td>
						<td width=250>
							<input type="text" name="lc" id="lc" size="30" readonly>
						</td>
						<td> Fecha de Autorización.
						</td>
						<td>
							<input type="text" name="fAplicacion" id="fAplicacion" readonly/>
						</td>
					</tr>
