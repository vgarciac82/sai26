    	<script type="text/javascript">
    		function fnGridConLayout(pParam, pFechaIni, pFechaFin)
    		{
    			...
    			var oTableCuentaConLayout = $('#dt_CuentaConLayout').dataTable({
					...
					bServerSide: true,
					sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vListaCuentasConLayout&qw=" + (pParam == 0 ? "" : "UNIDAD_EJECUTORA='" + pParam + "' AND ") + "FECHA_PROGRAMADAQuery BETWEEN convert(datetime,'" + pFechaIni + " 00:00',103) AND convert(datetime,'" + pFechaFin + " 23:59:59',103)",
					bProcessing: true,
					sPaginationType: "full_numbers",
					bJQueryUI: true,
					aaSorting: [[ 2, "asc" ]] ,
	  		...
	  		<form name="ConLayout" id="ConLayout" action="../gstnmngr/PagosDirectosConLayout" method="post">
