...
<head>
<title>Reporte Momento Contable del Pagado</title>
...
<br/>
	<form id="ExportarForm" name="ExportarForm" action="../reportes/ReportePolizas" method="get" target="_blank">
		...
		<input type="hidden" id="TIPO_REPORTE" name="TIPO_REPORTE" value="CONCILIARADPAGADO"/>	

		<div id="container" style="width: 90%" class="container SyCData">
			<h1>
				Conciliacion Contable - Presupuestal del Pagado<!-- <label style="font-size: 11pt"></label> -->
			</h1>
