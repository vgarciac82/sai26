	...
	<head>
		...
		$(document).ready(function() {
			...
			oTable = $("#tblSoeDocumentado").dataTable({
				...
				bServerSide: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vSOETransferenciaGrid",
				bProcessing: true,
			...
			$("#pbNuevo")
				.button()
				.click( function() {
 					location.href = 'dSOETransferForm.jsp?Op=A&EstatusParam=Generando Nuevo SOE' ;
				});
			...
			$("#pbModificar")
				...
				.click( function() {
					...
					ObtenParamEnv();
					location.href = 'dSOETransferForm.jsp?Op=M&SOEParam='  + sNoSoe + '&sPrestamoParam=' + sIdPrestamo + '&EstatusParam='+ sEstatusSoe + '&FechaParam='+ sFechaMod;
				});
			...
			$("#pbDesplegar")
				...
				.click( function() {
					...
					ObtenParamEnv();
					var url= 'dSOETransferForm.jsp?Op=X&SOEParam='  + sNoSoe + '&sPrestamoParam=' + sIdPrestamo + '&EstatusParam='+ sEstatusSoe + '&FechaParam='+ sFechaMod;
					location.href =url;
				});				
	...
	<form> 
		...
		<div id="container" class="container"  style="width:1100px">	
			<h1>SOE por Transferencia</h1>
				...
				<input type="button" id="pbCancelarSOE" style="visibility: hidden" value="Cancelar SOE"/>
			<br/><br/>
