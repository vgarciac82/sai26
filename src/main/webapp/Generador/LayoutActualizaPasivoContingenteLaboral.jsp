...
<script type="text/javascript">
	...
	$(document).ready(function(){				
		...
		$( "#btnEnviarLayout" ).click( function() {
			cargarInformacion( this.form.flPasivoLaboral.value );
		} );
		
		/*$( "#btnLimpiar" ).click( function() {
			limpiarTabla( this.form.flPasivoLaboral.value );
		} );*/

		$( "#btnAplicar" ).click( function() {
			aplicarInformacion( this.form.flPasivoLaboral.value );
		} );
		...
		if( !correcto ) {
			...
			Swal.fire({
				 ...
				 if (result.isConfirmed) {
					$( "#frmLayoutPL" ).attr( "action", "../gstnmngr/LayoutReportePasivosServlet" );
					$( "#frmLayoutPL" ).attr( "enctype", "multipart/form-data" );
	...
	function aplicarInformacion() {
		if($("#folioTempGral").val() != 0){
			...
			/*if( confirm( "Esta Seguro de deseas aplicar los cambios temporales" ) ) {
				$( "#frmLayoutPL" ).attr( "action", "../gstnmngr/LayoutReportePasivosServlet" );
				$( "#frmLayoutPL" ).attr( "enctype", "multipart/form-data" );
			...
			//alert("Favor de cargar el lay out a aplicar");
		}		
	}
...
<body id="dt_example">
<br/>	
	<form method="post" id="frmLayoutPL" name="frmLayoutPL" action="../ActualizaFirmantesMasivo">
		<div id="container" class="container" style="width: 80%">
			...
			<div class="card-header"> <h3> Layout Pasivos Contingentes Laborales (.csv) </h3> </div>
			<hr class="mt-3"/>
			
			<div class="row">
				<div class="col-6">									
					
			  		<input type="file" id="flPasivoLaboral" name="flPasivoLaboral" class="form-control form-control-sm" style="width: 30em;"/>				
				</div>
				...
				<div class="col-4">															
					...
					<input type="button" id="btnAplicar" name="btnAplicar" value="Terminar" class="btn btn-secondary" onclick="aplicarInformacion()"/>				
				</div>
			</div>
