    	<script type="text/javascript">
  		...
  		<div id="container" class="ms-5" class="container" style="width: 90%">
  			<form name="envioSICOP" id="envioSICOP" method="post">
				<div>
		    		...
		    		<input type="hidden" id="tipoPagoLayout" name="tipoPagoLayout" />
		    	</div>
				...
				<div class="row d-flex">								
					<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
						<input type="button" id="pbEnvia" style="visibility: hidden" type="button" value="Generar Layout" class="btn btn-secondary"/>
					</div>
					<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
						<input type="button" id="pbCompromiso" style="visibility: hidden" type="button" value="Generar Layout Compromiso" class="btn btn-primary"/>
					</div>
				</div>
