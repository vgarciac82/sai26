...
<script type="text/javascript">
	...
	function cargaGrid(){
		...
		var sV_CatalogoRFC = "v_PCATALOGORFC";
		
		if(formName == "datosReintegro"){//ARLA RFC tipo 3 y RFC de CONAFOR CNF010405EG1
			sV_CatalogoRFC = "v_PCATALOGORFC_NOMINA";
		}
		else if(formName != "FormContrato" && (destino == "RCRE" || destino == "CCRE")){//ARLA Se filtran solo los empleados a los que se les asigna la Caja Chica Devengado y Comprobacion
			sV_CatalogoRFC = "v_PCATALOGORFC_CAJACHICA";
		}		
		else if(formName != "FormContrato"){
			sV_CatalogoRFC = "v_PCATALOGORFC_TESORERIA";
		}
