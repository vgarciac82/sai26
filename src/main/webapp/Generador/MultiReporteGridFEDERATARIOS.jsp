...
//				return oTableLocal.$('tr.row_selected');
		...
		window.MultiReporteHija.Partida4.value=window.opener.FormContrato.Partida4.value;
		var Pp = $('#Partida').val();
		...
		return $("#tblEP").dataTable({
				...
				bServerSide: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vCatalogoEPGrid2&qw= Partida between '43000' and '43999' " + cunidadej + w,
				bProcessing: true,
