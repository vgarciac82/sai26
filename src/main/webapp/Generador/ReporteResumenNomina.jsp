	...
	function extrae(){	
		if ($("#fecha_fin").val() == "") {
			Swal.fire({ icon: 'warning',			
						text: "Debes seleccionar la fecha para el reporte." });					
		}
		else{		
...
<br/>
	<form id="ExportarForm" name="ExportarForm" action="../reportes/ReporteNomina" method="get" target="_blank">
		...
		<input type="hidden" id="TIPO_REPORTE" name="TIPO_REPORTE" value="FFM"/>
		
		<div id="container" style="width: 90%" class="container">
			<div class="card-header"> <h3> Reporte de las solicitudes de nomina generadas </h3> </div>
			<div class="mt-4 row d-flex">	
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">															
				</div>				
				<div class="col-12 col-lg-3 col-md-3 col-sm-12 p-1">
					<label class="form-label">Selecciona la fecha del reporte:</label>											
				</div>					
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
			...
			<div class="row d-flex">
				...
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
					<input type="button" class="btn btn-secondary btn-sm" id="cmdxlsReporteProg" name="cmdxlsReporteProg" value="Extraer" onclick="extrae()" />																		
				</div>						
			</div>	
