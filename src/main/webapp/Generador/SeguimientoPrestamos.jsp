...
<html>
	<head>
		<title>Seguimiento - Prestamos</title>
		...
		<script type="text/javascript" charset="utf-8">
			...
			$(document).ready(function() {
				...
				oTable = $("#tblPrestamo").dataTable({
					...
					bServerSide: true,
					sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vSeguimientoPrestamo",
					bProcessing: true,
...
<body id="dt_example" >
	<form> 
		<div id="container" style="padding:10px">	
			<h1>Seguimiento - Pr&eacute;stamos</h1>
