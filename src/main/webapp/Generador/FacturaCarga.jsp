...
<html>
  <head>
	...
	<meta http-equiv="description" content="Carga Facturas Desembolso">
...
$(document).ready(function(){
		...
		$("#btnCargarFactura").show();

		$("#txtAreaMensaje").val("<%=mensaje%>");
		//NOMBRE DEL BOTON
		$("#btnCargarFactura").click(function (){ 
		
			$("#frmFacturaCargaDesembolso").attr("action","../gstnmngr/FacturaDesemServlet");
			$("#frmFacturaCargaDesembolso").attr("enctype","multipart/form-data");
			$("#frmFacturaCargaDesembolso").submit();
...
<form method="post" id="frmFacturaCargaDesembolso" name="frmFacturaCargaDesembolso" >
<center>
	
	<div id="container" class="container" style="width:1100px">
			<h1><img id="imgPlayStop" style="visibility: hidden" src="imagenes/wait24trans.gif">Facturas <label id="lbOperacion" style="font-size: 8pt"></label></h1>


			<h2> Carga de Archivo CSV para Importar información de Facturas </h2>
			...
			<table border="0" align="center" width="800px">
				<tr>
					...
					<td colspan="1" align="center"><input type="button" id="btnCargarFactura" name="btnCargarFactura"  value="Cargar" /></td>
				</tr>
			</table>
			</fieldset>
