...
<html>
  <head>
    <title>Layout Operaciones Ajenas</title>
		...
		function enviar(){
 		...
 		function generarDocumentacion(){
 			try {
            	...
            	document.location.href='../gstnmngr/generaLayoutOperacionAjena?archivo=2';
            	document.envioSICOP.submit();
...
/*	,								
  	...
  	<body id="dt_example" onLoad="inicio();" >
		<div  id="container" >
			<h1>Layout Operación Ajena<label id="lbOperacion" style="font-size: 8pt"></label></h1>			
        	<div id="tabs">    		
        		<ul>
				...
				<div id="tabs-1">	
					...
					<fieldset>
						...
						<jsp:include page="listaOperacionAjena.jsp"></jsp:include>
					</fieldset>
					</form>	
				</div>
				<div id="tabs-2">				
				    <fieldset>
				    	...
				    	<jsp:include page="listaOperacionAjenaEnviados.jsp"></jsp:include>
					</fieldset>
				</div>
		        <div id="tabs-3">
		        	<table width="100%" border="0">
				    ...
				    <fieldset>
				    	...
				    	<jsp:include page="listaOperacionAjenaConLayout.jsp"></jsp:include>
					</fieldset>
				</div>		        
			</div>
