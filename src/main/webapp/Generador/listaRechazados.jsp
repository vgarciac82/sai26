    	<script type="text/javascript">
    		$(document).ready(function () {
    			var oTableLocal = $('#dt_rechazados').dataTable({
					sScrollY: "340",
					sScrollX: "100%",
					sScrollXInner: "100%",
					bRetrive: true,
					...
					bServerSide: true,
					sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vListaCompromisos&qw=estadoCompromiso = 'RECHAZADO'",
					bProcessing: true,
  		...
  		<div id="container">
            <div id="demo_jui">
  				<table   id="dt_rechazados" class="display">
					<thead>
						<tr align="center">
							<th>
				<!--			
							<input type="checkbox" name="integraTodosR" id="integraTodosR" value="" onclick="toggleReactivar(this)"/></th>
						
							<input type="checkbox" name="integraTodosR" id="integraTodosR" value="" />
				-->	
