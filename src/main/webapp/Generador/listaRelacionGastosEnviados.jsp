	<script type="text/javascript">
		...
		<form name="envioSICOP" id="envioSICOP" action="../gstnmngr/generaLayoutRelacionGastos" method="post">
			...
			<input type="hidden" id="sDataHComp" name="sDataHComp" />
			...
			<div class="row d-flex">								
				...
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
					<input type="button" id="pbEnvia" style="visibility: hidden" type="button" onClick="generar();" value="Generar Layout" class="btn btn-primary"/>
				</div>
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
					<input type="button" id="btnLayoutBan" style="visibility: hidden" type="button" onClick="generaLayoutBancario();" value="Layout Bancario" class="btn btn-secondary"/>
				</div>	
				<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-1">
					<input type="button" id="btnLayoutCmp" style="visibility: hidden" type="button" onClick="generaLayoutCompromiso();" value="Layout Compromiso" class="btn btn-success"/>
				</div>				
			</div>
		</form>
