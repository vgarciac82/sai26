    	<script type="text/javascript">
    		$(document).ready(function () {
					...
					aoColumns: [					    
						...
						{ sName: "CuentaXPagar",			bSearchable: false,	bSortable: false, bVisible: true}
					]
  		...
  		<div id="container" class="ms-5" class="container" style="width: 90%">
  			<form name="envioSICOP" id="envioSICOP" action="../gstnmngr/generaLayoutPagosDiversos" method="post">
