                    ...
                    function() {
                        ...
                        queryFormPost({
                            ...
                            callback: function() {
                                ...
                                if (operAct != "5") {
                                    alert("No se puede Modificar el Proveedor/Beneficiario, ya que el caso esta en algun proceso");
                                    $.unblockUI();
                                } else {
                                	queryFormPost({
						                            queryName: 'tAltaProveedorUpdateTipoPersona',
						                            async: false,
						                            callback: function() {$("#mainForm").submit();}
                                    				});
                                }
                            }
                        });
...
<body id="dt_example">
    <form action="../ModificaProveedor" method="post" id="mainForm">
        ...
        <input type="hidden" value="ModificaTipoPersona" id="accion" name="accion">
        <input type="hidden" value="" id="OperacionActual" name="OperacionActual">
        <h1>
						<label id="titulo"> Modificacion Tipo Persona de Proveedor/Beneficiario </label>
					</h1>
        <div id="container" class="container SyCData">
            ...
            <br />
            <h6>Doble Click para editar el Proveedor/Beneficiario.</h6>
