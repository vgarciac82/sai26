...
<%
	...
	String inputRFCTarget = request.getParameter("inputRFCTarget")==null || "".equals(request.getParameter("inputRFCTarget"))? "cIdRFC":request.getParameter("inputRFCTarget");
	...
	String inputNoEmpTarget = request.getParameter("inputNoEmpTarget")==null || "".equals(request.getParameter("inputNoEmpTarget"))? "nEmpleado":request.getParameter("inputNoEmpTarget");
%>
...
<script type="text/javascript">
	...
	function enviar(){
		...
		eval( 'window.opener.' + formName  + '.cUR.value=window.formBenef.cUR.value' );
		eval( 'window.opener.' + formName  + '.cPlaza.value=window.formBenef.cPlaza.value' );
		eval( 'window.opener.' + formName  + '.cNivel.value=window.formBenef.cNivel.value' );		
		
 
		var inputRFC = "";
		eval( "inputRFC = window.opener." + formName + "." + inputRFCTarget );
		if( inputRFC && inputRFC.onchange )
			inputRFC.onchange();
