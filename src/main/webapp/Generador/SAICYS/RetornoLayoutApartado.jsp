...
<html>
  <head>
    ...
    <title>Retorno de Layout Apartado</title>
	...
	<script type="text/javascript">
		...
		function fromSubmit(){			
			...
			$("#formRetornoLAyoutApartado").submit();
		}
		function fromSubmitAjax(){
			var hayDocumento=false;
			var data = new FormData();
			jQuery.each(jQuery('#layoutApartado')[0].files, function(i, file) {
			    data.append('file-'+i, file);
			    hayDocumento=true;
			});
			if(!hayDocumento){
				swal("Favor de seleccionar un archivo .csv",{icon:"info",button: "Cerrar"});
				return;
			}
...
<body>
	<form id="formRetornoLAyoutApartado" action="../../servlet/LeeArchivos"  enctype = "multipart/form-data" method = "post" >
  		<div class="container-fluid">
			<div class="col-md-12 col-lg-12 col-sm-12">
		  		<fieldset class="form-group border p-3">
			 		<legend class="w-auto px-2"> Carga Layout, Retorno de Apartado de Tienda Digital</legend>
			 		<div class="form-group">
						<div class="form-group row">
							<div class="form-group col-md-8">
								<div class="input-group">
								  <div class="custom-file">
								    <input type="file" class="custom-file-input" id="layoutApartado"
								      aria-describedby="inputGroupFileAddon01">
								    <label class="custom-file-label" for="layoutApartado">Layout  (*.csv):</label>
								  </div>
								</div>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-auto">
								<input id="sndBtn" name="sndBtn" type="button" value="Enviar" onclick="fromSubmitAjax()" class="btnInterfaceBG ui-button ui-widget ui-state-default ui-corner-all"/>
							</div>
						</div>
						<div class="form-group row">
							<div class="form-group col-md-8">
								<label for="observaciones">Respuesta:</label>
