...
<html>
  <head>
	...
	<meta http-equiv="pragma" content="no-cache" > 
		...
		<script type="text/javascript" src="../js/ProgramaAnual.js"></script>
	...
	<script type="text/javascript" charset="utf-8">
  		$(document).ready(function() {
	  		...
	  		$("#ConsultaPAAS").click(function() {
  				$("#tbs").val(0);
				window.location = "ProgramaAnual.jsp?tab=" + 0;
			});
			
			$("#ReportesPAAS").click(function() {
				$("#tbs").val(2);
				window.location = "ProgramaAnual.jsp?tab=" + 2;
			});
			if($("#tbs").val()!=1){
				$("#CalendarioPAAS" ).hide();
			}
 ...
 <body bgcolor="red" id="dt_example" bottommargin="0" leftmargin="0" topmargin="0" onkeydown="return checkShortcut();" > 
  	<div id="container" class="container" style="width: 98%;">
  		<br/>
		<br/>
		<h1>Programa Anual de Adquisiciones, Arrendamientos y Servicios<label id="lbOperacion" style="font-size: 8pt"></label></h1>
		<br/>
		<div class="tabs" id="tabs">
			<ul>
				<li><a id="ConsultaPAAS" href="#tabs-0" >Consulta</a></li>
				<li><a id="CalendarioPAAS" href="#tabs-1">Calendario</a></li>
				<li><a id="ReportesPAAS" href="#tabs-2" >Reportes</a></li>
				
			</ul>
			<div id="tabs-0" align="center">
				<% if ("0".equals(request.getParameter("tab"))) { %>
					<jsp:include page="ConsultaPAAS.jsp" />
					<script type="text/javascript" charset="utf-8">
							var $tabs = $(".tabs").tabs();
							$tabs.tabs('select', 0);
					</script>
			...
			<div id="tabs-1" align="center" >
				<% if ("1".equals(request.getParameter("tab"))) { %>
					<jsp:include page="CalendarioPAAS.jsp" />
					<script type="text/javascript" charset="utf-8">
							var $tabs = $(".tabs").tabs();
							$tabs.tabs('select', 1);
					</script>
			...
			<div id="tabs-2" align="center">
				<% if ("2".equals(request.getParameter("tab"))) { %>
					<jsp:include page="ReportesPAAS.jsp" />
					<script type="text/javascript" charset="utf-8">
							var $tabs = $(".tabs").tabs();
							$tabs.tabs('select', 2);
					</script>
