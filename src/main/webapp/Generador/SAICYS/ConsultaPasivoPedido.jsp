...
<html>
  <head>
    <title>Consulta Pasivos Pedido</title>
	...
	<script type="text/javascript" charset="utf-8"><!--
		...
		oTable=	$('#tblconsultaPasivosContrato').dataTable({
			...
			<%
				...
				Map pestanas=ebl.getPestana(role,"Contratos");
				...
				Map botones=nb.getBotones(role,"Contratos","consultaContrato");
			...
			function mostrar() { 
				...
				oTable=	$('#tblconsultaPasivosContrato').dataTable({
					...
					"oLanguage": {
						...
						bServerSide: true,
						sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=v_consultaPasivoPedido&qw=" + qw,
						aaSorting: [[ 0, "asc" ],[ 1, "asc" ],[2,"asc"]] ,			
						aoColumns: [
							{ sName: "cVinculo", bVisible: false },
		...
		//obtiene solo un registro del renglon seleccionado lo mete en un arreglo
			function fnGetSelected( oTableLocal )
			{
				...
				return aReturn;
	              ...
	              function guardarPasivoPedido(indice){
		          ...
		          if(confirm("\xBFEstas seguro de actualizar los datos de Pedido definitivo "+$("#cIdPedidoDefinitivo_"+indice+"").val()+ " "+  "de la Unidad Ejecutora"+" "+ $("#cIdUnidadEjecutoraConsultaPasivo_"+indice+"").val()+"?")){
				...
				//   $("#cIdSubPartida").val($("#cIdSubpartida_"+indice+"").val());
				   ...
				   queryFormPost("actualizaConsultaPasivoPedido",{async:false});
	              ...
	              function eliminaPasivoPedido(indice){
		          ...
		          if(confirm("\xBFEstas seguro de Eliminar los datos de Pedido definitivo "+$("#cIdPedidoDefinitivo_"+indice+"").val()+ " "+  "de la Unidad Ejecutora"+" "+ $("#cIdUnidadEjecutoraConsultaPasivo_"+indice+"").val()+"?")){
				   $("#contratoDefinitivo").val($("#cIdPedidoDefinitivo_"+indice+"").val());
				   $("#cUnidadEjecutoraPasivo").val($("#cIdUnidadEjecutoraConsultaPasivo_"+indice+"").val());
				   queryFormPost("eliminaConsultaPasivoPedido",{async:false});
			       window.location='PasivosPedido.jsp?tab=1'
				   return;
  ...
  <body id="dt_example" bottomMargin="0" bgcolor="red" leftmargin="0" topmargin="0">
  	<form> 
  		...
  		<fieldset >
  			<legend>Consulta Pasivos Pedido</legend>
