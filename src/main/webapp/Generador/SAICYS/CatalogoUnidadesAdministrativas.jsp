	...
	<script type="text/javascript" charset="utf-8">
		$(document).ready(function() {
			...
			$("#aTab0").click(function() {
				window.location = "CatalogoUnidadesAdministrativas.jsp?tab=" + 0;
			});
			$("#aTab1").click(function() {
				window.location = "CatalogoUnidadesAdministrativas.jsp?tab=" + 1;
			});
			$("#aTab2").click(function() {
				window.location = "CatalogoUnidadesAdministrativas.jsp?tab=" + 2;
			});
  ...
  <body id="dt_example" bottomMargin="0" bgcolor="red" leftmargin="0" topmargin="0" onkeydown="return checkShortcut()">
  	<form> 
		<div id="container" class="container">	
			<br/>
			<br/>
			<h1>Cat&aacute;logo de Unidades Administrativas<label id="lbOperacion" style="font-size: 8pt"></label></h1>
			<br/>
			<div class="tabs" id="tabs" name="tabs" >
				...
				<div id="tabs-0" align="center">
					<% if (request.getParameter("tab").equals("0")) { %>
						<jsp:include page="CatalogoUnidadesAdmnistrativasGridConsultar.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 0);
						</script>
				...
				<div id="tabs-1" align="center" width="800">
					<% if (request.getParameter("tab").equals("1")) { %>
						<jsp:include page="CatalogoUnidadesAdministrativasEditar.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 1);
						</script>
				...
				<div id="tabs-2" align="center" width="800">
					<% if (request.getParameter("tab").equals("2")) { %>
						<jsp:include page="CatalogoUnidadesAdministrativasNuevo.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 2);
						</script>
