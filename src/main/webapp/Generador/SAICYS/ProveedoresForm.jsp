	...
	<head>
		...
		$(document).ready(function() {
			...
			var cIdRFC1 = $( "#cIdRFC1" ),
				...
				allFields = $( [] ).add( cIdRFC ).add( cRazonSocial ).add( cRepresentanteLegal ).add( cGiro ).add(cMunicipio).add(cCalle).add(cNumeroExterno).add( cColonia ).add( cCodigoPostal ),
				tips = $( ".validateTips" );
			...
			$("#btnGuardar")
				...
				.click(function() {
					...
					var bValid = true;
						...
						bValid = bValid && checkLength( cRepresentanteLegal, "cRepresentanteLegal", 1, 100 );
					...
					if (bValid){
						...
						querySelectPost("mCatalogoProveedorCreate",  {async : false});
						querySelectPost("mCatalogoProveedorTelefonoCreate",  {async : false});						
						location.href = 'Proveedores.jsp?tab=1';
					}
			});			
		...
		<fieldset>
			...
			<table align="left">
				<tr align="left">
					...
					<td><input type="radio" id="tipoPersona" name="tipoPersona" value="1" onclick="cambioLongitud(1);">F&iacute;sica
						<input type="radio" id="tipoPersona" name="tipoPersona" value="2" checked onclick="cambioLongitud(2);"> Moral					
					</td>
				</tr>			
				<tr align="left">
				...
				<tr align="left">
					<td>Representante </td>
					<td><input type="text" name="cRepresentanteLegal" id="cRepresentanteLegal" style="width: 30em;" maxlength="100"/><font color="red">*</font></td>
				</tr>
				<tr align="left">
					<td>Giro </td>
