...
<meta charset="UTF-8">
<title>Convenios de contrataciones del capitulo 4 mil</title>
	...
	<script type="text/javascript" src="../js/funciones.js"></script>
 	<script type="text/javascript" src="../js/ConveniosContCap4.js"></script>
	...
	$(document).ready(function() {
		$(".tabs").tabs();
		$("#nuevoConvCap4").click(function() {
			window.location = "ConveniosCap4.jsp?tab=" + 0;
		});
		$("#consultaConvCap4").click(function() {
			window.location = "ConveniosCap4.jsp?tab=" + 1;
		});
		$("#caratulaConvCap4").click(function() {
			window.location = "ConveniosCap4.jsp?tab=" + 2;
		});
		$("#presupuestoConvCap4").click(function() {
			window.location = "ConveniosCap4.jsp?tab=" + 3;
		});
		$("#precompromisoConvCap4").click(function() {
			window.location = "ConveniosCap4.jsp?tab=" + 4;
		});
...
<body>
		<div class="container-fluid" >
			<div class="col-md-12 col-lg-12 col-sm-12">
	 			<h1 style="color: #1A69A9;">Convenios modificatorios del cap&iacute;tulo 4 mil</h1>
	 			<div class="tabs" id="tabs">
		 			<ul class="nav nav-tabs">
		 				<li class="nav-item"><a href="#tabs-0" id="nuevoConvCap4" class="nav-link" aria-current="page">Nuevo</a></li>
					    <li class="nav-item"><a href="#tabs-1" id="consultaConvCap4" class="nav-link" aria-current="page">Consulta</a></li>
					    <li class="nav-item"><a href="#tabs-2" id="caratulaConvCap4" class="nav-link" aria-current="page">Car&aacute;tula</a></li>
					    <li class="nav-item"><a href="#tabs-3" id="presupuestoConvCap4" class="nav-link" aria-current="page">Presupuesto</a></li>
					    <li class="nav-item"><a href="#tabs-4" id="precompromisoConvCap4" class="nav-link" aria-current="page">PreCompromiso</a></li>
		 			</ul>
		 			<% if (request.getParameter("tab")!= null){ %>
						<div id="tabs-0" align="left" >
							 <% if (request.getParameter("tab").equals("0")) { %>
								<jsp:include page="NuevoConvCap4.jsp" />
								<script type="text/javascript" charset="utf-8">
									$( "#tabs" ).tabs({ active: 0 });
								</script>
							<% }  %>
						...
						<div id="tabs-1" align="left" >
							 <% if (request.getParameter("tab").equals("1")) { %>
								<jsp:include page="ConsultaConvCap4.jsp" />
								<script type="text/javascript" charset="utf-8">
									$( "#tabs" ).tabs({ active: 1 });
								</script>
							<% }  %>
						...
						<div id="tabs-2" align="left" >
							 <% if (request.getParameter("tab").equals("2")) { %>
								<jsp:include page="CaratulaConvCap4.jsp" />
								<script type="text/javascript" charset="utf-8">
									$( "#tabs" ).tabs({ active: 2 });
								</script>
							<% }  %>
						...
						<div id="tabs-3" align="left" >
							 <% if (request.getParameter("tab").equals("3")) { %>
								<jsp:include page="PresupuestoConvCap4.jsp" />
								<script type="text/javascript" charset="utf-8">
									$( "#tabs" ).tabs({ active: 3 });
								</script>
							<% }  %>
						...
						<div id="tabs-4" align="left" >
							 <% if (request.getParameter("tab").equals("4")) { %>
								<jsp:include page="PrecompromisoConvCap4.jsp" />
								<script type="text/javascript" charset="utf-8">
									$( "#tabs" ).tabs({ active: 4 });
								</script>
							<% }  %>
