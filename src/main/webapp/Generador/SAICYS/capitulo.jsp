...
<html>
  <head>
	...
	<meta http-equiv="description" content="This is my page">
		...
		$(document).ready(function() {
			...
			mostrar();
			$("#tblcapitulo tbody").click(function(event) {
				...
				var aTrs = $('#tblcapitulo').dataTable().fnGetNodes();
				//alert("Yaaaa");
				for ( var i=aTrs.length ; i>=0; i-- )     
					{  
						...
						{   
							var nTr = $('#tblcapitulo').dataTable().fnGetData(aTrs[i]);
							$("#idcapitulo").val(nTr[0]);
							$("#capitulo").val(nTr[1]);
							
							window.opener.document.B.capitulo.value=nTr[1];
							window.opener.document.A.cIdCapitulo.value=nTr[0];
							window.close();
		...
		function mostrar() {
				var qw = " 1 = 1";
				if ($("#idcapitulo").val() != "" )
					qw += " AND cIdCapitulo like '%25" + $("#idcapitulo").val() + "%25'";
				if ($("#capitulo").val() != "" )
					qw += " AND ccapitulo like '%25" + $("#capitulo").val() + "%25'";
				
				oTable = $("#tblcapitulo").dataTable({
				sScrollX: "100%",
				sScrollXInner: "100%", 
				...
				bServerSide: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=[mCatalogoCapitulo]&qw="+qw,
				bProcessing: true,
				//Tablesorter:false,
				//bSortable: false
  ...
  <fieldset>
	...
	<legend>CAPITULO</legend>
  	...
  	<form action="" name="B" id="B">
  		<table width="100%" border="0">
	   			...
	   			<tr width="50%">
	   				<td ><input type="text" name="idcapitulo" id="idcapitulo" maxlength="50" style="width: 20%;"></td>
	   			...
	   			<tr width="50%">
	   				<td ><input type="text" name="capitulo" id="capitulo" maxlength="50" style="width: 80%;"></td>
    ...
    <table id="tblcapitulo" class="display">
           <thead>
               <tr>
   				<th >capitulo</th>
               	<th  >capitulo</th>
