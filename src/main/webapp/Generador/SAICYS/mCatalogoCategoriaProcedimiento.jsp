...
<html>
  <head>
    ...
    <title>mCatalogoCategoriaProcedimiento</title>
	...
	<script type="text/javascript" charset="utf-8">
		$(document).ready(function() {
			...
			$("#aTab1").click(function() {
				window.location = "mCatalogoCategoriaProcedimiento.jsp?tab=" + 1;
			});
			//prueba del checkbox
			$("#checkme").click(function(){
				alert("As presionado el checkbox");
			});
  ...
  <body id="dt_example" bottomMargin="0" bgcolor="red" leftmargin="0" topmargin="0" onkeydown="return checkShortcut()">
  	<!-- <form id="ejemplo" name="ejemplo" action="agregaCatalogoCategoriaProcedimiento.jsp">
			<input type="checkbox" name="checkme" id="checkme">
			<input type="submit" name="prueba" id="prueba" onclick="enviar();">
		</form>
	-->
   <div id="container" class="container">	
			<br/>
			<br/>
			<h1>mCatalogoCategoriaProcedimiento<label id="lbOperacion" style="font-size: 8pt"></label></h1>
			<br/>
			<div class="tabs" id="tabs" name="tabs">
				<ul>
					<li><a id="aTab0" href="#tabs-0" >Consulta</a></li>
					<li><a id="aTab1" href="#tabs-1" >Agregar</a></li>
					
				</ul>
				<div id="tabs-0" align="center">
					<% if (request.getParameter("tab").equals("0")) { %>
						<jsp:include page="mCatalogoCategoriaProcedimientoGrid.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 0);
						</script>
				...
				<div id="tabs-1" align="center" width="800">
					<% if (request.getParameter("tab").equals("1")) { %>
						<jsp:include page="agregaCatalogoCategoriaProcedimiento.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 1);
						</script>
