...
<body>
	<form id="formPresupuestoContArt25">
			...
			<div class="form-group">
				<div class="row">
					<div class="input-group">
						<div class="col">
							<input type="button" class="btnInterfaceAutoriza ui-button ui-corner-all float-right" 	id="imgAprobarContArt25" name="imgAprobarContArt25" 	value="Aprobar"	onclick="guardaContrato();" />
							<input type="button" class="btnInterfaceReturn ui-button ui-corner-all float-right" 	id="imgDevolverContArt25" name="imgDevolverContArt25" 	value="Devolver"	onclick="devuelveContrato();" />
							<input type="button" class="btnInterfaceBackToTop ui-button ui-corner-all float-right" 	id="imgSalirContArt25" 	name="imgSalirContArt25" value="Salir" onclick="window.location = 'ContratosArt25.jsp?tab=1';" />
						</div>
					</div>
				</div>
				<div class="row">
		...
		<fieldset class="form-group border p-3">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-auto">
						<br>
						<input type="button" id="btnIdClaveEgresos" name="btnIdClaveEgresos" value="..." onclick="buscaClavePresupuestal()" 
					...
					<div class="col-auto">
						<br>
						<input type="button" id="btnAgregarEPContArt25" name="btnAgregarEPContArt25" value="Agregar" onclick="fnClickAddRowC(3)" class="btnInterfaceBG ui-button ui-widget ui-state-default ui-corner-all float-start"/>
					</div>
				</div>
			</div>
			<div class="form-group">
