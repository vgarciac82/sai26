...
<html>
  <head>
    ...
    <title>Cat&aacute;logo de Montos de Adjudicaci&oacute;n Directa y de I3P</title>
	...
	<script type="text/javascript" charset="utf-8">
		$(document).ready(function() {
			...
			$("#aTab0").click(function() {
				window.location = "CatalogoMontosADydeI3P.jsp?tab=" + 0;
			});
  ...
  <body id="dt_example" bottomMargin="0" bgcolor="red" leftmargin="0" topmargin="0" onkeydown="return checkShortcut()">
  	<form>
		...
		<div id="container" class="container">	
			<br/>
			<br/>
			<h1>Cat&aacute;logo de Montos de Adjudicaci&oacute;n Directa y de I3P<label id="lbOperacion" style="font-size: 8pt"></label></h1>
			<br/>
			<div class="tabs" id="tabs" name="tabs" >
				...
				<div id="tabs-0" align="center">
					<% if (request.getParameter("tab").equals("0")) { %>
						<jsp:include page="CatalogoMontosADydeI3PConsultar.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 0);
						</script>
				...
				<div id="tabs-1" align="center" width="800">
					<% if (request.getParameter("tab").equals("1")) { %>
						<jsp:include page="CatalogoMontosADydeI3PEditar.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$tabs.tabs('select', 1);
						</script>
