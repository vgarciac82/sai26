	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			<%
				...
				int btnLnCopia=0;
				int imgGeneraContrato=0;
				Map botones=nb.getBotones(roles,"Contratos","nuevoContratoCap1000");
				...
				while (btn.hasNext()) {
					...
					if ("imgGeneraContrato1000".equals(img)){
		...
		function generaContrato(){
			var imgGeneraContrato='<%=imgGeneraContrato%>';
			if (imgGeneraContrato==0){
				if ($("#cDescripcion").val() == '') {
			...
			if (resultLineas) {
				...
				queryFormPost("mContratoCAP1000Create", { async:false });
				
				queryFormPost("mContratoConsecutivoCAP1000Read", { async:false });
				...
				alert("Usted no tiene permisos para realizar esta accion, contacte a su adminsitrador");
			}
							...
							<table align="left" width="750px">
								<tr>
						    		<td align="right" colspan="2">
                                    	<img id="imgGeneraContrato1000" src="../imagenes/accept_green.png" style="cursor: pointer" onclick="generaContrato();"/> Generar Contrato
                                	</td>
						    	</tr>
						...
						<fieldset style="width:750px" align="left">
							<legend>Agregar CUCOPS</legend>
								<table align="left" width="750px">
						    		...
						    		<tr>
						    			<td align="left">CUCOP:<select id="cIdCABM" name="cIdCABM" style="width: 400px;" ></select> <img id="imgRefreshContrato1000" src="../../imagenes/icono_refresh.jpg" style="cursor: pointer" onclick="oTableCAMBs.fnClearTable(oTableCAMBs); mostrar();"/> Actualizar </td>
						    		</tr>
						    		<tr>
	    				...
	    				<fieldset style="width:750px" align="left">
	    					<legend>L&iacute;neas capturadas</legend>
			    				<table width="740px">
			    					...
			    					<tr>
			    						<td align="left"><button id="btnCalcTotalCap1000" name="btnCalcTotalCap1000" onclick="calcTotales();">Calcular Total</button><button id="btnEliminarLineasReqCap1000" name="btnEliminarLineasReqCap1000" onclick="eliminarLineas();">Eliminar Lineas</button></td>
			    					</tr>
