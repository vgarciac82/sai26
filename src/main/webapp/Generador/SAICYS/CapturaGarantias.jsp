...
<html>
<head>
<title>Módulo para la captura de garantías</title>
<meta http-equiv="pragma" content="no-cache">
	...
	<script type="text/javascript" src="../js/CapturaGarantias.js"></script>
		...
		var UE_UsuarioActual="<%= usuario.getU_UR() %>";
  		$(document).ready(function() {
  			<%
				...
				Map pestanas=ebl.getPestana(roles,"CapturaGarantias");
  			...
  			%>
  			$(".tabs").tabs();
			$("#ConsultaGarantias").click(function() {
				window.location = "CapturaGarantias.jsp?tab=" + 0;
			});
			$("#CapturaGarantiasContrato").click(function() {
				window.location = "CapturaGarantias.jsp?tab=" + 1;
			});
...
<body>
	<div class="container-fluid" >
		<div class="col-md-12 col-lg-12 col-sm-12">
 			<h1 style="color: #1A69A9;">Captura de Garant&iacute;as</h1>
 			<div class="tabs" id="tabs">
	 			<ul class="nav nav-tabs">
				    <li class="nav-item"><a href="#tabs-0" id="ConsultaGarantias" class="nav-link" aria-current="page">Consulta</a></li>
				    <li class="nav-item"><a href="#tabs-1" id="CapturaGarantiasContrato" class="nav-link" aria-current="page">Captura</a></li>
	 			</ul>
				<div id="tabs-0" align="left" >
					<% if (request.getParameter("tab").equals("0")) { %>
						<jsp:include page="ConsultaContratosConGarantia.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$( "#tabs" ).tabs({ active: 0 });
						</script>
				...
				<div id="tabs-1" align="left">
					<% if (request.getParameter("tab").equals("1")) { %>
						<jsp:include page="CapturaGarantiasContrato.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$( "#tabs" ).tabs({ active: 1 });
						</script>
    ...
    <input type="hidden" name="esCapturaGarantia" id="esCapturaGarantia" value="1" />
