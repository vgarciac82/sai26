...
function mostrar() {
				...
				if ($("#desUnidadResponsable2").val() != "" && $("#desUnidadResponsable2").val() != "0" )
					qw += " AND cUnidadEjecutora = '" + $("#desUnidadResponsable2").val() + "'";
				...
				bServerSide: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=v_mMontosADydeI3P&qw="+qw,
				bProcessing: true,
				//Tablesorter:false,
				//bSortable: false
				...
				aoColumns: [
					...
					{ sName: "D_DESCRIPCION" },
					{ sName: "_original"  ,"bSortable": false },
					//{ sName: "MayorDe" },
					//{ sName: "Hasta"	},
			...
			<table id="tblMontosADydeI3P" class="display">
	            <thead>
	                <tr>
	                	...
	                	<th width="25%">MontoOriginal</th>	                	
	                   
	                    <th width="25%">MontoMaximo_AD</th>
