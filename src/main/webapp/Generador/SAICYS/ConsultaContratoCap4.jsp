...
<html>
  <head>
   <title>ConsultaContratoCap4</title>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			//	NegativaBoton NegBoton= new NegativaBoton();
				...
				Map botones=nb.getBotones(roles,"ContratoCap4","ConsultaContratoCap4");
		...
		function initQuerys(){
			...
			querySelectPost("estadoContratoRead", "estatusContratoCap4", {async: false});
			querySelectPost("tipoActividadEconomica", "actEconomContratoCap4", {async: false});
		}
		function  initTabla(){
			var qw=" cIdContratoDefinitivo LIKE'%25" +$("#contratoCap4").val()+ "%25' ";
			if ($("#cIdUnidadEjecutora").val() != "0"){
				qw+=" and cIdUnidadEjecutora='"+$("#cIdUnidadEjecutora").val()+"' ";
			}
			if ($("#estatusContratoCap4").val() != "0"){
				qw+=" and nIdEstado='"+$("#estatusContratoCap4").val()+"' ";
			}
			if ($("#actEconomContratoCap4").val() != "0"){
				qw+=" and nIdTipoActividadEconomica='"+$("#actEconomContratoCap4").val()+"' ";
			}
			...
			oTableConsulta = $("#tblConsulta").dataTable({
				...
				bServerSide: true,
				bProcessing: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=v_mConsultaContratoCap4&qw="+qw,
				sPaginationType: "full_numbers",
  ...
  <body>
  	<form id="formConsultaCont">
		<fieldset class="form-group border p-3">
			<legend class="w-auto px-2"> Consulta Contratos Cap&iacute;tulo 4000</legend>
			...
			<div class="form-group">
				<div class="row">
					<div class="input-group">
						<div class="col-2">
							<label for="contratoCap4">Contrato Definitivo: </label>
						</div>
						<div class="col-6">
							...
							name="contratoCap4" id="contratoCap4"  />
						</div>
					</div>
				</div>
			</div>
			<div class="form-group">
				<div class="row">
					<div class="input-group">
						<div class="col-2">
							<label for="estatusContratoCap4">Estatus: </label>
						</div>
						<div class="col-6">
							<select class="custom-select" id="estatusContratoCap4" name="estatusContratoCap4" >
