...
<html>
	<head>
					...
					{         						
						...
						{   
							...
							if((nTr[0]== $("#UE").val())||( $('#usuarioRole').val()=='ADMIN_RECMAT')){
								...
								window.location = "CatalogoUnidadesAdministrativas.jsp?tab=1&claveUnidadAdministrativa="+nTr[0];
							}
							 else{
		...
		function mostrar() {
				...
				if ($("#cUnidadResponsable").val() != "" && $("#cUnidadResponsable").val() != "*" )
					qw += " AND claveUnidadAdministrativa = '" + $("#cUnidadResponsable").val() + "'";
				...
				bServerSide: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=v_mUnidadesAdministrativas&qw=" + qw,
				bProcessing: true,
				sPaginationType: "full_numbers",
				bJQueryUI: true,
				aaSorting: [[ 0, "asc" ]] ,
				aoColumns: [
					{ sName: "claveUnidadAdministrativa" },
...
<body id="dt_example">
	<form> 
		...
		<div id="container" class="container" style="width: 100%; height: 100%" >	
			<h1 align="left">Cat&aacute;logo Unidad Administrativa</h1>
			<table align="left">
			<tr id="trcUnidadResponsable" align="left">
					<td>Clave de la Unidad Administrativa:</td>
					<td>
						<select id="cUnidadResponsable" name="cUnidadResponsable" style="width: 30em;">
			    ...
			    <!--  <tr id="trDescripcion" align="left">
					...
					<td>
					<select id="D_DESCRIPCION" name="D_DESCRIPCION" style="width: 40em;"></select>
					</td>
				</tr>	
				...
				<tr id="trcCentroContable" align="left">
					...
					<td>
					<select id="cCentroContable" name="cCentroContable" style="width: 10em;"></select>
					</td>
				</tr>
				-->	
			...
			<table id="tblUnidadesAdministrativas" class="display">
	            <thead>
	                <tr>
	                	...
	                	<th width="5%">UnidadAdministrativa</th>
	                	<th width="5%">CentroContable</th>	                	
	                    <th width="10%">Decripcion UnidadEje</th>
