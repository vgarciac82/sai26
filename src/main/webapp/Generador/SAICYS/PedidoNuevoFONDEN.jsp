	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			<%
				...
				int generaPedido=0;
		//		int btnLnElimina=0;
				Map botones=nb.getBotones(roles,"Pedidos","nuevoPedidoFONDEN");
				...
				while (btn.hasNext()) {
					...
					if ("imgAprobarLineasReqPedFonden".equals(img)){
			...
			$('#tblPAAFonden tr').live('dblclick', function() {
		...
		function generaPedido(){
			...
			queryFormPost("mPedidoFONDENCreate", { async:false });
			
			queryFormPost("mPedidoConsecutivoFONDENRead", { async:false });
			...
			window.location = url;
				...
				alert("No tiene permiso para realizar esta acción, contacte a su administrador");
			}
							...
							<table align="left" width="750px">
								<tr>
						    		<td align="right" colspan="2">
                                    	<img id="imgAprobarLineasReqPedFonden" src="../imagenes/accept_green.png" style="cursor: pointer" onclick="generaPedido();"/> Generar Pedido
                                	</td>
						    	</tr>
					...
					<td>
						<fieldset style="width:750px" align="left">
							<legend>Agregar CUCOPS</legend>
								<table align="left" width="750px">
						    		<tr>
						    			<td align="left">CUCOP:<select id="cIdCABM" name="cIdCABM" style="width: 400px;" ></select> &nbsp;&nbsp;&nbsp; <button id="agrLineaPedidFonden" onclick="agregarLineaCUCOP();" >Agrega Linea CUCOP</button>
						    		</tr>
						    		<tr>
						    		...
						    		<tr>
						    			<td align="left" > <button id="nuevoPedidoFonden" onclick="agregarLinea();" >Agrega Linea del Programa Anual OTROS</button> </td>
						    		</tr>
						    	</table>
		    			</fieldset>
		    		</td>
	    					...
	    					<legend>L&iacute;neas capturadas</legend>
			    				<table width="740px">
			    					...
			    					<tr>
			    						...
			    						<tr>
			    						<td align="left"><button id="btnCalcTotalPedFonden" name="btnCalcTotalPedFonden" onclick="calcTotales();">Calcular Total</button><button id="btnEliminarLineasReqPedFonden" name="btnEliminarLineasReqPedFonden" onclick="eliminarLineas();">Eliminar Lineas</button></td>
			    					</tr>
			    					</tr>
			    				</table>
	    				</fieldset>
