...
<html>
<head>
<title>Módulo de liberación de garantias</title>
	...
	<script type="text/javascript" src="../js/Garantias.js"></script>
		...
		var UE_UsuarioActual="<%= usuario.getU_UR() %>";
  		$(document).ready(function() {
  			<%
				...
				Map pestanas=ebl.getPestana(roles,"Garantias");
			...
			$("#ConsultaGarantias").click(function() {
				window.location = "Garantias.jsp?tab=" + 0;
			});
			$("#LiberaGarantias").click(function() {
				window.location = "Garantias.jsp?tab=" + 1;
			});
...
<body>
	<div class="container-fluid" >
		<div class="col-md-12 col-lg-12 col-sm-12">
 			<h1 style="color: #1A69A9;">Liberaci&oacute;n de Garant&iacute;as</h1>
 			<div class="tabs" id="tabs">
	 			<ul class="nav nav-tabs">
				    <li class="nav-item"><a href="#tabs-0" id="ConsultaGarantias" class="nav-link" aria-current="page">Consulta</a></li>
				    <li class="nav-item"><a href="#tabs-1" id="LiberaGarantias" class="nav-link" aria-current="page">Liberaci&oacute;n</a></li>
	 			</ul>
				...
				<div id="tabs-1" align="left">
					<% if (request.getParameter("tab").equals("1")) { %>
						<jsp:include page="LiberaGarantia.jsp" />
						<script type="text/javascript" charset="utf-8">
								var $tabs = $(".tabs").tabs();
								$( "#tabs" ).tabs({ active: 1 });
						</script>
    ...
    <input type="hidden" name="esCapturaGarantia" id="esCapturaGarantia" value="0" />
