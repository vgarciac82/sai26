...
<body>
	<form id="formContratosCAAS" action="../../servlet/LeeArchivos?operacion=-1"  enctype = "multipart/form-data" method = "post">
		<div class="container-fluid">
			<div class="col-md-12 col-lg-12 col-sm-12">
	 			<fieldset class="form-group border p-3">
	 				<legend class="w-auto px-2"> Carga Layout de contrataciones del CAAS</legend>
	 				<div class="form-group">
						...
						<div class="form-group row">
							<div class="col-md-auto">
								<input id="btnSubmit1" name="btnSubmit1" type="button" value="Enviar" onclick="ejecutaAjax()" class="btnInterfaceBG ui-button ui-widget ui-state-default ui-corner-all"/>
							</div>
						</div>
						<div class="form-group row">
	 	...
	 	<input type="hidden" id="operacion" name="operacion" value="6" />
	 </form>
</body>
</html>