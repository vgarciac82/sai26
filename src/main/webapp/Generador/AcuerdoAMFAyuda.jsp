...
oTableSaldos = $("#tblSaldos").dataTable({
	...
	//				window.opener.frmPadre.textboxPadre.value=window.frmHija.textboxHijo.value
					window.opener.formPagos.ep.value=window.FacturaAcuerdosAdministracion.ep.value ;
...
//				return oTableLocal.$('tr.row_selected');
		...
		window.FacturaAcuerdosAdministracion.Partida.value=window.opener.formPagos.Partida.value;
		window.FacturaAcuerdosAdministracion.Partida2.value=window.opener.formPagos.Partida2.value;
		window.FacturaAcuerdosAdministracion.Partida3.value=window.opener.formPagos.Partida3.value;
		window.FacturaAcuerdosAdministracion.Partida4.value=window.opener.formPagos.Partida4.value;
		var Pp = $('#Partida').val();
		var Pp2 = $('#Partida2').val();
		var Pp3 = $('#Partida3').val();
		var Pp4 = $('#Partida4').val();
		var cunidadej = "";
		//UEt = UE.substring( UE.length - 2 );
		cunidadej = " UnidadEjecutora='" + UE + "'";
		if (UE == 'A02'){
			cunidadej = " 1 = 1";
		}
		...
		return $("#tblEP").dataTable({
				...
				bServerSide: true,
				sAjaxSource: window.location.protocol + "//" + window.location.host + "/" + window.location.pathname.split("/")[1] + "/crud?rt=t&ql=vCatalogoEPGrid2&qw= " + cunidadej + w,
				bProcessing: true,
...
<body id="dt_example" >
	<form id="FacturaAcuerdosAdministracion" name="FacturaAcuerdosAdministracion">
