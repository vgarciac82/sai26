...
$(document).ready(function() {
	...
	querySelectPost("tCatDestinoGasto", "destinoGasto", {async : true});
	...
	function extrae(){
		...
		if ($("#checkAllDestGast").prop("checked"))
			$("#todosDest").val("SI");
		else
			$("#todosDest").val("NO");
...
<body id="dt_example">
<br/>
	<form id="ExportarForm" name="ExportarForm" action="../reportes/ReporteCargaMasivaRG" method="get" target="_blank">
		...
		<input id="todosDest" name="todosDest" type="hidden" value=""/>
		...
		<div id="container" style="width: 80%" class="container">			
			<div class="card-header"> <h3> Reporte carga masiva de Relacion de Gastos </h3> </div>
			<hr class="mt-3"/>
			...
			<div class="row">
	        	...
	        	<div class="col-12 col-lg-2 col-md-2 col-sm-12 d-flex p-1">
					<label for="destinoGasto" class="form-label"> Destino Gasto:&nbsp; </label>												
				</div>				
				<div class="col-12 col-lg-5 col-md-5 col-sm-12 d-flex p-1">
					<select name = "destinoGasto" id = "destinoGasto" class="form-select form-select-sm">							
					</select>	
				</div>
				<div class="col-12 col-lg-3 col-md-3 col-sm-12 d-flex p-1">							
					<input type="checkbox" id="checkAllDestGast" name="checkAllDestGast" class="form-check-input"/>	&nbsp;Todos los Destinos										
				</div>
			</div>
