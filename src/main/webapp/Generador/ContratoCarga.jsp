...
<html>
  <head>
    ...
    <title>Carga de Contratos</title>
    
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="keyword1,keyword2,keyword3">
	<meta http-equiv="description" content="Carga Contratos Desembolso">
...
$(document).ready(function(){
		...
		$("#btnCargarContrato").show();

		$("#txtAreaMensaje").val("<%=mensaje%>");
		//NOMBRE DEL BOTON
		$("#btnCargarContrato").click(function (){ 
		
			$("#frmContratoCargaDesembolso").attr("action","../gstnmngr/ContratoDesemServlet");
			$("#frmContratoCargaDesembolso").attr("enctype","multipart/form-data");
			$("#frmContratoCargaDesembolso").submit();
...
<form method="post" id="frmContratoCargaDesembolso" name="frmContratoCargaDesembolso" >
<center>
	
	<div id="container" class="container" style="width:1100px">
	
			<h1><img id="imgPlayStop" style="visibility: hidden" src="imagenes/wait24trans.gif">Contratos <label align="left" id="lbOperacion" style="font-size: 8pt"></label></h1>


			<h2> Carga de Archivo CSV para Importar información de Contratos </h2>
			...
			<table border="0" align="center" width="800px">
				<tr>
					...
					<td colspan="1" align="center"><input type="button" id="btnCargarContrato" name="btnCargarContrato"  value="Cargar" /></td>
				</tr>
			</table>
			</fieldset>
