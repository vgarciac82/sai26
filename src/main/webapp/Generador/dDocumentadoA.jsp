							...
							if ( $('input', data[i] )[0].checked ){
								...
								if ($("#Numero_SOE").val() == "" ) {
									// readGeneraNoSOE es el que genera llave de SOE, debes enviar el ID_Prestamo
					      			...
					      			alert("SOE generado correctamente");
...
<body id="dt_example" bottomMargin="0" bgColor="red" leftMargin="0" topMargin="0" >
	<form> 
		...
		<div id="tabs-0" class="container">					
			<h1>SOE Documentado <label id="lbOperacion" style="font-size: 8pt">(Agregar)</label></h1>
			<table border="0" align="center" width="100%">
				<tr>
              	...
              	<tr>
					...
					<td align="right" width="150px">Entidad Federativa:</td>
					<td >
		...
		<table class="display" >
				...
				<tr> <td colspan="2"> <h1>Datos en SOE </h1> </td> </tr>
		</table>
		</div>
