...
<html>
  <head>
    <title>Layout Pago Acuerdos</title>
...
function generar(){
 			try 
 			{
            	...
            	//document.location.href='../gstnmngr/generaLayoutOperacionAjena?archivo=1';
            	document.location.href='../gstnmngr/generaPagoAcuerdosAMF?archivo=1';
...
function generarDocumentacion(){
 			try {
            	...
            	document.location.href='../gstnmngr/generaPagoAcuerdosAMF?archivo=2';
            	document.envioSICOP.submit();
...
$(function(){$( "#FechaInicial" ).datepicker({
				dateFormat: "dd/mm/yy",
				showOn: "button",
...
$(function() {$( "#FechaFinal" ).datepicker({
				dateFormat: "dd/mm/yy",
				showOn: "button",
				buttonImage: "images/calendar.gif",
				buttonImageOnly: true
...
$(function() {$( "#FechaInicial1" ).datepicker({
				dateFormat: "dd/mm/yy",
				showOn: "button",
				buttonImage: "images/calendar.gif",
				buttonImageOnly: true
...
$(function() {$( "#FechaFinal1" ).datepicker({
				dateFormat: "dd/mm/yy",
				showOn: "button",
				buttonImage: "images/calendar.gif",
				buttonImageOnly: true
...
$(function() {$( "#FechaProgramada" ).datepicker({
				dateFormat: "dd/mm/yy",
				showOn: "button",
				buttonImage: "images/calendar.gif",
				buttonImageOnly: true
...
function toggle(status) {$("input:checkbox").each( 
				function() {
					$(this).attr("checked",status.checked);
				}
			);
...
$( "#pbLeyenda" ).button().click(function() {
				if (!fnValidaRowSel())
				{
...
$( "#pbCuentasBancarias" ).button().click(function() {
  	...
  	<body id="dt_example" onLoad="inicio();" >
		<div  id="container" >
			<h1>Layout Pago Acuerdos AMF<label id="lbOperacion" style="font-size: 8pt"></label></h1>			
        	<div id="tabs">    		
        		<ul>
				...
				<div id="tabs-1">	
					...
					<fieldset>
						...
						<jsp:include page="listaPagoAcuerdosAMF.jsp"></jsp:include>
					</fieldset>
					</form>	
				</div>
				<div id="tabs-2">				
				    <fieldset>
				    	...
				    	<jsp:include page="listaPagoAcuerdosAMFEnviados.jsp"></jsp:include>
					</fieldset>
				</div>
		        <div id="tabs-3">
		        	<table width="100%" border="0"">
				    ...
				    <fieldset>
				    	...
				    	<jsp:include page="listaPagoAcuerdosAMFConLayout.jsp"></jsp:include>
					</fieldset>
				</div>		        
			</div>
