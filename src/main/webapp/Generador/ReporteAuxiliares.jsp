...
<br/>
	<form id="ExportarForm" name="ExportarForm" action="../reportes/ReportePagosBeneficiarios" method="get" target="_blank">
		...
		<div id="container" style="width: 90%" class="container SyCData">
			<h1>
				Consulta de Pagos a Beneficiarios
				<!-- <label style="font-size: 11pt"></label> -->
			</h1>
				...
				<table align="center">									
					...
					<tr>
						...
						<td>
							<input type="text" name="ep" id="ep" maxlength="63" size="63" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<input type="text" name="rfc" id="rfc" maxlength="18" size="20" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<input type="text" name="cRazonSocial" id="cRazonSocial" maxlength="50" size="63" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td>
							<input type="text" name="cContrato" id="cContrato" maxlength="50" size="63" style="width: 231px; "/>
						</td>
					</tr>
