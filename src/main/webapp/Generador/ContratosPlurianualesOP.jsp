...
<html>
	<head>
		...
		<script type="text/javascript" src="js/ContratoPlurianualOP.js"></script>
	...
	<body id="dt_example">
		<form action="../ConvenioModificatorio" method="post" id="mainForm">
			...
			<input type="hidden" value="CONTRATO_PLURIANUAL" id="accion" name="accion">
			...
			<div id="container" class="container SyCData">
				...
				<table>
					...
					<tr>
						...
						<td colspan="4" align="right">
							<!--  <input type="button" id="newButton" value="Nuevo" > -->
						</td>
					</tr>
				</table>
				<h6>
					Doble Click en el contrato para iniciar el contrato plurianual.
				</h6>
				...
				<div id="question" style="display: none; cursor: default">
					...
					<br>
					<h5>
						Se agregar&aacute; un contrato Plurianual
						seleccionado.
					</h5>
