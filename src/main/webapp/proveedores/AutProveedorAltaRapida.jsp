...
<%! private static final Logger log=LoggerFactory.getLogger("ProveedorAltaRapida.jsp"); %>
...
<html lang="es">
  ...
  <head>
    ...
    <title>Autoriza alta rápida de proveedores</title>
    <link
  ...
  <body>
    <div class="container mt-3 justify-content-center">
      <h1>Autoriza Alta rapida de proveedores.</h1>
      <form id="proveedorForm" method="POST">
        ...
        <div class="row g-3 justify-content-sm-start mb-3">
          ...
          <div class="col-sm-1 justify-content-sm-start">
            <button role="button" class="btn btn-primary btn-sm" id="extraerBtn">Extraer</button>
          </div>
          
          <div class="col-sm-7 justify-content-sm-start text-start">
            &nbsp;
          </div>
        ...
        <div class="card-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-sm-4">
              ...
              <button class="btn btn-primary" type="button" role="button" id="aprobarBtn"  >Aprobar</button>
            
              <button class="btn btn-primary" type="button" role="button" id="rechazarBtn" >Rechazar</button>
            </div>
    ...
    <div class="modal fade" id="observacionesDlg" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="observacionesDlgLabel" aria-hidden="true">
      <form id="observacionesFrm" method="post">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            
            <div class="modal-header">
              <h5 class="modal-title" id="observacionesDlgLabel">Rechaza Alta Proveedor.</h5>
            ...
            <div class="modal-body">
              ...
              <div class="row mb-3">
                <label for="destino" class="col-sm-12 col-form-label">Motivo de Rechazo:</label>
              
                <div class="col-sm-12">
                  <textarea id="observacionesRechazo" name="observacionesRechazo" class="form-control" rows="3"></textarea>
                </div>
              </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" id="rechazaAltaRapidaBtn">Aceptar</button>
     ...
     <form id="ExportarForm" name="ExportarForm" action="../reportes/FormatoAltaProveedor" method="POST" target="_blank">
        <input type="hidden" name="altaRapida" value="true">
     </form>
    </div>
    ...
    <script src="js/AutProveedorAltaRapida.js"></script>
