...
/** Para regresar la solicitud (caNoContrarrecibo del ingreso fiscal.) **/
var solicitud = "";
...
function tblPagoDblClick(event) {
	...
	$("#MesDebeDecir").val(nMesDice);
	document.getElementById("MesDebeDecir").disabled=true;
 ...
 */
function Grid() {
	window.open('../Generador/AyudEPsPresupuestos.jsp', 'AyudaEPsPagos', 'status=1, width=900px, height=680px, left=100px');	
	return false;
}
