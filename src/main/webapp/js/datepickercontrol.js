...
DatePickerControl.createButton = function(input, useId)
{
	...
	*/
	...
	//alert("name="+input.name+", useId="+useId);
...
DatePickerControl.build = function(m, y)
{
	...
	if (m==null){
		var now = new Date();
		// !FIXME: getMonth() va de 0 a 11, Realizar esta correccion al cambiar a una nueva version de DatePicker (GJCG), 
		///Ricardo: Se le quito el now.getMonth() + 1 --> Ya que si va del 0 al 11 el 11 seria diciembre y + 1  marcaria error de mes invalido
