		...
		<div class="row">
			...
			<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-2">
				...
				<div class="input-group">
					...
					<input type="text" readonly="readonly" class="form-control form-control-sm" id="retencionesFacturas" name="retencionesFacturas"/>
				</div>
			</div>
			<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-2">
				...
				<div class="input-group">
					<span class="input-group-text"><i class="bi bi-currency-dollar"></i></span>				
					<input type="text" readonly="readonly" class="form-control form-control-sm" id="retencionesCapturadas" name="retencionesCapturadas"/>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-12 col-lg-2 col-md-2 col-sm-12 p-2">
				...
				<div class="input-group">
					<span class="input-group-text"><i class="bi bi-currency-dollar"></i></span>				
					<input type="text" readonly="readonly" class="form-control form-control-sm" id="importeRetencionCalculado" name="importeRetencionCalculado"/>
				</div>
			</div>
