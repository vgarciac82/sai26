<div id="Resumen">
	<fieldset>
		...
		<table id="mainTable" align="center" class="tablaResumen" cellspacing="0" width ="65%">
			<tr>
				<td style="padding: 0px;">
					...
					<table class="tablaResumen" cellpadding="5" width="100%">
						<tr>
							...
							<td class="tituloSuperiorDer" width="23%" nowrap>Fecha de Aplicacion</td>
						</tr>
						<tr>
							<td colspan="3" width="31%">&nbsp;</td>
							<td class="infoInferior" width="23%" id="caNoContrarreciboResumen">&nbsp;</td>
							<td class="infoInferior" width="23%" id="tipoDocumentoResumen">&nbsp;</td>
							<td class="infoInferiorDer" width="23%" id="fechaAplicacionResumen">&nbsp;</td>
						</tr>
						<tr>
							<td colspan="3" width="31%">&nbsp;</td>
							<td colspan="1" width="34%" class="tituloSuperior">Folio</td>
							<td colspan="2" width="35%" class="infoSuperiorDer" id="destinoGastoResumen" style="text-align: left">&nbsp;</td>
						</tr>
						<tr>
							<td colspan="3" width="31%" nowrap><b>CUENTA POR PAGAR</b></td>
							<td colspan="1" width="34%" class="infoInferior" id="nFolioResumen">&nbsp;</td>
							<td colspan="2" width="35%" class="infoInferiorDer" id="tipoConceptoResumen" style="text-align: left">&nbsp;</td>
						</tr>
						<tr>
							<td colspan="4" width="65%" nowrap class="tituloSuperior">&nbsp;</td>
							<td colspan="2" width="35%" class="tituloSuperiorDer">Tipo de C x P</td>
						</tr>
						<tr>
							<td colspan="2" width="32%" nowrap class="infoInferiorH" id="centroContableResumen"
								style="border-left: 1px solid rgb(50, 50, 50);">&nbsp;</td>
							<td colspan="2" width="33%" nowrap class="infoInferiorH" id="unidadResponsableResumen">&nbsp;</td>
							<td colspan="2" width="35%" class="infoInferiorDer" id="tipoPagoDirectoResumen">&nbsp;</td>
						</tr>
					</table>
				</td>
			</tr>
						...
						<tr>
							<td width="50%" class="BR">
								<table width="100%" class="tablaResumen" cellpadding="5">
									...
									<tr>
										<td class="tituloResumenR">Programa:</td>
										<td colspan="2" id="programaResumen" align="left">&nbsp;</td>
									</tr>
									<tr>
										<td class="tituloResumenR">SubPrograma:</td>
										<td colspan="2" id="subprogramaResumen" align="left">&nbsp;</td>
									</tr>
								</table>
			...
			<tr>
				<td style="padding: 0px;" class="BL BB BR" width="100%">
					<table width="100%" class="tablaResumen" id="tblResumenPagoR" cellpadding="5">
						<thead>
							<tr>
			...
			<tr>
				<td style="padding: 0px;" class="BL BB BR" width="100%">
					<table width="100%" class="tablaResumen" id="tblResumenMovtosR" cellpadding="5">
						<thead>
							<tr>
				...
				<td width="100%">
					<div >
						<table width="100%" align="center">
							<tr>
								<td align="right">
									<input type="button" id="btnAdjuntaDocRete" value="Adjuntar Justificacion" class="btn btn-secondary"/>
								</td>
							</tr>
						</table>
					</div>
