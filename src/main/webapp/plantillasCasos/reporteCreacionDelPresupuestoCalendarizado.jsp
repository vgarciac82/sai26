...
<html>
	<head>
		...
		<title>Reporte Creaci&oacute;n del Presupuesto Calendarizado</title>
		...
		<script type="text/javascript">
			function limpiarSesion(){
				window.location.href="reporteCreacionDelPresupuestoCalendarizado.jsp?id=<%=request.getParameter("id")%>";//Esto recarga la pagina
			}

			function Grid(){
				window.open('gridAnteproyectoCalendarizado.jsp?id=<%=request.getParameter("id")%>', 'MultiReporteGrid', 'status=1, width=900px, height=500px');
			}
			...
			function fnPrintTituloReporte() {
				...
				if (ep=="" & EjercicioFiscal=="" & UnidadEjecutora=="" & RamoEP=="" & UnidadResponsableEP=="" & GrupoFuncional=="" & Funcion=="" & SubFuncion=="" & ProgramaGeneral=="" & ProgramaPresupuestario=="" & ActividadInstitucional=="" & Partida=="" & FuenteFinanciamiento=="" & EntidadFederativa=="" & Cartera=="" & UnidadNormativa=="" ){
...
//					parent.frames['resultado'].location.href = "MultiReporteResultado.jsp?" + param;
					...
					window.open('resultadoCreacionDelPresupuestoCalendarizado.jsp?'+ param, 'Resultado','toolbar=no,menubar=no,scrollbars=yes,resizable=yes');
...
//					querySelectPost("catalogoUnidadResponsableRead", "UnidadResponsableEP");
	...
	<body background="../imagenes/steel_BG.gif" style="width: 97%">
		<form id="frmCreacionPresupuestoCalendarizado" name="frmCreacionPresupuestoCalendarizado" method="post" target="formulario" action="./reporteCreacionDelPresupuestoCalendarizado.jsp?select=u_login">
				...
				<table class="TituloRutaCA"  height="10">
					<tr>
						<td>
							...
							<font color="#FFFFFF">
								<strong>Reporte Creaci&oacute;n del Presupuesto Calendarizado.</strong>
							</font>
						</td>
					</tr>
				</table>
