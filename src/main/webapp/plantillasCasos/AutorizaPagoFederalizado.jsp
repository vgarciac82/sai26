...
<%@page import="com.syc.egresos.core.impl.EgresoPAGOFEDERALIZADOEncabezado"%>
...
<%
	...
	EgresoEncabezado pagoFederalizado = new EgresoPAGOFEDERALIZADOEncabezado();
	pagoFederalizado.setJniName( GestionInterface.ATT_CONEXION );
	pagoFederalizado = pagoFederalizado.cargaEncabezado(nFolioPagoFed);
...
<script type="text/javascript" src="js/AutorizaPagoFederalizado.js"></script> 
...
<script type="text/javascript">
	...
	var infoObj = {
		...
		nFolioPagoFed : '<%=nFolioPagoFed%>',
		ramo : '<%=ramo%>',
		ejercicioFiscal : '<%=ejercicioFiscal%>',
		folio : '<%=folio%>',
		cTipoPago : "<%=c.getTipoCaso().getGavetaAsociada()%>",
		nFolioPago : "<%=nFolioPagoFed%>",
		    	...
		    	<div class="modal-content">
			    	...
			    	<div class="modal-body">
			      	...
			      	<div class="modal-footer">
			        	<button type="button" id="btnModificaCuenta" onclick="aceptarDlg();" class="btn btn-primary">Guardar</button>
